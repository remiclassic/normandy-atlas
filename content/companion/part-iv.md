...
:::scenario-brief
**Map argument:** Carolingian integration **concentrated** wealth along the Seine; civil **fraying** after the mid-9th century changed **who** could defend that hydraulic spine — Scandinavian operators read the geography as opportunity, not coincidence.  
**Layers:** Regions (`frontier` / `contested` reads) · **Places** (abbeys, Rouen) · **Routes** (raid / trade **kinds**) · optional **rivers**.
:::

![Static snapshot — Seine corridor schematic](/companion/seine-corridor-argument.svg)
