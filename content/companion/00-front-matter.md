...
**Success:** You can name what an **era** changes on the map without confusing a corridor with a captain’s logbook.
:::
...
Keep the atlas open beside you if you can. **Dual-track layout:** the main text stays geographical and narrative; **Tactical** boxes spell out IDs, toggles, and evidence stamps such as :evidence:documentary_cluster or :evidence:synthesis so power users can align prose with the data model.
...
![Evidence ladder — how proof types stack in the atlas’s vocabulary](/companion/evidence-ladder.svg)
