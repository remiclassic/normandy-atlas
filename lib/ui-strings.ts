...
const STRINGS = {
  ...
  'toolsMenu.normanReadingsLabel': {
    en: 'Norman readings',
    fr: 'Lectures normandes',
    es: 'Lecturas normandas',
    it: 'Letture normanne',
    de: 'Normannische Texte',
    nb: 'Normanniske tekster',
    sv: 'Normandiska texter',
    da: 'Normanniske tekster',
  },
  'toolsMenu.normanReadingsHint': {
    en: 'Long-form essays — sidebar list, share links, jump to map pins.',
    fr: 'Essais longs — liste latérale, partage, accès aux épingles.',
    es: 'Ensayos extensos: lista lateral, compartir, ir al mapa.',
    it: 'Saggi: elenco laterale, condivisione, vai alla mappa.',
    de: 'Langessays — Seitenleiste, Teilen, Sprung zur Karte.',
    nb: 'Langtekster — sidemeny, deling, hopp til kartnåler.',
    sv: 'Långa texter — sidolista, dela, hoppa till kartnålar.',
    da: 'Lange essays — sidemenu, deling, hop til kortnåle.',
  },
  'normanReadings.navGroupThematic': {
    en: 'Essays & bibliography',
    fr: 'Essais et bibliographie',
    es: 'Ensayos y bibliografía',
    it: 'Saggi e bibliografia',
    de: 'Essays und Bibliografie',
    nb: 'Essayer og bibliografi',
    sv: 'Essäer och bibliografi',
    da: 'Essays og bibliografi',
  },
  'normanReadings.navGroupPlaces': {
    en: 'Places on the map',
    fr: 'Lieux sur la carte',
    es: 'Lugares en el mapa',
    it: 'Luoghi sulla mappa',
    de: 'Orte auf der Karte',
    nb: 'Steder på kartet',
    sv: 'Platser på kartan',
    da: 'Steder på kortet',
  },
  'normanReadings.navAria': {
    en: 'Norman readings navigation',
    fr: 'Navigation des lectures normandes',
    es: 'Navegación de lecturas normandas',
    it: 'Navigazione letture normanne',
    de: 'Navigation Normannische Texte',
    nb: 'Navigasjon normanniske tekster',
    sv: 'Navigation normandiska texter',
    da: 'Navigation normanniske læsninger',
  },
  'normanReadings.openOnMapAria': {
    en: 'Open on map',
  ...
  'normanReadings.browseDrawerTitle': {
    en: 'All readings',
  ...
  'normanReadings.browseArticles': {
    en: 'Browse articles',
    fr: 'Parcourir les articles',
    es: 'Explorar artículos',
    it: 'Sfoglia gli articoli',
    de: 'Artikel durchsuchen',
    nb: 'Bla i artikler',
    sv: 'Bläddra artiklar',
    da: 'Gennemse artikler',
  },
  'normanReadings.shareArticle': {
    en: 'Share article',
    fr: 'Partager l’article',
    es: 'Compartir artículo',
    it: 'Condividi articolo',
    de: 'Artikel teilen',
    nb: 'Del artikkel',
    sv: 'Dela artikel',
    da: 'Del artikel',
  },
  'normanReadings.shareHub': {
    en: 'Share reading list',
  ...
  'storyLibrary.normandyFigures.title': {
    en: 'Normandy figures (story arcs)',
    fr: 'Figures normandes (arcs narratifs)',
    es: 'Figuras de Normandía (arcos narrativos)',
    it: 'Figure della Normandia (archi di storia)',
    de: 'Normannische Figuren (Story-Arcs)',
    nb: 'Normanniske figurer (historiebuer)',
    sv: 'Normandiska figurer (story arcs)',
    da: 'Normanniske figurer (historiebuer)',
  },
  'storyLibrary.normandyFigures.subtitle': {
    en: 'Casting list by era — links to readings and the map chronicle.',
    fr: 'Distribution par époque — liens vers les lectures et la chronique sur la carte.',
    es: 'Reparto por época: enlaces a lecturas y a la crónica del mapa.',
    it: 'Casting per epoca — collegamenti alle letture e alla cronaca sulla mappa.',
    de: 'Besetzung nach Epoche — Verknüpfungen zu Texten und der Karten-Chronik.',
    nb: 'Rolleliste etter epoke — lenker til lesninger og kartkrøniken.',
    sv: 'Rollista efter epok — länkar till texter och kartkrönikan.',
    da: 'Rolleliste efter epoke — links til læsninger og kortkrøniken.',
  },
  'storyLibrary.normandyFigures.filterTimeline': {
    en: 'Timeline',
    fr: 'Chronologie',
    es: 'Línea de tiempo',
    it: 'Cronologia',
  ...
  'storyLibrary.normandyFigures.filterAll': {
    en: 'All',
    fr: 'Tout',
    es: 'Todo',
    it: 'Tutto',
  ...
  'storyLibrary.normandyFigures.filterMap': {
    en: 'Main map eras',
    fr: 'Époques carte principale',
    es: 'Eras del mapa principal',
    it: 'Epoche mappa principale',
    de: 'Hauptkarten-Epochen',
    nb: 'Hovedkart-epoker',
    sv: 'Huvudkartans epoker',
    da: 'Hovedkorts epoker',
  },
  'storyLibrary.normandyFigures.filterAtlas': {
    en: 'Atlas deep time',
    fr: 'Atlas (temps profonds)',
    es: 'Atlas (tiempo profundo)',
    it: 'Atlas (tempo profondo)',
    de: 'Atlas (Urzeit)',
    nb: 'Atlas (dyptid)',
    sv: 'Atlas (djup tid)',
    da: 'Atlas (dyb tid)',
  },
  'storyLibrary.normandyFigures.filterPrimary': {
    en: 'Primary arcs only',
    fr: 'Arcs prioritaires seulement',
    es: 'Solo arcos prioritarios',
    it: 'Solo archi prioritari',
    de: 'Nur Haupt-Arcs',
    nb: 'Kun primære buer',
    sv: 'Bara primära arcs',
    da: 'Kun primære buer',
  },
  'storyLibrary.normandyFigures.filterEra': {
    en: 'Era',
    fr: 'Époque',
    es: 'Época',
    it: 'Epoca',
  ...
  'storyLibrary.normandyFigures.anyEra': {
    en: 'Any era',
    fr: 'Toute époque',
    es: 'Cualquier época',
    it: 'Qualsiasi epoca',
    de: 'Jede Epoche',
    nb: 'Hvilken som helst epoke',
    sv: 'Vilken epok som helst',
    da: 'Enhver epoke',
  },
  'storyLibrary.normandyFigures.reading': {
    en: 'Reading',
    fr: 'Lecture',
    es: 'Lectura',
    it: 'Lettura',
  ...
  'storyLibrary.normandyFigures.chronicle': {
    en: 'Map chronicle',
    fr: 'Chronique (carte)',
    es: 'Crónica del mapa',
    it: 'Cronaca sulla mappa',
    de: 'Karten-Chronik',
    nb: 'Kartkrønike',
    sv: 'Kartkrönika',
    da: 'Kortkrønike',
  },
  'storyLibrary.normandyFigures.openChronicle': {
    en: 'Open on map',
    fr: 'Ouvrir sur la carte',
    es: 'Abrir en el mapa',
    it: 'Apri sulla mappa',
  ...
  'storyLibrary.normandyFigures.reliability.documentary': {
    en: 'documentary',
    fr: 'documentaire',
    es: 'documental',
    it: 'documentato',
  ...
  'storyLibrary.normandyFigures.reliability.chronicler': {
    en: 'chronicler',
    fr: 'chroniqueur',
    es: 'cronista',
    it: 'cronaca',
  ...
  'storyLibrary.normandyFigures.reliability.legend': {
    en: 'legend',
    fr: 'légende',
    es: 'leyenda',
    it: 'leggenda',
  ...
  'storyLibrary.normandyFigures.reliability.composite': {
    en: 'composite',
    fr: 'composite',
    es: 'composito',
    it: 'composito',
  ...
  'storyLibrary.figure.kindSuffix': {
    en: 'Figure',
    fr: 'Figure',
    es: 'Figura',
    it: 'Figura',
  ...
  'storyLibrary.figure.cardMeta': {
    en: 'Linked reading & map beat',
    fr: 'Lecture liée et temps fort sur la carte',
    es: 'Lectura vinculada y momento en el mapa',
    it: 'Lettura collegata e momento sulla mappa',
    de: 'Verknüpfte Lektüre und Kartenmoment',
    nb: 'Lenket lesning og kartøyeblikk',
    sv: 'Länkad läsning och kartögonblick',
    da: 'Linket læsning og kortøjeblik',
  },
  'storyLibrary.figure.openLinked': {
    en: 'Open linked story',
    fr: 'Ouvrir le récit lié',
    es: 'Abrir relato vinculado',
    it: 'Apri racconto collegato',
    de: 'Verknüpfte Geschichte öffnen',
    nb: 'Åpne lenket fortelling',
    sv: 'Öppna länkad berättelse',
    da: 'Åbn linket fortælling',
  },
  'storyLibrary.figure.detailsPrompt': {
    en: 'Open arc, reading & links',
    fr: 'Ouvrir l’arc, la lecture et les liens',
    es: 'Abrir arco, lectura y enlaces',
    it: 'Apri arco, lettura e collegamenti',
    de: 'Bogen, Lektüre und Links öffnen',
    nb: 'Åpne bue, lesning og lenker',
    sv: 'Öppna båge, läsning och länkar',
    da: 'Åbn bue, læsning og links',
  },
  'storyLibrary.figure.arcSuffix': {
    en: 'Story arc',
    fr: 'Arc narratif',
    es: 'Arco narrativo',
    it: 'Arco narrativo',
  ...
  'storyLibrary.figure.linkedArcHook': {
    en: 'A compact arc on the map: anchor in the figure’s era, then the linked story below.',
    fr: 'Un arc court sur la carte : ancrage dans l’ère de la figure, puis le récit lié ci-dessous.',
    es: 'Un arco breve en el mapa: contexto en la época de la figura y relato vinculado debajo.',
    it: 'Un arco compatto sulla mappa: ancoraggio nell’epoca della figura, poi il racconto collegato.',
    de: 'Ein kurzer Bogen auf der Karte: Verankerung in der Epoche der Figur, dann die verknüpfte Geschichte.',
    nb: 'En kort bue på kartet: forankring i figurens epoke, deretter den lenkede fortellingen.',
    sv: 'En kompakt båge på kartan: förankring i personens epok, sedan den länkade berättelsen.',
    da: 'En kort bue på kortet: forankring i personens epoke, derefter den linkede fortælling.',
  },
  'storyLibrary.figure.arcStage.anchorEra': {
    en: 'Anchor the atlas in {era}',
    fr: 'Ancrer l’atlas dans {era}',
    es: 'Anclar el atlas en {era}',
    it: 'Ancora l’atlante in {era}',
    de: 'Atlas in {era} verankern',
    nb: 'Forankre atlaset i {era}',
    sv: 'Förankra atlaset i {era}',
    da: 'Forankre atlaset i {era}',
  },
  'storyLibrary.figure.arcStage.context': {
    en: 'Use this library card for era, timeline, and navigation links.',
    fr: 'Utilisez cette fiche pour l’ère, la chronologie et les liens de navigation.',
    es: 'Usa esta ficha para la época, la cronología y los enlaces.',
    it: 'Usa questa scheda per epoca, cronologia e collegamenti.',
    de: 'Diese Karte nutzen für Epoche, Zeitstrahl und Navigationslinks.',
    nb: 'Bruk dette kortet for epoke, tidslinje og navigasjonslenker.',
    sv: 'Använd detta kort för epok, tidslinje och navigering.',
    da: 'Brug dette kort for epoke, tidslinje og links.',
  },
  'storyLibrary.figure.arcStage.reading': {
    en: 'Long-form Norman reading (essay)',
    fr: 'Lecture normande longue forme (essai)',
    es: 'Lectura normanda extensa (ensayo)',
    it: 'Lettura normanna lunga (saggio)',
    de: 'Auslaufende normannische Lektüre (Essay)',
    nb: 'Lang lesning om normannisk historie (essay)',
    sv: 'Lång normandisk läsning (essä)',
    da: 'Lang normannisk læsning (essay)',
  },
  'storyLibrary.figure.arcStage.mapChronicle': {
    en: 'Atlantic chronicle beat on the map',
    fr: 'Étape de chronique atlantique sur la carte',
    es: 'Paso de crónica atlántica en el mapa',
    it: 'Momento della cronaca atlantica sulla mappa',
    de: 'Atlantik-Chronik-Szene auf der Karte',
    nb: 'Atlantisk krøniketrinn på kartet',
    sv: 'Atlantisk krönikepunkt på kartan',
    da: 'Atlantisk krøniketrin på kortet',
  },
  'storyLibrary.figure.arcStagesCount': {
    en: '{count} stages',
    fr: '{count} étapes',
    es: '{count} etapas',
    it: '{count} tappe',
  ...
  'storyLibrary.figure.openMapChronicle': {
    en: 'Open map chronicle',
    fr: 'Ouvrir la chronique sur la carte',
    es: 'Abrir crónica en el mapa',
    it: 'Apri cronaca sulla mappa',
    de: 'Chronik auf der Karte öffnen',
    nb: 'Åpne krønike på kartet',
    sv: 'Öppna krönika på kartan',
    da: 'Åbn krønike på kortet',
  },
  'storyLibrary.figure.noDirectLink': {
    en: 'No linked reading or chronicle step yet',
    fr: 'Pas encore de lecture ni d’étape de chronique liée',
    es: 'Aún sin lectura ni paso de crónica vinculado',
    it: 'Nessuna lettura o passo di cronaca collegato',
    de: 'Noch keine verknüpfte Lektüre oder Chronik',
    nb: 'Ingen lenket lesning eller krøniketrinn ennå',
    sv: 'Ingen länkad läsning eller krönikesteg ännu',
    da: 'Endnu ingen linket læsning eller krøniketrin',
  },
  ...
  'storyLibrary.section.overview': {
    en: 'This story arc',
    fr: 'Cet arc narratif',
    es: 'Este arco narrativo',
    it: 'Questo arco narrativo',
    de: 'Dieser Erzählbogen',
    nb: 'Denne fortellingens bue',
    sv: 'Denna berättelsebåge',
    da: 'Denne fortællingsbue',
  },
  ...
  'storyLibrary.section.chapters': {
    en: 'Stages on this arc',
    fr: 'Étapes de cet arc',
    es: 'Etapas de este arco',
    it: 'Tappe di questo arco',
    de: 'Etappen dieses Bogens',
    nb: 'Trinn langs buen',
    sv: 'Skeenden längs bågen',
    da: 'Trin langs buen',
  },
  ...
  'storyLibrary.copyReadingLink': {
    en: 'Copy reading link',
    fr: 'Copier le lien de lecture',
    es: 'Copiar enlace del artículo',
    it: 'Copia link alla lettura',
    de: 'Leselink kopieren',
    nb: 'Kopier lesingslenke',
    sv: 'Kopiera läsningslänk',
    da: 'Kopiér læselink',
  },
  ...
  'storyLibrary.section.related': {
    en: 'Crossing paths',
    fr: 'Chemins qui se croisent',
    es: 'Caminos que se cruzan',
    it: 'Percorsi che si incrociano',
    de: 'Sich kreuzende Wege',
    nb: 'Kryssende stier',
    sv: 'Korsande vägar',
    da: 'Krydsende spor',
  },
  ...
  'atlasJournal.tooltip.hint': {
    en: 'In-app reference: index lookups, era timeline, Norman names, story arcs with Story Library links, guided expeditions, and your exploration ledger.',
    fr: 'Référence dans l’appli : index, chronologie des époques, patronymes, arcs narratifs et liens vers la bibliothèque d’histoires, expéditions guidées et votre registre d’exploration.',
    es: 'Referencia en la app: índice, línea de tiempo, apellidos normandos, arcos con enlaces a la biblioteca de historias, expediciones guiadas y tu registro de exploración.',
    it: 'Riferimento nell’app: indice, cronologia delle epoche, cognomi normanni, archi con collegamenti alla libreria di storie, spedizioni guidate e registro di esplorazione.',
    de: 'In-App-Referenz: Index, Epochen-Zeitstrahl, normannische Namen, Story-Bögen mit Geschichtenbibliothek-Links, geführte Expeditionen und Erkundungsregister.',
    nb: 'Referanse i appen: register, tidslinje for epoker, normanniske navn, fortellingsbuer med lenker til historiebiblioteket, guidede ekspedisjoner og utforskningslogg.',
    sv: 'I appen: uppslagsindex, epoktidslinje, normandiska namn, berättelsebågar med länkar till berättelsebiblioteket, guidade expeditioner och din utforskningsjournal.',
    da: 'I appen: opslagsindex, epoketidslinje, normanniske navne, fortællebuer med links til historiebiblioteket, guidede ekspeditioner og din udforskningsjournal.',
  },
  ...
  'genealogy.navSection.workspace': {
    en: 'Workspace',
    fr: 'Espace',
    es: 'Espacio',
    it: 'Spazio',
  ...
  'genealogy.navSection.resources': {
    en: 'Library & lookup',
    fr: 'Bibliothèque et références',
    es: 'Biblioteca y consulta',
    it: 'Biblioteca e riferimenti',
    de: 'Bibliothek & Nachschlagewerk',
    nb: 'Bibliotek og oppslag',
    sv: 'Bibliotek och uppslag',
    da: 'Bibliotek og opslag',
  },
  ...
  /** Short strip label (full name: atlas journal). */
  'genealogy.subnav.journal': {
    en: 'Journal',
    fr: 'Journal',
    es: 'Diario',
    it: 'Diario',
  ...
  /** Short strip label for /reference (hub); avoids “Guides & reference” wrapping. */
  'genealogy.subnav.reference': {
    en: 'Reference',
    fr: 'Référence',
    es: 'Referencia',
    it: 'Riferimenti',
  ...
  'ancestryJourney.stepMapEraSimYear': {
    en: 'Simulation year: {year}',
    fr: 'Année de simulation : {year}',
    es: 'Año de simulación: {year}',
    it: 'Anno di simulazione: {year}',
    de: 'Simulationsjahr: {year}',
    nb: 'Simuleringsår: {year}',
    sv: 'Simuleringsår: {year}',
    da: 'Simuleringsår: {year}',
  },
  'ancestryJourney.stepMapEraLayers': {
    en: 'Map layers turned on: {layers}',
    fr: 'Calques activés : {layers}',
    es: 'Capas activadas: {layers}',
    it: 'Livelli attivi: {layers}',
    de: 'Eingeschaltete Ebenen: {layers}',
    nb: 'Kartlag på: {layers}',
    sv: 'Kartlager på: {layers}',
    da: 'Kortlag til: {layers}',
  },
  'ancestryJourney.stepMapFly': {
    en: 'Flying to {place}',
    fr: 'Vol vers {place}',
    es: 'Vuelo a {place}',
    it: 'Volo verso {place}',
    de: 'Flug nach {place}',
    nb: 'Flyr til {place}',
    sv: 'Flyger till {place}',
    da: 'Flyver til {place}',
  },
  'ancestryJourney.stepMapFlyGeneric': {
    en: 'Moving the map',
    fr: 'Déplacement sur la carte',
    es: 'Moviendo el mapa',
    it: 'Spostamento sulla mappa',
    de: 'Karte bewegen',
    nb: 'Flytter kartet',
    sv: 'Flyttar kartan',
    da: 'Flytter kortet',
  },
  'ancestryJourney.stepMapFlyCoords': {
    en: 'Zooming to coordinates {lng}, {lat}',
    fr: 'Zoom sur {lng}, {lat}',
    es: 'Zoom a {lng}, {lat}',
    it: 'Zoom su {lng}, {lat}',
    de: 'Zoom auf {lng}, {lat}',
    nb: 'Zoom til {lng}, {lat}',
    sv: 'Zoom till {lng}, {lat}',
    da: 'Zoom til {lng}, {lat}',
  },
  'ancestryJourney.stepLineageTitle': {
    en: 'Lineage explorer: {name}',
    fr: 'Explorateur de lignées : {name}',
    es: 'Explorador de linajes: {name}',
    it: 'Esplora lignaggi: {name}',
    de: 'Linien-Explorer: {name}',
    nb: 'Linjeutforsker: {name}',
    sv: 'Linjeutforskare: {name}',
    da: 'Linjeudforsker: {name}',
  },
  'ancestryJourney.stepLineageLens': {
    en: 'Time lens: {lens}',
    fr: 'Fenêtre temporelle : {lens}',
    es: 'Lente temporal: {lens}',
    it: 'Lente temporale: {lens}',
    de: 'Zeitlinse: {lens}',
    nb: 'Tidsfilter: {lens}',
    sv: 'Tidslins: {lens}',
    da: 'Tidslinse: {lens}',
  },
  'ancestryJourney.stepLineageMacro': {
    en: 'Broader “historical presence” overlay at year {year}.',
    fr: 'Couche « présence historique » (vue large) vers l’an {year}.',
    es: 'Capa amplia de “presencia histórica” en el año {year}.',
    it: 'Overlay “presenza storica” ampia nell’anno {year}.',
    de: 'Breitere „Historical Presence“-Ebene im Jahr {year}.',
    nb: 'Bred «historisk tilstedeværelse»-overlegg ved år {year}.',
    sv: 'Bred “historisk närvaro”-överlagring vid år {year}.',
    da: 'Bred «historisk tilstedeværelse»-overlay ved år {year}.',
  },
  'ancestryJourney.lineageLens.deep': {
    en: 'Deep origins',
    fr: 'Origines profondes',
    es: 'Orígenes profundos',
    it: 'Origini profonde',
  ...
  'ancestryJourney.lineageLens.antiquity': {
    en: 'Antiquity',
    fr: 'Antiquité',
    es: 'Antigüedad',
    it: 'Antichità',
  ...
  'ancestryJourney.lineageLens.early_medieval': {
    en: 'Early medieval',
    fr: 'Haut Moyen Âge',
    es: 'Alta Edad Media',
    it: 'Alto Medioevo',
  ...
  'ancestryJourney.lineageLens.high_medieval': {
    en: 'High medieval',
    fr: 'Classique / bas Moyen Âge',
    es: 'Plena Edad Media',
    it: 'Alto-basso Medioevo',
    de: 'Hohes Mittelalter',
    nb: 'Høymiddelalder',
    sv: 'Högmedeltid',
    da: 'Højmiddelalder',
  },
  'ancestryJourney.lineageLens.colonial': {
    en: 'Colonial era',
    fr: 'Époque coloniale',
    es: 'Época colonial',
    it: 'Epoca coloniale',
  ...
  'ancestryJourney.stepStoryBeatFallbackTitle': {
    en: 'Story chapter',
    fr: 'Chapitre narratif',
    es: 'Capítulo',
    it: 'Capitolo',
    de: 'Geschichtskapitel',
    nb: 'Forteljingkapittel',
    sv: 'Berättelsekapitel',
    da: 'Fortællingskapitel',
  },
  'ancestryJourney.stepStoryBeatFallbackBody': {
    en: 'This story beat is loading — use the story bar if it appears.',
    fr: 'Ce passage se charge — utilisez la barre d’histoire si elle apparaît.',
    es: 'Cargando este pasaje — use la barra de historia si aparece.',
    it: 'Caricamento — usa la barra della storia se compare.',
    de: 'Dieses Kapitel lädt — nutzen Sie die Geschichtsleiste.',
    nb: 'Laster — bruk historielinjen hvis den vises.',
    sv: 'Laddar — använd historikfältet om det visas.',
    da: 'Indlæser — brug historiklinjen hvis den vises.',
  },
  'ancestryJourney.stepStoryBeatHint': {
    en: 'Use the story bar on the map for full narrative beats. The sampler arrows move the overall tour; they are not tied to each story slide.',
    fr: 'Utilisez la barre d’histoire pour lire les passages. Les flèches de l’aperçu font avancer le parcours global, pas chaque diapositive.',
    es: 'Use la barra de historia para el relato completo. Las flechas del recorrido mueven el tour general.',
    it: 'Usa la barra della storia per il racconto. Le frecce del percorso cambiano il tour complessivo.',
    de: 'Nutzen Sie die Geschichtsleiste für den Text. Die Pfeile im Ausblick wechseln die Gesamtführung.',
    nb: 'Bruk historielinjen for fortellingen. Pilene i sampleren styrer hele omvisningen.',
    sv: 'Använd historikfältet för berättelsen. Sampler-pilarna styr hela rundturen.',
    da: 'Brug historiklinjen til narrativet. Sampler-pile styr hele rundvisningen.',
  },
  'ancestryJourney.truncatedFootnote': {
    en: 'Showing the first {shown} of {total} steps.',
    fr: 'Affichage des {shown} premières étapes sur {total}.',
    es: 'Mostrando los primeros {shown} pasos de {total}.',
    it: 'Mostrati i primi {shown} passi su {total}.',
    de: 'Es werden die ersten {shown} von {total} Schritten gezeigt.',
    nb: 'Viser de første {shown} av {total} steg.',
    sv: 'Visar de första {shown} av {total} steg.',
    da: 'Viser de første {shown} af {total} trin.',
  },
  ...
  'referenceHub.tabsAria': {
    en: 'Library sections',
    fr: 'Sections de la bibliothèque',
    es: 'Secciones de la biblioteca',
    it: 'Sezioni della biblioteca',
    de: 'Bibliotheksbereiche',
    nb: 'Bibliotekseksjoner',
    sv: 'Biblioteksavsnitt',
    da: 'Bibliotekssektioner',
  },
  /** First hub tab: overview at `/reference` (hero + section cards). */
  'referenceHub.homeTab': {
    en: 'Library',
    fr: 'Bibliothèque',
    es: 'Biblioteca',
    it: 'Biblioteca',
  ...
  'mobileNav.commandPalette': {
    en: 'Search & commands',
    fr: 'Recherche et commandes',
    es: 'Buscar y comandos',
    it: 'Cerca e comandi',
    de: 'Suche & Befehle',
    nb: 'Søk og kommandoer',
    sv: 'Sök och kommandon',
    da: 'Søg og kommandoer',
  },
  'mobileNav.genealogyMoreTitle': {
    en: 'More genealogy',
    fr: 'Plus de généalogie',
    es: 'Más genealogía',
    it: 'Altra genealogia',
    de: 'Weitere Genealogie',
    nb: 'Mer slektsforskning',
    sv: 'Mer genealogi',
    da: 'Mere slægtsforskning',
  },
  'mobileNav.continueJourney': {
    en: 'Continue journey',
    fr: 'Poursuivre le parcours',
    es: 'Continuar recorrido',
  ...
  /** Single hero paragraph: replaces stacked taglines + hub intro. */
  'referenceHub.intro': {
    en: 'Guides, readings, and the companion handbook sit next to your journal and genealogy workspace—everything stays linked to the map. Open the Story Library from the tools menu to browse chronicles and arcs without starting playback. Use the tabs to switch quickly, or choose a section below.',
    fr: 'Guides, lectures et compagnon côtoient journal et espace généalogie—le tout reste relié à la carte. Ouvrez la bibliothèque d’histoires depuis le menu d’outils pour parcourir chroniques et arcs sans lancer la lecture. Utilisez les onglets pour aller vite, ou choisissez une section ci-dessous.',
    es: 'Guías, lecturas y el manual comparten espacio con tu diario y la genealogía—todo enlazado al mapa. Abre la biblioteca de historias desde el menú de herramientas para explorar crónicas y arcos sin iniciar la reproducción. Usa las pestañas para ir rápido o elige una sección abajo.',
    it: 'Guide, letture e companion affiancano diario e genealogia—tutto legato alla mappa. Apri la libreria di storie dal menu strumenti per sfogliare croniche e archi senza avviare la riproduzione. Usa le schede per spostarti in fretta o scegli una sezione sotto.',
    de: 'Guides, Texte und Begleitbuch liegen neben Journal und Genealogie—alles bleibt mit der Karte verknüpft. Öffnen Sie die Geschichtenbibliothek über das Werkzeugmenü, um Chroniken und Bögen zu stöbern, ohne die Wiedergabe zu starten. Wechseln Sie über die Tabs oder wählen Sie unten einen Bereich.',
    nb: 'Guider, tekster og følgebok står ved siden av journal og slektsarbeid—alt er knyttet til kartet. Åpne historiebiblioteket fra verktøymenyen for å bla i krøniker og buer uten å starte avspilling. Bruk fanene for raske bytter, eller velg en seksjon nedenfor.',
    sv: 'Guider, texter och följeslagare ligger bredvid journal och genealogi—allt kopplat till kartan. Öppna berättelsebiblioteket från verktygsmenyn för att bläddra i krönikor och bågar utan att starta uppspelning. Använd flikarna för snabba byten eller välj ett avsnitt nedan.',
    da: 'Guider, tekster og ledsager ligger ved siden af journal og slægtsarbejde—alt forbunden med kortet. Åbn historiebiblioteket fra værktøjsmenuen for at gennemse krøniker og buer uden at starte afspilning. Brug fanerne til hurtige skift, eller vælg en sektion nedenfor.',
  },
  /** Shelf heading: curated texts & reference material. */
  'referenceHub.shelfReadTitle': {
    en: 'Read & reference',
    fr: 'Lire & références',
    es: 'Lectura y referencia',
    it: 'Lettura e riferimenti',
    de: 'Lesen & Nachschlagen',
    nb: 'Lesing og oppslagsverk',
    sv: 'Läsning och referens',
    da: 'Læsning og opslagsværk',
  },
  /** Shelf heading: personal notes & genealogy tools. */
  'referenceHub.shelfWorkspaceTitle': {
    en: 'Journal & genealogy',
    fr: 'Journal & généalogie',
    es: 'Diario y genealogía',
    it: 'Diario e genealogia',
    de: 'Journal & Genealogie',
    nb: 'Journal og slektsforskning',
    sv: 'Journal och genealogi',
    da: 'Journal og slægtsforskning',
  },
  'referenceHub.cardsNavAria': {
    en: 'Library sections: digital guides, readings, companion, journal, genealogy',
    fr: 'Sections : guides numériques, lectures, compagnon, journal, généalogie',
    es: 'Secciones: guías digitales, lecturas, compañero, diario, genealogía',
    it: 'Sezioni: guide digitali, letture, companion, diario, genealogia',
    de: 'Bereiche: digitale Guides, Texte, Begleiter, Journal, Genealogie',
    nb: 'Seksjoner: digitale guider, tekster, følgebok, journal, slektsforskning',
    sv: 'Avsnitt: digitala guider, texter, följeslagare, journal, genealogi',
    da: 'Sektioner: digitale guider, tekster, ledsager, journal, slægtsforskning',
  },
  'referenceHub.cardGenealogyHint': {
    en: 'Workspace, deep-origins map, DNA compare tools, and lookups—grounded in the atlas.',
    fr: 'Espace de travail, carte des origines profondes, outils ADN et références—ancrés dans l’atlas.',
    es: 'Espacio de trabajo, mapa de orígenes, ADN y consultas—ligados al atlas.',
    it: 'Area di lavoro, mappa delle origini, confronti DNA e riferimenti—nell’atlante.',
    de: 'Arbeitsbereich, Ursprungskarte, DNA-Vergleich und Nachschlagen—im Atlas verankert.',
    nb: 'Arbeidsflate, opphavskart, DNA-sammenligning og oppslag—forankret i atlaset.',
    sv: 'Arbetsyta, ursprungskarta, DNA-jämförelser och uppslag—i atlasen.',
    da: 'Arbejdsrum, oprindelseskort, DNA-sammenligning og opslag—forankret i atlaset.',
  },
  ...
  'flythrough.picker.tooltip.label': {
    en: 'Viking route flythroughs',
    fr: 'Survols des routes vikings',
    es: 'Recorridos aéreos de rutas vikingas',
    it: 'Voli sulle rotte vichinghe',
    de: 'Wikinger-Routen-Überflüge',
    nb: 'Viking route flythroughs',
    sv: 'Vikingarutter — genomflygning',
    da: 'Vikinge-ruter — gennemflyvning',
  },
  'flythrough.picker.tooltip.hint': {
    en: 'Play a cinematic flight along a migration corridor. Click to choose Danish, Celtic Sea, or both routes.',
    fr: 'Lancez un survol le long d\u2019un corridor migratoire. Cliquez pour choisir danois, mer Celtique ou les deux.',
    es: 'Reproduce un vuelo por un corredor migratorio. Elige danés, mar Celta o ambos.',
    it: 'Avvia un volo lungo un corridoio migratorio. Scegli danese, mare Celtico o entrambi.',
    de: 'Starten Sie einen Flug entlang eines Migrationskorridors. Dänisch, Keltische See oder beides wählen.',
    nb: 'Play a cinematic flight along a migration corridor. Click to choose Danish, Celtic Sea, or both routes.',
    sv: 'Spela ett flyg längs en migrationskorridor. Välj dansk rutt, keltiska havet eller båda.',
    da: 'Afspil en flyvetur langs en migrationskorridor. Vælg dansk, keltiske hav eller begge.',
  },
  'flythrough.picker.menuAria': {
    en: 'Choose a flythrough route',
    fr: 'Choisir une route de survol',
    es: 'Elegir ruta de sobrevuelo',
    it: 'Scegli un percorso di sorvolo',
    de: 'Überflugroute wählen',
    nb: 'Choose a flythrough route',
    sv: 'Välj flygväg',
    da: 'Vælg gennemflyvningsrute',
  },
  ...
  'launcher.openSheet.aria': {
    en: 'Open story menu for this era — flythroughs and more stories',
    fr: 'Ouvrir le menu des récits pour cette ère — survols et autres récits',
    es: 'Abrir el menú de historias de esta época: vuelos y más relatos',
    it: 'Apri il menu storie per quest\u2019epoca \u2014 percorsi e altre storie',
    de: 'Geschichtenmenü für diese Epoche öffnen — Rundflüge und weitere Geschichten',
    nb: 'Open story menu for this era — flythroughs and more stories',
    sv: 'Öppna berättelsemeny för den här eran — flygningar och fler berättelser',
    da: 'Åbn historiemenu for denne æra — gennemflyvninger og flere historier',
  },
  'launcher.idle.moreStoriesCaption': {
    en: '+{n} more this era',
    fr: '+{n} de plus',
    es: '+{n} más',
    it: '+{n} in più',
  ...
  'launcher.idle.primary.tooltip.label': {
    en: 'Play this era\u2019s main arc',
    fr: 'Lancer le récit principal de l\u2019ère',
    es: 'Reproducir el arco principal',
    it: 'Avvia l\u2019arco principale dell\u2019epoca',
    de: 'Haupterzählung dieser Epoche starten',
    nb: 'Play this era\u2019s main arc',
    sv: 'Spela erans huvudbåge',
    da: 'Afspil ærens hovedbue',
  },
  'launcher.idle.primary.tooltip.hintWithMore': {
    en: 'This era also has {n} more stories — open the list on the right.',
    fr: 'Cette ère compte aussi {n} autres récits — ouvrez la liste à droite.',
    es: 'Esta época tiene {n} historias más: abre la lista a la derecha.',
    it: 'Ci sono altre {n} storie in quest\u2019epoca — apri la lista a destra.',
    de: 'Diese Epoche hat außerdem {n} weitere Geschichten — Liste rechts öffnen.',
    nb: 'This era also has {n} more stories — open the list on the right.',
    sv: 'Eran har också {n} fler berättelser — öppna listan till höger.',
    da: 'Æraen har også {n} flere historier — åbn listen til højre.',
  },
  'launcher.idle.primary.tooltip.hintMainOnly': {
    en: 'The list on the right has flythroughs and the full story menu.',
    fr: 'La liste à droite propose survols et menu complet.',
    es: 'La lista a la derecha: vuelos y el menú de historias.',
    it: 'La lista a destra: percorsi e menu completo.',
    de: 'Die Liste rechts: Rundflüge und das volle Menü.',
    nb: 'The list on the right has flythroughs and the full story menu.',
    sv: 'Listan till höger har flygningar och hela menyn.',
    da: 'Listen til højre har gennemflyvninger og hele historiemenuen.',
  },
  'launcher.idle.list.tooltip.label': {
    en: 'Every story for this era',
    fr: 'Tous les récits de cette ère',
    es: 'Todas las historias de la época',
    it: 'Tutte le storie dell\u2019epoca',
    de: 'Alle Geschichten dieser Epoche',
    nb: 'Every story for this era',
    sv: 'Alla berättelser för eran',
    da: 'Alle historier for æraen',
  },
  'launcher.idle.list.tooltip.hintWithMore': {
    en: '{n} more arcs plus flythroughs — tap to browse.',
    fr: '{n} autres arcs et survols — touchez pour parcourir.',
    es: '{n} arcos más y vuelos — toca para ver.',
    it: 'Altri {n} archi e percorsi — tocca per sfogliare.',
    de: '{n} weitere Bögen plus Rundflüge — tippen zum Stöbern.',
    nb: '{n} more arcs plus flythroughs — tap to browse.',
    sv: '{n} fler bågar plus flygningar — tryck för att bläddra.',
    da: '{n} flere buer plus gennemflyvninger — tryk for at gennemse.',
  },
  'launcher.idle.list.tooltip.hintMainOnly': {
    en: 'Flythroughs, other periods, and full library.',
    fr: 'Survols, autres époques et bibliothèque.',
    es: 'Vuelos, otras épocas y biblioteca.',
    it: 'Percorsi, altre epoche e biblioteca.',
    de: 'Rundflüge, andere Epochen, ganze Bibliothek.',
    nb: 'Flythroughs, other periods, and full library.',
    sv: 'Flygningar, andra perioder och biblioteket.',
    da: 'Gennemflyvninger, andre perioder og bibliotek.',
  },
  'launcher.idle.primary.aria.withMore': {
    en: 'Play main story: {title}. {n} more stories in this era — use the story list button.',
    fr: 'Lancer le récit principal : {title}. {n} autres récits pour cette ère — utilisez le bouton liste.',
    es: 'Reproducir la historia principal: {title}. {n} historias más en esta época: botón de lista.',
    it: 'Avvia la storia principale: {title}. Altre {n} storie in quest\u2019epoca — pulsante lista.',
    de: 'Haupterzählung starten: {title}. {n} weitere Geschichten in dieser Epoche — Listen-Schaltfläche.',
    nb: 'Play main story: {title}. {n} more stories in this era — use the story list button.',
    sv: 'Spela huvudberättelsen: {title}. {n} fler berättelser den här eran — använd listknappen.',
    da: 'Afspil hovedhistorie: {title}. {n} flere historier i denne æra — brug listeknappen.',
  },
  'launcher.idle.primary.aria.mainOnly': {
    en: 'Play main story for this era: {title}. Open the story list for flythroughs and the full library.',
    fr: 'Lancer le récit principal de cette ère : {title}. Ouvrez la liste pour les survols et la bibliothèque.',
    es: 'Reproducir la historia principal de esta época: {title}. Abre la lista para vuelos y la biblioteca.',
    it: 'Avvia la storia principale di quest\u2019epoca: {title}. Apri la lista per percorsi e biblioteca.',
    de: 'Haupterzählung dieser Epoche starten: {title}. Liste öffnen für Rundflüge und die Bibliothek.',
    nb: 'Play main story for this era: {title}. Open the story list for flythroughs and the full library.',
    sv: 'Spela huvudberättelsen för den här eran: {title}. Öppna listan för flygningar och biblioteket.',
    da: 'Afspil hovedhistorie for denne æra: {title}. Åbn listen for gennemflyvninger og biblioteket.',
  },
  'launcher.title': {
    en: 'Stories',
    fr: 'Récits',
  ...
  'launcher.tagline': {
    en: 'The main story for the era on your map is below—play in one tap. Open the library to see this era, every other period, and search the full chronicle.',
    fr: 'Le r\u00e9cit principal de l\u2019\u00e9poque sur votre carte est ci-dessous\u2014lancez d\u2019un geste. Ouvrez la biblioth\u00e8que pour cette \u00e9poque, toutes les autres p\u00e9riodes et la recherche dans toute la chronique.',
    es: 'La historia principal de la época en tu mapa está abajo: empieza con un toque. Abre la biblioteca para ver esta época, el resto de periodos y buscar en toda la crónica.',
    it: 'La storia principale per l\u2019epoca sulla mappa \u00e8 qui sotto: avvia con un tocco. Apri la biblioteca per quest\u2019epoca, tutti gli altri periodi e la ricerca nell\u2019intera cronaca.',
    de: 'Die Haupterzählung zur Epoche auf Ihrer Karte steht unten—starten Sie mit einem Tipp. Öffnen Sie die Bibliothek für diese Epoche, alle anderen Zeiten und die Suche in der ganzen Chronik.',
    nb: 'The main story for the era on your map is below—play in one tap. Open the library to see this era, every other period, and search the full chronicle.',
    sv: 'Huvudberättelsen för eran på din karta finns nedan—spela upp med ett tryck. Öppna biblioteket för den här eran, alla andra perioder och sök i hela krönikan.',
    da: 'Hovedhistorien for æraen på dit kort er nedenfor—start med ét tryk. Åbn biblioteket for at se denne æra, alle andre perioder og søge i hele krøniken.',
  },
  ...
  'launcher.browseAll': {
    en: 'Browse story library',
    fr: 'Parcourir la biblioth\u00e8que de r\u00e9cits',
    es: 'Explorar la biblioteca de historias',
    it: 'Sfoglia la biblioteca di storie',
    de: 'Geschichtenbibliothek durchsuchen',
    nb: 'Browse story library',
    sv: 'Bläddra i berättelsebiblioteket',
    da: 'Gennemse historiebiblioteket',
  },
  'launcher.browseAll.hint': {
    en: 'This era first, then all periods—arcs, journeys, search',
    fr: 'D\u2019abord cette \u00e9poque, puis toutes les p\u00e9riodes\u2014arcs, parcours, recherche',
    es: 'Primero esta época, luego todos los períodos: arcos, recorridos, búsqueda',
    it: 'Prima quest\u2019epoca, poi tutti i periodi\u2014archi, percorsi, ricerca',
    de: 'Zuerst diese Epoche, dann alle Zeiten—Bögen, Reisen, Suche',
    nb: 'This era first, then all periods—arcs, journeys, search',
    sv: 'Först den här eran, sedan alla perioder—bågar, resor, sökning',
    da: 'Først denne æra, derefter alle perioder—buer, rejser, søgning',
  },
  'launcher.moreThisEra': {
    en: '{count} more for this era',
    fr: '{count} de plus pour cette \u00e9poque',
    es: '{count} m\u00e1s en esta \u00e9poca',
    it: '{count} altre in quest\u2019epoca',
    de: '{count} weitere in dieser Epoche',
    nb: '{count} more for this era',
    sv: '{count} till för den här eran',
    da: '{count} flere for denne æra',
  },
  'launcher.aria.close': {
  ...
  'billing.gate.title': {
    en: 'Unlock research tools',
    fr: 'Débloquer les outils de recherche',
  },
  'billing.gate.close': {
    en: 'Close',
    fr: 'Fermer',
  },
  'billing.gate.bodyMacroCompare': {
    en: 'Year-over-year macro presence compare and the dual map overlay are part of Atlas Pro — built for people who live in the evidence view.',
    fr: 'La comparaison macro entre deux années et la double couche cartographique font partie d’Atlas Pro — pensées pour celles et ceux qui travaillent dans la vue « preuves ».',
  },
  'billing.gate.bodyMacroCsv': {
    en: 'Exporting the full macro slice as CSV is an Atlas Pro feature — it keeps the free atlas fast while funding deeper dataset maintenance.',
    fr: 'L’export CSV de la tranche macro complète est une fonction Atlas Pro — cela garde l’atlas gratuit rapide tout en finançant la maintenance des jeux de données.',
  },
  'billing.gate.bodyLineageCompare': {
    en: 'Side-by-side lineage comparison across atlas themes is included with Atlas Pro.',
    fr: 'La comparaison côte à côte des lignées (thèmes de l’atlas) est incluse dans Atlas Pro.',
  },
  'billing.gate.immersion': {
    en: 'Stories and the cinematic map stay free — we only ask here when you need power tools.',
    fr: 'Les récits et la carte cinématique restent gratuits — cette étape arrive seulement quand vous avez besoin d’outils avancés.',
  },
  'billing.gate.ctaUpgrade': {
    en: 'Upgrade with Stripe',
    fr: 'Passer à Pro via Stripe',
  },
  'billing.gate.detailsOnProfile': {
    en: 'View plans on profile',
    fr: 'Voir les offres sur le profil',
  },
  'billing.gate.checkoutPausedNote': {
    en: 'Atlas Pro checkout is almost here — bookmark the site and check back; when we open, the upgrade path will be one click from here and from your profile.',
    fr: 'Le paiement Atlas Pro arrive bientôt — gardez le site en favori et revenez ; à l’ouverture, la mise à niveau sera à un clic d’ici et depuis votre profil.',
  },
  'billing.gate.ctaComingSoon': {
    en: 'Upgrade — coming soon',
    fr: 'Passer à Pro — bientôt',
  },
  'billing.pro.cardTitle': {
    en: 'Atlas Pro',
    fr: 'Atlas Pro',
  },
  'billing.pro.cardHint': {
    en: 'Macro compare, CSV export, and lineage comparison — funding ongoing atlas work.',
    fr: 'Comparaison macro, export CSV et comparaison de lignées — pour financer le travail sur l’atlas.',
  },
  'billing.pro.statusActive': {
    en: 'Your subscription is active.',
    fr: 'Votre abonnement est actif.',
  },
  'billing.pro.statusInstitution': {
    en: 'Institution seat',
    fr: 'Siège institutionnel',
  },
  'billing.pro.statusDev': {
    en: 'Dev bypass — all Pro tools enabled.',
    fr: 'Contournement dev — tous les outils Pro activés.',
  },
  'billing.pro.manage': {
    en: 'Manage billing',
  ...
  'billing.pro.upgrade': {
    en: 'Upgrade to Atlas Pro',
    fr: 'Passer à Atlas Pro',
  },
  'billing.pro.notConfigured': {
    en: 'Checkout will be available once billing is configured on the server.',
    fr: 'Le paiement sera disponible une fois la facturation configurée sur le serveur.',
  },
  'billing.pro.upgradeComingSoon': {
    en: 'Atlas Pro — coming soon',
    fr: 'Atlas Pro — bientôt',
  },
  'billing.pro.upgradeComingSoonHint': {
    en: 'Checkout is not open yet — we will enable this button when Atlas Pro launches.',
    fr: 'Le paiement n’est pas encore ouvert — ce bouton s’activera au lancement d’Atlas Pro.',
  },
  'billing.pro.teaserReturn': {
    en: 'Save this page — we are finishing checkout and will turn this into a live upgrade as soon as it is ready.',
    fr: 'Gardez cette page — nous finalisons le paiement et activerons la mise à niveau dès qu’elle sera prête.',
  },
  'billing.pro.educationLink': {
    en: 'Schools & libraries',
    fr: 'Écoles et bibliothèques',
  },
  'billing.education.title': {
    en: 'Education & institutions',
    fr: 'Éducation et institutions',
  },
  'billing.education.comingSoonBanner': {
    en: 'Institution pilot — preview only. Key redemption and licensing email are not open yet; you can read what we are planning below.',
    fr: 'Pilote institution — aperçu seulement. L’activation par clé et le courriel de licence ne sont pas encore ouverts ; vous pouvez lire ce que nous préparons ci-dessous.',
  },
  'billing.education.lead': {
    en: 'Pilot licenses for classrooms: seat keys unlock the same research tools as Atlas Pro for your cohort. For purchase orders and custom scopes, contact us.',
    fr: 'Licences pilote pour les classes : des clés de siège débloquent les mêmes outils de recherche qu’Atlas Pro pour votre cohorte. Pour les bons de commande et périmètres sur mesure, contactez-nous.',
  },
  'billing.education.leadPreview': {
    en: 'We are preparing pilot licenses for classrooms: seat keys will unlock the same research tools as Atlas Pro for your cohort, with purchase orders and custom scopes when we open. Nothing on this page can be submitted yet — check back or bookmark Norman Atlas.',
    fr: 'Nous préparons des licences pilote pour les classes : des clés de siège débloqueront les mêmes outils qu’Atlas Pro pour votre cohorte, avec bons de commande et périmètres sur mesure à l’ouverture. Rien sur cette page n’est encore actif — revenez plus tard ou gardez Norman Atlas en favori.',
  },
  'billing.education.redeemLabel': {
    en: 'Redeem institution key',
    fr: 'Activer une clé institution',
  },
  'billing.education.redeemPlaceholder': {
    en: 'Paste your seat key',
    fr: 'Collez votre clé de siège',
  },
  'billing.education.redeemCta': {
    en: 'Activate',
    fr: 'Activer',
  },
  'billing.education.redeemSuccess': {
    en: 'Activated for',
    fr: 'Activé pour',
  },
  'billing.education.redeemError': {
    en: 'Could not activate that key.',
    fr: 'Impossible d’activer cette clé.',
  },
  'billing.education.redeemNeedsApi': {
    en: 'Institution keys require a billing API URL (NEXT_PUBLIC_BILLING_API_URL).',
    fr: 'Les clés institution nécessitent une URL d’API de facturation (NEXT_PUBLIC_BILLING_API_URL).',
  },
  'billing.education.contact': {
    en: 'Email for licensing & POs',
    fr: 'Courriel pour licences et bons de commande',
  },
  'billing.education.contactInstructions': {
    en: 'Include your institution, approximate seat count, and whether you need a purchase order or invoice.',
    fr: 'Indiquez l’établissement, le nombre de sièges souhaité, et si vous avez besoin d’un bon de commande.',
  },
  'billing.education.contactComingSoon': {
    en: 'A direct licensing address for purchase orders and custom scopes will appear here when the pilot opens. For now there is no public email on this page.',
    fr: 'Une adresse dédiée pour les licences, bons de commande et périmètres sur mesure apparaîtra ici à l’ouverture du pilote. Il n’y a pas encore de courriel public sur cette page.',
  },
  'billing.education.contactNotConfigured': {
    en: 'Licensing contact is not published on this build. Operators can set NEXT_PUBLIC_EDUCATION_CONTACT_EMAIL.',
    fr: 'Le contact licence n’est pas publié sur cette version. Les opérateurs peuvent définir NEXT_PUBLIC_EDUCATION_CONTACT_EMAIL.',
  },
  'billing.education.redeemComingSoon': {
    en: 'Activate — coming soon',
    fr: 'Activer — bientôt',
  },
  'billing.education.redeemComingSoonHint': {
    en: 'Key redemption opens when the institution pilot launches.',
    fr: 'L’activation par clé s’ouvrira au lancement du pilote institution.',
  },
  'billing.education.redeemPreviewNote': {
    en: 'This is a preview of the form — fields stay disabled until we open the pilot.',
    fr: 'Aperçu du formulaire — les champs restent désactivés jusqu’à l’ouverture du pilote.',
  },
  'toolsMenu.atlasProLabel': {
    en: 'Atlas Pro',
    fr: 'Atlas Pro',
  },
  'toolsMenu.atlasProHint': {
    en: 'Plans, institution keys, and billing',
    fr: 'Offres, clés institution et facturation',
  },
  'toolsMenu.atlasProHintSoon': {
    en: 'Plans opening soon — check your profile to watch for launch',
    fr: 'Offres bientôt — consultez votre profil pour le lancement',
  },
  'toolsMenu.educationLabel': {
    en: 'Education pilot',
    fr: 'Pilote éducation',
  },
  'toolsMenu.educationHint': {
    en: 'Institution seats and PO contact',
    fr: 'Sièges institution et contact achats',
  },
