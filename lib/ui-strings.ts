...
const STRINGS = {
  ...
  'referenceHub.heroEyebrow': {
    en: 'Reference hub',
    fr: 'Espace références',
    es: 'Centro de referencia',
    it: 'Hub di riferimento',
    de: 'Referenz-Hub',
    nb: 'Referansesenter',
    sv: 'Referensnav',
    da: 'Reference-hub',
  ...
  'referenceHub.heroTagline1': {
    en: 'Digital guides, in-app journal, Norman readings, genealogy tools, and the companion handbook—each tied to the map.',
    fr: 'Guides numériques, journal intégré, lectures normandes, outils de généalogie et compagnon—le tout relié à la carte.',
    es: 'Guías digitales, diario en la app, lecturas normandas, genealogía y compañero, todo enlazado al mapa.',
    it: 'Guide digitali, diario in app, letture normanne, genealogia e companion—legati alla mappa.',
    de: 'Digitale Guides, In-App-Journal, normannische Texte, Genealogie-Tools und Begleitbuch—verbunden mit der Karte.',
    nb: 'Digitale guider, app-journal, normanniske tekster, slektsverktøy og følgebok—knyttet til kartet.',
    sv: 'Digitala guider, appjournal, normandiska texter, genealogiverktyg och följeslagare—kopplat till kartan.',
    da: 'Digitale guider, app-journal, normanniske tekster, slægtsværktøjer og ledsager—knyttet til kortet.',
  },
  'referenceHub.heroTagline2': {
    en: 'Use the tabs above for quick moves, or open a shelf below. Built for explorers, teachers, and historians alike.',
    fr: 'Utilisez les onglets pour naviguer vite, ou ouvrez une section ci-dessous. Pour explorateurs, enseignants et historiens.',
    es: 'Use las pestañas para moverse rápido o abra una sección abajo. Para exploradores, docentes e historiadores.',
    it: 'Usa le schede per spostarti in fretta o apri uno scaffale sotto. Per esploratori, insegnanti e storici.',
    de: 'Nutzen Sie die Tabs zum schnellen Wechsel oder öffnen Sie unten ein Regal. Für Entdecker, Lehrende und Historiker.',
    nb: 'Bruk fanene for raske bytter, eller åpne en hylle nedenfor. For utforskere, lærere og historikere.',
    sv: 'Använd flikarna för snabba byten eller öppna en hylla nedan. För utforskare, lärare och historiker.',
    da: 'Brug fanerne til hurtige skift, eller åbn en hylde nedenfor. Til udforskere, undervisere og historikere.',
  },
  'referenceHub.hubIntro': {
    en: 'Each card matches a tab in this library—your map stays one tap away.',
    fr: 'Chaque carte correspond à un onglet de cette bibliothèque—la carte reste à un geste.',
    es: 'Cada tarjeta coincide con una pestaña de esta biblioteca: el mapa sigue a un toque.',
    it: 'Ogni scheda corrisponde a una linguetta della biblioteca: la mappa è a un tocco.',
    de: 'Jede Karte entspricht einem Tab dieser Bibliothek—zur Karte ist es nur ein Tipp.',
    nb: 'Hvert kort svarer til en fane i biblioteket—kartet er ett trykk unna.',
    sv: 'Varje kort motsvarar en flik i biblioteket—kartan är ett tryck bort.',
    da: 'Hvert kort matcher en fane i biblioteket—kortet er ét tryk væk.',
  },
  'referenceHub.intro': {
    en: 'Choose a tab or a shelf: digital guides (when available), journal, readings, genealogy, or companion.',
    fr: 'Choisissez un onglet ou une section : guides numériques (si disponibles), journal, lectures, généalogie ou compagnon.',
    es: 'Elija una pestaña o sección: guías digitales (si hay), diario, lecturas, genealogía o compañero.',
    it: 'Scegli una scheda o uno scaffale: guide digitali (se disponibili), diario, letture, genealogia o companion.',
    de: 'Wählen Sie Tab oder Regal: digitale Guides (falls verfügbar), Journal, Texte, Genealogie oder Begleiter.',
    nb: 'Velg fane eller hylle: digitale guider (når tilgjengelig), journal, tekster, slektsforskning eller følgebok.',
    sv: 'Välj flik eller hylla: digitala guider (när de finns), journal, texter, genealogi eller följeslagare.',
    da: 'Vælg fane eller hylde: digitale guider (når tilgængelige), journal, tekster, slægtsforskning eller ledsager.',
  },
  'referenceHub.cardsNavAria': {
    en: 'Library sections: digital guides, journal, readings, genealogy, companion',
    fr: 'Sections de la bibliothèque : guides numériques, journal, lectures, généalogie, compagnon',
    es: 'Secciones: guías digitales, diario, lecturas, genealogía, compañero',
    it: 'Sezioni: guide digitali, diario, letture, genealogia, companion',
    de: 'Bereiche: digitale Guides, Journal, Texte, Genealogie, Begleiter',
    nb: 'Seksjoner: digitale guider, journal, tekster, slektsforskning, følgebok',
    sv: 'Avsnitt: digitala guider, journal, texter, genealogi, följeslagare',
    da: 'Sektioner: digitale guider, journal, tekster, slægtsforskning, ledsager',
  },
