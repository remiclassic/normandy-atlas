...
const STRINGS = {
  ...
  'referenceHub.intro': {
    en: 'Guides, readings, and the companion handbook sit next to your journal and genealogy workspace—everything stays linked to the map. Use the tabs to switch quickly, or choose a section below.',
    fr: 'Guides, lectures et compagnon côtoient journal et espace généalogie—le tout reste relié à la carte. Utilisez les onglets pour aller vite, ou choisissez une section ci-dessous.',
    es: 'Guías, lecturas y el manual comparten espacio con tu diario y la genealogía—todo enlazado al mapa. Usa las pestañas para ir rápido o elige una sección abajo.',
    it: 'Guide, letture e companion affiancano diario e genealogia—tutto legato alla mappa. Usa le schede per spostarti in fretta o scegli una sezione sotto.',
    de: 'Guides, Texte und Begleitbuch liegen neben Journal und Genealogie—alles bleibt mit der Karte verknüpft. Wechseln Sie über die Tabs oder wählen Sie unten einen Bereich.',
    nb: 'Guider, tekster og følgebok står ved siden av journal og slektsarbeid—alt er knyttet til kartet. Bruk fanene for raske bytter, eller velg en seksjon nedenfor.',
    sv: 'Guider, texter och följeslagare ligger bredvid journal och genealogi—allt kopplat till kartan. Använd flikarna för snabba byten eller välj ett avsnitt nedan.',
    da: 'Guider, tekster og ledsager ligger ved siden af journal og slægtsarbejde—alt forbunden med kortet. Brug fanerne til hurtige skift, eller vælg en sektion nedenfor.',
  },
