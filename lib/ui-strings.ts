...
const STRINGS = {
  ...
  'guidesHub.hint': {
    ...
    es: 'Referencia en la app (diario), manual extenso (guía oficial) y guías digitales.',
    it: 'Riferimento in app (diario), manuale esteso (guida ufficiale) e guide digitali.',
  ...
  'referenceHub.intro': {
    en: 'Choose a tab above: the in-app journal (lookups and ledger), the official companion handbook in your browser, or digital guides when available.',
    fr: 'Choisissez un onglet ci-dessus : le journal dans l’appli (recherches et registre), le compagnon officiel dans le navigateur, ou les guides numériques le cas échéant.',
    es: 'Elija una pestaña arriba: el diario en la app (consultas y registro), el compañero oficial en el navegador o las guías digitales si están disponibles.',
    it: 'Scegli una scheda sopra: il diario in app (consultazioni e registro), il companion ufficiale nel browser o le guide digitali se disponibili.',
    de: 'Wählen Sie oben einen Tab: das In-App-Journal (Nachschlagen und Register), das offizielle Begleitbuch im Browser oder digitale Guides, falls verfügbar.',
    nb: 'Velg en fane over: app-journalen (oppslag og logg), den offisielle følgeboken i nettleseren, eller digitale guider når tilgjengelig.',
    sv: 'Välj en flik ovan: appjournalen (uppslag och journal), den officiella följeslagaren i webbläsaren eller digitala guider när de finns.',
    da: 'Vælg en fane ovenfor: app-journalen (opslag og log), den officielle ledsager i browseren eller digitale guider når de findes.',
  },
  ...
  'companion.title': {
    en: 'Official companion',
    fr: 'Compagnon officiel',
    es: 'Guía oficial',
    it: 'Guida ufficiale',
    de: 'Offizieller Begleiter',
    nb: 'Offisiell følge',
    sv: 'Officiell följeslagare',
    da: 'Officiel ledsager',
  },
  'companion.nav': {
    en: 'Companion',
    fr: 'Compagnon',
  ...
  'companion.aria': {
    en: 'Open official atlas companion book',
    fr: 'Ouvrir le livre compagnon officiel de l\'atlas',
    es: 'Abrir el libro complementario oficial del atlas',
    it: 'Apri il libro companion ufficiale dell\'atlante',
    de: 'Offizielles Begleitbuch zum Atlas öffnen',
    nb: 'Åpne offisiell atlas-følgebok',
    sv: 'Öppna officiell atlas följebok',
    da: 'Åbn officiel atlas ledsagebog',
  },
  'companion.tooltip': {
