...
export const journalSections: JournalSectionCopy[] = [
  {
    ...
    body: {
      en: 'This journal is your companion guide to the Norman Atlas. Browse the timeline of eras, explore Norman-origin surnames carried to the New World, look up historical terms in the glossary, follow guided expeditions, take on weekly challenges, and learn how the atlas works. For DNA and family history, open the Genealogy hub to search the Francogene/GFNA catalogues and try the Norman Identity path; for deep haplogroup reading separate from settler triangulation, use the Genetic Lineage Explorer.',
