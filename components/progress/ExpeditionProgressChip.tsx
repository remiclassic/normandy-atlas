...
function ExpeditionProgressChip({ onOpenLedger }: Props) {
  ...
  return (
    <button
      type="button"
      onClick={handleClick}
      className="flex items-center gap-1.5 rounded-full border border-gold/15 bg-gold/5 px-2.5 py-1 text-[11px] font-medium text-gold/80 transition-all duration-200 hover:border-gold/25 hover:bg-gold/10 hover:text-gold max-w-[180px]"
