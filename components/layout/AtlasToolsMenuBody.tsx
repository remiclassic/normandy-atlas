...
import { Award, BookOpen, Clapperboard, Feather, Heart, Library, Share2, Signpost } from 'lucide-react';
  ...
  return (
    <div className="space-y-6">
      <div className="space-y-2">
        <p className="text-[9px] font-semibold uppercase tracking-[0.18em] text-text-dim/50 mb-2">Explore</p>
        <button
          type="button"
          onClick={() => {
            onNormanOverview();
