...
export const MIGRATION_COHORT_LABELS: Record<MigrationCohortId, I18nString> = {
  all_immigrants: { en: 'All Immigrants', fr: 'Tous les immigrants', it: 'Tutti gli immigrati', de: 'Alles Einwanderer' },
  founding_immigrants: { en: 'Founding Immigrants', fr: 'Immigrants fondateurs', it: 'Immigrati fondatori', de: 'Gründungseinwanderer' },
  engages: { en: 'Engagés (Indentured Workers)', fr: 'Engagés', it: 'Engagés (lavoratori a contratto)', de: 'Engagiert' },
  filles_du_roi: { en: 'Filles du Roi', fr: 'Filles du Roi', it: 'Filles du Roi', de: 'Töchter des Königs' },
  carignan_salieres: { en: 'Carignan-Salières Regiment', fr: 'Régiment de Carignan-Salières', it: 'Reggimento Carignan-Salières', de: 'Carignan-Salières-Regiment' },
};
...
export const migrationDatasets: MigrationDataset[] = [
  {
    ...
    origins: [
      { entityId: 'normandy', label: { en: 'Normandy', fr: 'Normandie', it: 'Normandia', de: 'Normandie' }, percent: 19, confidence: 'medium',
        note: { en: 'Estimated within museum "Northwest France" (39% total). Normandy was the single largest source province.', fr: 'Estimé au sein du « Nord-Ouest » du musée (39% total).', it: 'Stima entro il «Nord-Ovest» del museo (39% totale). La Normandia era la provincia di provenienza più numerosa.', de: 'Geschätzt im „Nordwesten“ des Museums (insgesamt 39 %).' } },
      { entityId: 'brittany', label: { en: 'Brittany', fr: 'Bretagne', it: 'Bretagna', de: 'Bretagne' }, percent: 16, confidence: 'medium',
        note: { en: 'Estimated within "Northwest France". Many Breton arrivals were temporary (fishermen, engagés).', fr: 'Estimé au sein du « Nord-Ouest ». Beaucoup de Bretons étaient temporaires.', it: 'Stima entro il «Nord-Ovest». Molti bretoni erano arrivi temporanei (pescatori, engagés).', de: 'Geschätzt im „Nordwesten“. Viele Bretonen waren vorübergehend.' } },
      { entityId: 'perche', label: { en: 'Perche', fr: 'Perche', it: 'Perche', de: 'Barsch' }, percent: 4, confidence: 'medium',
        note: { en: '~4–5% per Perche-Québec studies. Small region with outsized founder impact.', fr: '~4–5% selon les études Perche-Québec. Petite région à l\'impact fondateur démesuré.', it: 'Circa 4–5% secondo gli studi Perche-Québec. Regione piccola con impatto fondatore sproporzionato.', de: '~4–5 % laut Perche-Québec-Studien. Kleine Region mit unverhältnismäßiger Gründungswirkung.' } },
      { entityId: 'aunis', label: { en: 'Centre-West (Aunis, Saintonge, Poitou)', fr: 'Centre-Ouest (Aunis, Saintonge, Poitou)', it: 'Centro-Ovest (Aunis, Saintonge, Poitou)', de: 'Mitte-West (Aunis, Saintonge, Poitou)' }, percent: 19, confidence: 'high',
        note: { en: 'Museum "Centre-West" category. La Rochelle was the primary embarkation port.', fr: 'Catégorie « Centre-Ouest » du musée.', it: 'Categoria «Centro-Ovest» del museo. La Rochelle era il principale porto d\'imbarco.', de: 'Kategorie „Zentral-West“ des Museums.' } },
      { entityId: 'ile-de-france', label: { en: 'Paris Region (Île-de-France)', fr: 'Région parisienne (Île-de-France)', it: 'Regione parigina (Île-de-France)', de: 'Region Paris (Île-de-France)' }, percent: 14, confidence: 'high' },
      { entityId: 'southwest-france', label: { en: 'Southwest France', fr: 'Sud-Ouest de la France', it: 'Sud-Ovest della Francia', de: 'Südwestlich von Frankreich' }, percent: 11, confidence: 'high' },
      { entityId: 'other-france', label: { en: 'Other Regions', fr: 'Autres régions', it: 'Altre regioni', de: 'Andere Regionen' }, percent: 17, confidence: 'high' },
      CHANNEL_ISLANDS_ORIGIN_CALLOUT,
    ],
    ports: [
      { entityId: 'la-rochelle', label: { en: 'La Rochelle / Rochefort', fr: 'La Rochelle / Rochefort', it: 'La Rochelle / Rochefort', de: 'La Rochelle / Rochefort' }, percent: 52, confidence: 'medium',
        note: { en: 'Primary embarkation hub throughout the French regime.', fr: 'Principal port d\'embarquement sous le Régime français.', it: 'Principale snodo d\'imbarco durante il regime francese.', de: 'Haupteinschiffungshafen unter dem französischen Regime.' } },
      { entityId: 'dieppe', label: { en: 'Dieppe', fr: 'Dieppe', it: 'Dieppe', de: 'Dieppe' }, percent: 16, confidence: 'medium' },
      { entityId: 'saint-malo', label: { en: 'Saint-Malo', fr: 'Saint-Malo', it: 'Saint-Malo', de: 'Saint-Malo' }, percent: 12, confidence: 'medium' },
      { entityId: 'rouen', label: { en: 'Rouen', fr: 'Rouen', it: 'Rouen', de: 'Rouen' }, percent: 8, confidence: 'low',
        note: { en: 'Often a staging point — many departures recorded at Rouen actually shipped from downstream ports.', fr: 'Souvent un point de transit.', it: 'Spesso punto di transito: molte partenze registrate a Rouen salpavano in realtà da porti a valle.', de: 'Oft ein Transitpunkt.' } },
      { entityId: 'honfleur', label: { en: 'Honfleur', fr: 'Honfleur', it: 'Honfleur', de: 'Honfleur' }, percent: 6, confidence: 'low' },
      { entityId: 'other-ports', label: { en: 'Other Ports', fr: 'Autres ports', it: 'Altri porti', de: 'Andere Häfen' }, percent: 6, confidence: 'low' },
      MAINLAND_EMBARKATION_PORT_CALLOUT,
    ],
    colonies: [
      { entityId: 'colony-zone-quebec', label: { en: 'Québec Region', fr: 'Région de Québec', it: 'Regione di Québec', de: 'Region Quebec' }, percent: 45, confidence: 'medium',
        note: { en: 'Includes Côte-de-Beaupré, Île d\'Orléans, Beauport seigneuries.', fr: 'Inclut Côte-de-Beaupré, Île d\'Orléans, seigneuries de Beauport.', it: 'Include Côte-de-Beaupré, Île d\'Orléans, signorie di Beauport.', de: 'Beinhaltet Côte-de-Beaupré, Île d\'Orléans und die Herrschaftsgebiete von Beauport.' } },
      { entityId: 'colony-zone-montreal', label: { en: 'Montréal Region', fr: 'Région de Montréal', it: 'Regione di Montréal', de: 'Region Montreal' }, percent: 33, confidence: 'medium' },
      { entityId: 'colony-zone-trois-rivieres', label: { en: 'Trois-Rivières Region', fr: 'Région de Trois-Rivières', it: 'Regione di Trois-Rivières', de: 'Region Trois-Rivières' }, percent: 14, confidence: 'medium' },
      { entityId: 'other-st-lawrence', label: { en: 'Other St. Lawrence', fr: 'Autres Saint-Laurent', it: 'Altri (San Lorenzo)', de: 'Andere Saint-Laurent' }, percent: 8, confidence: 'low' },
    ],
    flowEdges: [
...

  {
    ...
    yearRange: [1608, 1760],
    metricDefinition: {
      label: { en: 'Share of founding immigrants to Canada', fr: 'Part des immigrants fondateurs du Canada', it: 'Quota degli immigrati fondatori in Canada', de: 'Anteil der Gründungseinwanderer nach Kanada' },
      description: {
    ...
    sources: [MUSEUM_SOURCE, PERCHE_SOURCE],
    origins: [
      { entityId: 'normandy', label: { en: 'Normandy', fr: 'Normandie', it: 'Normandia', de: 'Normandie' }, percent: 14, confidence: 'medium' },
      { entityId: 'brittany', label: { en: 'Brittany', fr: 'Bretagne', it: 'Bretagna', de: 'Bretagne' }, percent: 9, confidence: 'medium',
        note: { en: 'Drops sharply from 16% — many Bretons did not settle permanently.', fr: 'Forte baisse depuis 16% — beaucoup de Bretons ne sont pas restés.', it: 'Forte calo rispetto al 16%: molti bretoni non si stabilirono in modo permanente.', de: 'Starker Rückgang von 16 % – viele Bretonen blieben nicht.' } },
      { entityId: 'perche', label: { en: 'Perche', fr: 'Perche', it: 'Perche', de: 'Barsch' }, percent: 5, confidence: 'medium',
        note: { en: 'Rises as a share of founders — Percherons overwhelmingly stayed and formed families.', fr: 'Augmente parmi les fondateurs — les Percherons sont restés.', it: 'Cresce tra i fondatori: i percheroni rimasero quasi tutti e fondarono famiglie.', de: 'Zuwächse unter den Gründern – die Percherons blieben.' } },
      { entityId: 'aunis', label: { en: 'Centre-West (Aunis, Saintonge, Poitou)', fr: 'Centre-Ouest', it: 'Centro-Ovest (Aunis, Saintonge, Poitou)', de: 'Zentraler Westen' }, percent: 20, confidence: 'high' },
      { entityId: 'ile-de-france', label: { en: 'Paris Region (Île-de-France)', fr: 'Région parisienne', it: 'Regione parigina (Île-de-France)', de: 'Region Paris' }, percent: 16, confidence: 'high' },
      { entityId: 'southwest-france', label: { en: 'Southwest France', fr: 'Sud-Ouest', it: 'Sud-Ovest', de: 'Südwesten' }, percent: 3, confidence: 'high',
        note: { en: 'Drops from 11% — most southwestern migrants were temporary.', fr: 'Baisse depuis 11% — la plupart des migrants du Sud-Ouest étaient temporaires.', it: 'Calo rispetto all\'11%: la maggior parte dei migranti del sud-ovest era temporanea.', de: 'Rückgang von 11 % – die meisten Migranten aus dem Südwesten waren vorübergehend.' } },
      { entityId: 'other-france', label: { en: 'Other Regions', fr: 'Autres régions', it: 'Altre regioni', de: 'Andere Regionen' }, percent: 33, confidence: 'high' },
      CHANNEL_ISLANDS_ORIGIN_CALLOUT,
    ],
    ports: [
      { entityId: 'la-rochelle', label: { en: 'La Rochelle / Rochefort', fr: 'La Rochelle / Rochefort', it: 'La Rochelle / Rochefort', de: 'La Rochelle / Rochefort' }, percent: 55, confidence: 'medium' },
      { entityId: 'dieppe', label: { en: 'Dieppe', fr: 'Dieppe', it: 'Dieppe', de: 'Dieppe' }, percent: 15, confidence: 'medium' },
      { entityId: 'saint-malo', label: { en: 'Saint-Malo', fr: 'Saint-Malo', it: 'Saint-Malo', de: 'Saint-Malo' }, percent: 10, confidence: 'low' },
      { entityId: 'rouen', label: { en: 'Rouen', fr: 'Rouen', it: 'Rouen', de: 'Rouen' }, percent: 8, confidence: 'low' },
      { entityId: 'honfleur', label: { en: 'Honfleur', fr: 'Honfleur', it: 'Honfleur', de: 'Honfleur' }, percent: 6, confidence: 'low' },
      { entityId: 'other-ports', label: { en: 'Other Ports', fr: 'Autres ports', it: 'Altri porti', de: 'Andere Häfen' }, percent: 6, confidence: 'low' },
      MAINLAND_EMBARKATION_PORT_CALLOUT,
    ...
    colonies: [
      { entityId: 'colony-zone-quebec', label: { en: 'Québec Region', fr: 'Région de Québec', it: 'Regione di Québec', de: 'Region Quebec' }, percent: 48, confidence: 'medium' },
      { entityId: 'colony-zone-montreal', label: { en: 'Montréal Region', fr: 'Région de Montréal', it: 'Regione di Montréal', de: 'Region Montreal' }, percent: 30, confidence: 'medium' },
      { entityId: 'colony-zone-trois-rivieres', label: { en: 'Trois-Rivières Region', fr: 'Région de Trois-Rivières', it: 'Regione di Trois-Rivières', de: 'Region Trois-Rivières' }, percent: 15, confidence: 'medium' },
      { entityId: 'other-st-lawrence', label: { en: 'Other St. Lawrence', fr: 'Autres Saint-Laurent', it: 'Altri (San Lorenzo)', de: 'Andere Saint-Laurent' }, percent: 7, confidence: 'low' },
    ],
    flowEdges: [
      { originRegionId: 'perche', portPlaceId: 'dieppe', colonyZoneId: 'colony-zone-quebec', weight: 3, confidence: 'medium' },
      { originRegionId: 'aunis', portPlaceId: 'la-rochelle', colonyZoneId: 'colony-zone-quebec', weight: 4, confidence: 'medium' },
...

  {
    ...
    yearRange: [1663, 1673],
    metricDefinition: {
      label: { en: 'Share among Filles du Roi', fr: 'Part parmi les Filles du Roi', it: 'Quota tra le Filles du Roi', de: 'Anteile unter den Töchtern des Königs' },
      description: {
    ...
    origins: [
      { entityId: 'ile-de-france', label: { en: 'Paris Region (Île-de-France)', fr: 'Région parisienne', it: 'Regione parigina (Île-de-France)', de: 'Region Paris' }, percent: 36, confidence: 'medium',
        note: { en: 'Many recruited from Parisian institutions (Salpêtrière, etc.).', fr: 'Beaucoup recrutées dans les institutions parisiennes.', it: 'Molte reclutate nelle istituzioni parigine (Salpêtrière, ecc.).', de: 'Viele wurden in Pariser Institutionen rekrutiert.' } },
      { entityId: 'normandy', label: { en: 'Normandy', fr: 'Normandie', it: 'Normandia', de: 'Normandie' }, percent: 14, confidence: 'medium' },
      { entityId: 'aunis', label: { en: 'Centre-West', fr: 'Centre-Ouest', it: 'Centro-Ovest', de: 'Zentraler Westen' }, percent: 12, confidence: 'medium' },
      { entityId: 'other-france', label: { en: 'Other Regions', fr: 'Autres régions', it: 'Altre regioni', de: 'Andere Regionen' }, percent: 38, confidence: 'medium' },
      CHANNEL_ISLANDS_ORIGIN_CALLOUT,
    ],
    ports: [
      { entityId: 'la-rochelle', label: { en: 'La Rochelle', fr: 'La Rochelle', it: 'La Rochelle', de: 'La Rochelle' }, percent: 65, confidence: 'medium' },
      { entityId: 'dieppe', label: { en: 'Dieppe', fr: 'Dieppe', it: 'Dieppe', de: 'Dieppe' }, percent: 20, confidence: 'low' },
      { entityId: 'other-ports', label: { en: 'Other Ports', fr: 'Autres ports', it: 'Altri porti', de: 'Andere Häfen' }, percent: 15, confidence: 'low' },
      MAINLAND_EMBARKATION_PORT_CALLOUT,
    ],
    colonies: [
      { entityId: 'colony-zone-quebec', label: { en: 'Québec Region', fr: 'Région de Québec', it: 'Regione di Québec', de: 'Region Quebec' }, percent: 50, confidence: 'medium' },
      { entityId: 'colony-zone-montreal', label: { en: 'Montréal Region', fr: 'Région de Montréal', it: 'Regione di Montréal', de: 'Region Montreal' }, percent: 30, confidence: 'medium' },
      { entityId: 'colony-zone-trois-rivieres', label: { en: 'Trois-Rivières Region', fr: 'Région de Trois-Rivières', it: 'Regione di Trois-Rivières', de: 'Region Trois-Rivières' }, percent: 15, confidence: 'medium' },
      { entityId: 'other-st-lawrence', label: { en: 'Other', fr: 'Autres', it: 'Altri', de: 'Andere' }, percent: 5, confidence: 'low' },
    ],
...

  {
    ...
    yearRange: [1604, 1713],
    metricDefinition: {
      label: { en: 'Share of immigrants to Acadia', fr: 'Part des immigrants en Acadie', it: 'Quota di immigrati in Acadia', de: 'Anteil der Einwanderer in Acadia' },
      description: {
    ...
    sources: [MUSEUM_SOURCE],
    origins: [
      { entityId: 'aunis', label: { en: 'Centre-West (Aunis, Saintonge, Poitou)', fr: 'Centre-Ouest', it: 'Centro-Ovest (Aunis, Saintonge, Poitou)', de: 'Zentraler Westen' }, percent: 28, confidence: 'medium' },
      { entityId: 'southwest-france', label: { en: 'Southwest France', fr: 'Sud-Ouest', it: 'Sud-Ovest', de: 'Südwesten' }, percent: 18, confidence: 'medium',
        note: { en: 'Stronger southwestern connection than the St. Lawrence colony.', fr: 'Lien plus fort avec le sud-ouest que la colonie du Saint-Laurent.', it: 'Legame più forte con il sud-ovest rispetto alla colonia del San Lorenzo.', de: 'Stärkere Verbindung mit dem Südwesten als die Kolonie St. Lawrence.' } },
      { entityId: 'brittany', label: { en: 'Brittany', fr: 'Bretagne', it: 'Bretagna', de: 'Bretagne' }, percent: 15, confidence: 'medium' },
      { entityId: 'normandy', label: { en: 'Normandy', fr: 'Normandie', it: 'Normandia', de: 'Normandie' }, percent: 12, confidence: 'medium' },
      { entityId: 'ile-de-france', label: { en: 'Paris Region', fr: 'Région parisienne', it: 'Regione parigina', de: 'Region Paris' }, percent: 10, confidence: 'medium' },
      { entityId: 'perche', label: { en: 'Perche', fr: 'Perche', it: 'Perche', de: 'Barsch' }, percent: 2, confidence: 'low',
        note: { en: 'Perche was far less connected to Acadia than to the St. Lawrence.', fr: 'Le Perche était beaucoup moins lié à l\'Acadie.', it: 'Il Perche era molto meno collegato all\'Acadia che al San Lorenzo.', de: 'Der Perche war viel weniger mit Acadia verbunden.' } },
      { entityId: 'other-france', label: { en: 'Other Regions', fr: 'Autres régions', it: 'Altre regioni', de: 'Andere Regionen' }, percent: 15, confidence: 'medium' },
      CHANNEL_ISLANDS_ORIGIN_CALLOUT,
    ],
    ports: [
      { entityId: 'la-rochelle', label: { en: 'La Rochelle', fr: 'La Rochelle', it: 'La Rochelle', de: 'La Rochelle' }, percent: 55, confidence: 'medium' },
      { entityId: 'saint-malo', label: { en: 'Saint-Malo', fr: 'Saint-Malo', it: 'Saint-Malo', de: 'Saint-Malo' }, percent: 20, confidence: 'medium' },
      { entityId: 'dieppe', label: { en: 'Dieppe', fr: 'Dieppe', it: 'Dieppe', de: 'Dieppe' }, percent: 10, confidence: 'low' },
      { entityId: 'other-ports', label: { en: 'Other Ports', fr: 'Autres ports', it: 'Altri porti', de: 'Andere Häfen' }, percent: 15, confidence: 'low' },
      MAINLAND_EMBARKATION_PORT_CALLOUT,
    ],
    colonies: [
      { entityId: 'acadia', label: { en: 'Acadia', fr: 'Acadie', it: 'Acadia', de: 'Akadien' }, percent: 100, confidence: 'high' },
    ],
    flowEdges: [
