...
export const atlasEraArcs: EraArcEntry[] = [
  ...
  },
  {
    ...
    eraIds: ['age-of-exploration'],
    label: { en: 'Roberval — France’s first viceroy in Canada', fr: 'Roberval — premier vice-roi de France au Canada', es: 'Roberval — primer virrey de Francia en Canadá', it: 'Roberval — primo viceré francese in Canada', de: 'Roberval – der erste französische Vizekönig in Kanada', nb: 'Roberval — Frankrikes første visekonge i Canada', sv: 'Roberval — Frankrikes förste vicekung i Kanada', da: 'Roberval — Frankrigs første vicekonge i Canada' },
    style: { text: 'text-amber-200/85', textHover: 'hover:text-amber-100', border: 'border-amber-400/20', borderHover: 'hover:border-amber-400/35', iconBg: 'bg-amber-400/12', iconBgHover: 'group-hover:bg-amber-400/18' },
    styleLight: { text: 'text-amber-950/92', textHover: 'hover:text-amber-950', border: 'border-amber-900/40', borderHover: 'hover:border-amber-900/55', iconBg: 'bg-amber-900/22', iconBgHover: 'group-hover:bg-amber-900/30' },
  },
  {
    arcId: 'atlantic-pilots-bridge',
    eraIds: ['age-of-exploration'],
    label: { en: 'Atlantic pilots — skills across empires', fr: 'Pilotes de l’Atlantique — savoir-faire entre empires', es: 'Pilotos del Atlántico — pericia entre imperios', it: 'Piloti atlantici — competenze tra imperi', de: 'Atlantiklotsen – Können zwischen Reichen', nb: 'Atlantiske loser — ferdigheter på tvers av riker', sv: 'Atlantiska lotsar — färdigheter mellan riken', da: 'Atlantiske lodser — færdigheder på tværs af riger' },
    style: { text: 'text-cyan-200/85', textHover: 'hover:text-cyan-100', border: 'border-cyan-400/20', borderHover: 'hover:border-cyan-400/35', iconBg: 'bg-cyan-400/12', iconBgHover: 'group-hover:bg-cyan-400/18' },
    styleLight: { text: 'text-cyan-950/92', textHover: 'hover:text-cyan-950', border: 'border-cyan-900/40', borderHover: 'hover:border-cyan-900/55', iconBg: 'bg-cyan-900/22', iconBgHover: 'group-hover:bg-cyan-900/30' },
  },
  {
    arcId: 'giovanni-da-verrazzano',
    eraIds: ['age-of-exploration'],
    label: { en: 'Verrazzano — French-sponsored coast, 1524', fr: 'Verrazzano — côte sous pavillon français, 1524', es: 'Verrazzano — costa patrocinada por Francia, 1524', it: 'Verrazzano — costa sponsorizzata dalla Francia, 1524', de: 'Verrazzano – französische Küste 1524', nb: 'Verrazzano — fransk støttet kyst, 1524', sv: 'Verrazzano — fransk understödd kust, 1524', da: 'Verrazzano — fransk understøttet kyst, 1524' },
    style: { text: 'text-emerald-200/85', textHover: 'hover:text-emerald-100', border: 'border-emerald-400/20', borderHover: 'hover:border-emerald-400/35', iconBg: 'bg-emerald-400/12', iconBgHover: 'group-hover:bg-emerald-400/18' },
    styleLight: { text: 'text-emerald-950/92', textHover: 'hover:text-emerald-950', border: 'border-emerald-900/40', borderHover: 'hover:border-emerald-900/55', iconBg: 'bg-emerald-900/22', iconBgHover: 'group-hover:bg-emerald-900/30' },
  },
  {
    arcId: 'pre-champlain-monopoly',
    eraIds: ['age-of-exploration'],
    label: { en: 'Before Champlain — trade monopolies', fr: 'Avant Champlain — monopoles de traite', es: 'Antes de Champlain — monopolios comerciales', it: 'Prima di Champlain — monopoli commerciali', de: 'Vor Champlain – Handelsmonopole', nb: 'Før Champlain — handelsmonopol', sv: 'Före Champlain — handelsmonopol', da: 'Før Champlain — handelsmonopoler' },
    style: { text: 'text-yellow-200/85', textHover: 'hover:text-yellow-100', border: 'border-yellow-400/20', borderHover: 'hover:border-yellow-400/35', iconBg: 'bg-yellow-400/12', iconBgHover: 'group-hover:bg-yellow-400/18' },
    styleLight: { text: 'text-yellow-950/92', textHover: 'hover:text-yellow-950', border: 'border-yellow-900/40', borderHover: 'hover:border-yellow-900/55', iconBg: 'bg-yellow-900/22', iconBgHover: 'group-hover:bg-yellow-900/30' },
  },
  {
    arcId: 'grand-banks-cod-prelude',
    eraIds: ['age-of-exploration'],
    label: { en: 'Grand Banks — cod before colonies', fr: 'Grands Bancs — morue avant les colonies', es: 'Grandes Bancos — bacalao antes que colonias', it: 'Grand Banks — merluzzo prima delle colonie', de: 'Große Banken – Kabeljau vor Kolonien', nb: 'Grand Banks — torsk før kolonier', sv: 'Grand Banks — torsk före kolonier', da: 'Grand Banks — torsk før kolonier' },
    style: { text: 'text-teal-200/85', textHover: 'hover:text-teal-100', border: 'border-teal-400/20', borderHover: 'hover:border-teal-400/35', iconBg: 'bg-teal-400/12', iconBgHover: 'group-hover:bg-teal-400/18' },
    styleLight: { text: 'text-teal-950/92', textHover: 'hover:text-teal-950', border: 'border-teal-900/40', borderHover: 'hover:border-teal-900/55', iconBg: 'bg-teal-900/22', iconBgHover: 'group-hover:bg-teal-900/30' },
  },
  {
    arcId: 'norman-atlantic-embarkation',
    eraIds: ['age-of-exploration'],
    label: { en: 'Norman Atlantic ports — embarkation', fr: 'Ports normands de l’Atlantique — embarquement', es: 'Puertos normandos del Atlántico', it: 'Porti normanni dell’Atlantico', de: 'Normannische Atlantikhäfen – Einschiffung', nb: 'Normanniske Atlanterhavshavner', sv: 'Normandiska Atlantiska hamnar', da: 'Normanniske Atlanterhavshavne' },
    style: { text: 'text-indigo-200/85', textHover: 'hover:text-indigo-100', border: 'border-indigo-400/20', borderHover: 'hover:border-indigo-400/35', iconBg: 'bg-indigo-400/12', iconBgHover: 'group-hover:bg-indigo-400/18' },
    styleLight: { text: 'text-indigo-950/92', textHover: 'hover:text-indigo-950', border: 'border-indigo-900/40', borderHover: 'hover:border-indigo-900/55', iconBg: 'bg-indigo-900/22', iconBgHover: 'group-hover:bg-indigo-900/30' },
  },
  {
    arcId: 'ile-sainte-croix-winter',
    eraIds: ['age-of-exploration'],
    label: { en: 'Île Sainte-Croix — winter that re-planned Acadia', fr: 'Île Sainte-Croix — l’hiver qui réaménagea l’Acadie', es: 'Île Sainte-Croix — invierno que redefinió Acadia', it: 'Île Sainte-Croix — inverno che ridisegnò l’Acadia', de: 'Île Sainte-Croix – der Winter, der Akadien neu plante', nb: 'Île Sainte-Croix — vinteren som omplanla Acadia', sv: 'Île Sainte-croix — vintern som omplanerade Acadia', da: 'Île Sainte-Croix — vinteren der omplante Acadia' },
    style: { text: 'text-slate-200/85', textHover: 'hover:text-slate-100', border: 'border-slate-400/20', borderHover: 'hover:border-slate-400/35', iconBg: 'bg-slate-400/12', iconBgHover: 'group-hover:bg-slate-400/18' },
    styleLight: { text: 'text-slate-950/92', textHover: 'hover:text-slate-950', border: 'border-slate-900/40', borderHover: 'hover:border-slate-900/55', iconBg: 'bg-slate-900/22', iconBgHover: 'group-hover:bg-slate-900/30' },
  },
  {
    arcId: 'st-lawrence-contact-nations',
    eraIds: ['age-of-exploration'],
    label: { en: 'St. Lawrence nations — diplomacy of contact', fr: 'Nations du Saint-Laurent — diplomatie du contact', es: 'Naciones del San Lorenzo', it: 'Nazioni del San Lorenzo', de: 'St.-Lorenz-Nationen – Kontakt-Diplomatie', nb: 'St. Lawrence-nasjoner', sv: 'St. Lawrence-nationer', da: 'St. Lawrence-nationer' },
