...
export const atlasTimelineMarkers: TimelineMarker[] = [
  // ── Deep-time ─────────────────────────────────────────────────────
  {
    ...
    label: { en: 'First dolmens raised', fr: 'Premiers dolmens érigés', it: 'Primi dolmen eretti', de: 'Erste Dolmen errichtet' },
    detail: {
  ...
  },
  {
    ...
    label: { en: 'Channel tin trade peaks', fr: 'Apogée du commerce de l\'étain', it: 'Apogeo del commercio dello stagno nella Manica', de: 'Blütezeit des Zinnhandels' },
    detail: {
  ...
  },
  {
    ...
    label: { en: 'Celtic oppida established', fr: 'Oppida celtes établis', it: 'Oppida celtici fondati', de: 'Gründung des keltischen Oppida' },
    detail: {
  ...
  },
  {
    ...
    label: { en: 'Caesar conquers Gaul', fr: 'César conquiert la Gaule', it: 'Cesare conquista la Gallia', de: 'Caesar erobert Gallien' },
    detail: {
  ...
  },
  {
    ...
    year: 100,
    eraIds: ['roman-gaul'],
    label: { en: 'Rotomagus: provincial capital', fr: 'Rotomagus : capitale provinciale', it: 'Rotomagus: capitale provinciale', de: 'Rotomagus: Provinzhauptstadt' },
    detail: {
  ...
  },
  {
    ...
    year: 350,
    eraIds: ['roman-gaul'],
    label: { en: 'Saxon Shore defences', fr: 'Défenses du Litus Saxonicum', it: 'Difese del Litus Saxonicum', de: 'Verteidigung von Litus Saxonicum' },
    detail: {
  ...
  // ── Post-Roman / Neustria ─────────────────────────────────────────
  {
    ...
    label: { en: 'Clovis baptized', fr: 'Baptême de Clovis', it: 'Battesimo di Clodoveo', de: 'Taufe von Chlodwig' },
    detail: {
  ...
  },
  {
    ...
    year: 561,
    eraIds: ['neustria'],
    label: { en: 'Neustria partitioned', fr: 'Partition de la Neustrie', it: 'Partizione della Neustria', de: 'Teilung von Neustrie' },
    detail: {
  ...
  },
  {
    ...
    year: 654,
    eraIds: ['neustria'],
    label: { en: 'Jumièges Abbey founded', fr: 'Fondation de l\'abbaye de Jumièges', it: 'Fondazione dell\'abbazia di Jumièges', de: 'Gründung der Abtei Jumièges' },
    detail: {
  ...
  // ── Carolingian ───────────────────────────────────────────────────
  {
    ...
    label: { en: 'Charlemagne crowned emperor', fr: 'Charlemagne couronné empereur', it: 'Carlo Magno incoronato imperatore', de: 'Karl der Große wird zum Kaiser gekrönt' },
    detail: {
  ...
  },
  {
    ...
    year: 840,
    eraIds: ['frankish-carolingian'],
    label: { en: 'Death of Louis the Pious', fr: 'Mort de Louis le Pieux', it: 'Morte di Ludovico il Pio', de: 'Tod Ludwigs des Frommen' },
    detail: {
  ...
  // ── Viking Age ────────────────────────────────────────────────────
  {
    ...
    label: { en: 'Lindisfarne Raid', fr: 'Raid de Lindisfarne', it: 'Incursione a Lindisfarne', de: 'Lindisfarne-Überfall' },
    detail: {
  ...
  },
  {
    ...
    year: 841,
    eraIds: ['viking-age'],
    label: { en: 'First Norse raid on Seine', fr: 'Premier raid scandinave sur la Seine', it: 'Primo raid norreno sulla Senna', de: 'Erster skandinavischer Überfall auf die Seine' },
    detail: {
  ...
  },
  {
    ...
    year: 862,
    eraIds: ['viking-age'],
    label: { en: 'Rurik in Novgorod', fr: 'Riourik à Novgorod', it: 'Rurik a Novgorod', de: 'Ryurik in Nowgorod' },
    detail: {
  ...
  },
  {
    ...
    year: 870,
    eraIds: ['viking-age'],
    label: { en: 'Iceland Settlement', fr: 'Colonisation de l\'Islande', it: 'Colonizzazione dell\'Islanda', de: 'Kolonisierung Islands' },
    detail: {
  ...
  },
  {
    ...
    year: 885,
    eraIds: ['viking-age'],
    label: { en: 'Siege of Paris', fr: 'Siège de Paris', it: 'Assedio di Parigi', de: 'Belagerung von Paris' },
    detail: {
  ...
  // ── Norman Origins (911–1066) — includes Normandy STOPS ──────────
  {
    ...
    label: { en: '911 — Treaty of Saint-Clair (Rollo)', fr: '911 — Traité de Saint-Clair (Rollon)', it: '911 — Trattato di Saint-Clair-sur-Epte (Rollone)', de: '911 – Vertrag von Saint-Clair (Rollon)' },
    detail: {
  ...
  },
  {
    ...
    year: 924,
    eraIds: ['norman-origins'],
    label: { en: '924 — Bessin annexed', fr: '924 — Annexion du Bessin', it: '924 — Annessione del Bessin', de: '924 – Annexion von Bessin' },
    detail: {
  ...
  },
  {
    ...
    year: 933,
    eraIds: ['norman-origins'],
    label: { en: '933 — Cotentin & Avranchin', fr: '933 — Cotentin et Avranchin', it: '933 — Cotentin e Avranchino', de: '933 – Cotentin und Avranchin' },
    detail: {
  ...
  },
  {
    ...
    year: 1050,
    eraIds: ['norman-origins'],
    label: { en: '~1050 — Duchy consolidated', fr: '~1050 — Duché consolidé', it: '~1050 — Ducato consolidato', de: '~1050 – Konsolidiertes Herzogtum' },
    detail: {
  ...
  },
  {
    ...
    label: { en: '1066 — Battle of Hastings', fr: '1066 — Bataille d\'Hastings', it: '1066 — Battaglia di Hastings', de: '1066 – Schlacht von Hastings' },
    detail: {
...

  {
    ...
    label: { en: '1204 — Channel Islands remain with Crown', fr: '1204 — Les îles restent sous la Couronne', it: '1204 — Le isole restano con la Corona', de: '1204 – Die Inseln bleiben unter der Krone' },
    detail: {
  ...
  // ── Norman Expansion ──────────────────────────────────────────────
  {
    ...
    year: 1096,
    eraIds: ['norman-expansion'],
    label: { en: 'First Crusade — Normans at Antioch', fr: 'Première croisade — Normands à Antioche', it: 'Prima crociata — Normanni ad Antiochia', de: 'Erster Kreuzzug – Normannen in Antiochia' },
    detail: {
  ...
  },
  {
    ...
    year: 1130,
    eraIds: ['norman-expansion'],
    label: { en: 'Kingdom of Sicily founded', fr: 'Royaume de Sicile fondé', it: 'Fondazione del regno di Sicilia', de: 'Gründung des Königreichs Sizilien' },
    detail: {
  ...
  // ── Age of Exploration ────────────────────────────────────────────
  {
    ...
    label: { en: 'Cartier reaches St. Lawrence', fr: 'Cartier atteint le Saint-Laurent', it: 'Cartier raggiunge il San Lorenzo', de: 'Cartier erreicht den Sankt-Lorenz-Strom' },
    detail: {
  ...
  },
  {
    ...
    year: 1604,
    eraIds: ['age-of-exploration'],
    label: { en: 'Dugua founds Port Royal', fr: 'Dugua fonde Port-Royal', it: 'Dugua fonda Port-Royal', de: 'Dugua gründete Port-Royal' },
    detail: {
  ...
  // ── New France phase boundaries (cross-era timeline) ─────────────
  {
    ...
    label: { en: 'Company of One Hundred Associates', fr: 'Compagnie des Cent-Associés', it: 'Compagnia dei Cento Associati', de: 'Unternehmen mit hundert Mitarbeitern' },
    detail: {
  ...
  },
  {
    ...
    label: { en: 'New France becomes Royal Colony', fr: 'La Nouvelle-France devient colonie royale', it: 'La Nuova Francia diventa colonia regia', de: 'Neufrankreich wird eine königliche Kolonie' },
    detail: {
  ...
  },
  {
    ...
    label: { en: 'Great Peace of Montréal', fr: 'Grande Paix de Montréal', it: 'Grande pace di Montréal', de: 'Großer Frieden von Montreal' },
    detail: {
  ...
  },
  {
    ...
    label: { en: 'Seven Years\' War begins', fr: 'Début de la guerre de Sept Ans', it: 'Inizio della guerra dei Sette Anni', de: 'Beginn des Siebenjährigen Krieges' },
    detail: {
  ...
  // ── New France Foundations ────────────────────────────────────────
  {
    ...
    year: 1608,
    eraIds: ['new-france-foundations'],
    label: { en: 'Champlain founds Québec', fr: 'Champlain fonde Québec', it: 'Champlain fonda Québec', de: 'Champlain gründet Quebec' },
    detail: {
  ...
  },
  {
    ...
    year: 1617,
    eraIds: ['new-france-foundations'],
    label: { en: 'Louis Hébert — first farmer', fr: 'Louis Hébert — premier agriculteur', it: 'Louis Hébert — primo agricoltore', de: 'Louis Hébert – erster Bauer' },
    detail: {
  ...
  },
  {
    ...
    year: 1634,
    eraIds: ['new-france-foundations'],
    label: { en: 'Giffard recruits Perche settlers', fr: 'Giffard recrute des colons du Perche', it: 'Giffard recluta coloni dal Perche', de: 'Giffard rekrutiert Siedler aus Perche' },
    detail: {
  ...
  },
  {
    ...
    year: 1642,
    eraIds: ['new-france-foundations'],
    label: { en: 'Founding of Ville-Marie', fr: 'Fondation de Ville-Marie', it: 'Fondazione di Ville-Marie', de: 'Ville-Marie-Stiftung' },
    detail: {
  ...
  },
  {
    ...
    year: 1658,
    eraIds: ['new-france-foundations'],
    label: { en: 'Bourgeoys founds school', fr: 'Bourgeoys fonde une école', it: 'Bourgeoys fonda una scuola', de: 'Bourgeoys gründet eine Schule' },
    detail: {
  ...
  // ── Royal New France ──────────────────────────────────────────────
  {
    ...
    year: 1665,
    eraIds: ['royal-new-france'],
    label: { en: 'Jean Talon — first intendant', fr: 'Jean Talon — premier intendant', it: 'Jean Talon — primo intendente', de: 'Jean Talon – erster Intendant' },
    detail: {
  ...
  },
  {
    ...
    year: 1665,
    eraIds: ['royal-new-france'],
    label: { en: 'Carignan-Salières Regiment arrives', fr: 'Arrivée du régiment Carignan-Salières', it: 'Arrivo del reggimento Carignan-Salières', de: 'Ankunft des Regiments Carignan-Salières' },
    detail: {
  ...
  },
  {
    ...
    year: 1668,
    eraIds: ['royal-new-france'],
    label: { en: 'Filles du Roi migration', fr: 'Migration des Filles du Roi', it: 'Migrazione delle Fille du Roi', de: 'Migration der Töchter des Königs' },
    detail: {
  ...
  },
  {
    ...
    year: 1673,
    eraIds: ['royal-new-france'],
    label: { en: 'Jolliet maps the Mississippi', fr: 'Jolliet cartographie le Mississippi', it: 'Jolliet cartografa il Mississippi', de: 'Jolliet kartiert den Mississippi' },
    detail: {
  ...
  // ── Atlantic Imprint ──────────────────────────────────────────────
  {
    ...
    year: 1713,
    eraIds: ['atlantic-imprint'],
    label: { en: 'Treaty of Utrecht', fr: 'Traité d\'Utrecht', it: 'Trattato di Utrecht', de: 'Vertrag von Utrecht' },
    detail: {
  ...
  },
  {
    ...
    year: 1759,
    eraIds: ['atlantic-imprint'],
    label: { en: 'Fall of Québec', fr: 'Chute de Québec', it: 'Caduta di Québec', de: 'Fall von Quebec' },
    detail: {
  ...
  },
  {
    ...
    year: 1763,
    eraIds: ['atlantic-imprint'],
    label: { en: 'Treaty of Paris', fr: 'Traité de Paris', it: 'Trattato di Parigi', de: 'Vertrag von Paris' },
    detail: {
