...
> = {
  ...
  'chpl-beat-first-crossings': [{ src: '/story/age-of-exploration/atlantic-crossing-16th-century.jpg', alt: { en: 'Atlantic crossing — 16th-century ship on the open ocean', fr: 'Traversée atlantique — navire du XVIe siècle en plein océan' }, credit: { en: 'Wikimedia Commons (public domain)', fr: 'Wikimedia Commons (domaine public)' } }],
  'chpl-beat-acadia': [{ src: '/story/new-france-foundations/port-royal-habitation.jpg', alt: { en: 'Port-Royal Habitation — France\'s first sustained settlement in Acadia', fr: 'Habitation de Port-Royal — premier établissement français durable en Acadie' }, credit: { en: 'Wikimedia Commons (public domain)', fr: 'Wikimedia Commons (domaine public)' }, placeId: 'port-royal' }],
  'chpl-beat-founding-quebec': [{ src: '/story/guillaume-couture/habitation-quebec.jpg', alt: { en: 'Champlain\'s Habitation at Québec — the fortified post founded in 1608', fr: 'L\'Habitation de Champlain à Québec — le poste fortifié fondé en 1608' }, credit: { en: 'Wikimedia Commons (public domain)', fr: 'Wikimedia Commons (domaine public)' }, placeId: 'quebec-city' }],
  'chpl-beat-alliances': [{ src: '/story/guillaume-couture/france-foi-hurons.jpg', alt: { en: 'French-Indigenous encounter — alliances that defined New France', fr: 'Rencontre franco-autochtone — alliances qui définirent la Nouvelle-France' }, credit: { en: 'Wikimedia Commons (public domain)', fr: 'Wikimedia Commons (domaine public)' } }],
  'chpl-beat-great-lakes': [{ src: '/story/royal-new-france/sault-ste-marie-locks.jpg', alt: { en: 'The Great Lakes interior — Champlain reached Lake Huron in 1615', fr: 'L\'intérieur des Grands Lacs — Champlain atteignit le lac Huron en 1615' }, credit: { en: 'Wikimedia Commons (public domain)', fr: 'Wikimedia Commons (domaine public)' }, placeId: 'sault-ste-marie' }],
  'chpl-beat-cartographer': [{ src: '/story/guillaume-couture/champlain-map-1632.jpg', alt: { en: 'Champlain\'s 1632 map of New France — the most accurate of its era', fr: 'Carte de 1632 de Champlain — la plus précise de son époque' }, credit: { en: 'Wikimedia Commons (public domain)', fr: 'Wikimedia Commons (domaine public)' }, placeId: 'quebec-city' }],
  'chpl-beat-death': [{ src: '/story/guillaume-couture/habitation-quebec.jpg', alt: { en: 'Québec — where Champlain died on Christmas Day 1635', fr: 'Québec — où Champlain mourut le jour de Noël 1635' }, credit: { en: 'Wikimedia Commons (public domain)', fr: 'Wikimedia Commons (domaine public)' }, placeId: 'quebec-city' }],

  // ── Jacques Cartier ──
  'jcar-beat-saint-malo': [{ src: '/story/new-france-foundations/saint-malo-port.jpg', alt: { en: 'Saint-Malo — the walled Breton port where Cartier was born', fr: 'Saint-Malo — le port breton fortifié où naquit Cartier' }, credit: { en: 'Wikimedia Commons (public domain)', fr: 'Wikimedia Commons (domaine public)' }, placeId: 'saint-malo' }],
  'jcar-beat-first-voyage': [{ src: '/story/age-of-exploration/atlantic-crossing-16th-century.jpg', alt: { en: 'Atlantic crossing — Cartier\'s first voyage of 1534', fr: 'Traversée atlantique — premier voyage de Cartier en 1534' }, credit: { en: 'Wikimedia Commons (public domain)', fr: 'Wikimedia Commons (domaine public)' } }],
  'jcar-beat-gaspe': [{ src: '/story/age-of-exploration/gaspe-point-newport.jpg', alt: { en: 'Gaspé Peninsula — where Cartier planted the cross of France in 1534', fr: 'Péninsule de Gaspé — où Cartier planta la croix de France en 1534' }, credit: { en: 'Wikimedia Commons (public domain)', fr: 'Wikimedia Commons (domaine public)' }, placeId: 'gaspe-peninsula' }],
  'jcar-beat-stadacona': [{ src: '/story/guillaume-couture/habitation-quebec.jpg', alt: { en: 'Site of Stadacona — where Cartier wintered in 1535–36', fr: 'Site de Stadaconé — où Cartier hiverna en 1535-36' }, credit: { en: 'Wikimedia Commons (public domain)', fr: 'Wikimedia Commons (domaine public)' }, placeId: 'quebec-city' }],
  'jcar-beat-hochelaga': [{ src: '/story/new-france-foundations/vieux-port-montreal.jpg', alt: { en: 'Montréal — site of the palisaded town of Hochelaga visited by Cartier', fr: 'Montréal — site de la ville palissadée d\'Hochelaga visitée par Cartier' }, credit: { en: 'Wikimedia Commons (public domain)', fr: 'Wikimedia Commons (domaine public)' }, placeId: 'montreal' }],
  'jcar-beat-third-voyage': [{ src: '/story/new-france-foundations/saint-malo-port.jpg', alt: { en: 'Saint-Malo — from which Cartier launched his third and final voyage', fr: 'Saint-Malo — d\'où Cartier lança son troisième et dernier voyage' }, credit: { en: 'Wikimedia Commons (public domain)', fr: 'Wikimedia Commons (domaine public)' }, placeId: 'saint-malo' }],
  'jcar-beat-legacy': [{ src: '/story/guillaume-couture/champlain-map-1632.jpg', alt: { en: 'The St. Lawrence mapped — Cartier\'s voyages opened France\'s claim to North America', fr: 'Le Saint-Laurent cartographié — les voyages de Cartier ouvrirent la revendication française sur l\'Amérique du Nord' }, credit: { en: 'Wikimedia Commons (public domain)', fr: 'Wikimedia Commons (domaine public)' } }],

  // ── Pierre Dugua de Mons ──
  'dugua-beat-royan': [{ src: '/story/new-france-foundations/la-rochelle-vieux-port-lisch.jpg', alt: { en: 'La Rochelle — the Atlantic port near Dugua\'s Saintonge homeland', fr: 'La Rochelle — le port atlantique proche de la Saintonge natale de Dugua' }, credit: { en: 'Wikimedia Commons (public domain)', fr: 'Wikimedia Commons (domaine public)' }, placeId: 'la-rochelle' }],
  'dugua-beat-monopoly': [{ src: '/story/age-of-exploration/honfleur-port.jpg', alt: { en: 'Honfleur — one of the Norman ports through which Dugua\'s ventures sailed', fr: 'Honfleur — l\'un des ports normands par lesquels les entreprises de Dugua prirent la mer' }, credit: { en: 'Wikimedia Commons (public domain)', fr: 'Wikimedia Commons (domaine public)' }, placeId: 'honfleur' }],
  'dugua-beat-sainte-croix': [{ src: '/story/new-france-foundations/port-royal-habitation.jpg', alt: { en: 'Port-Royal — where survivors relocated after the lethal winter at Île Sainte-Croix', fr: 'Port-Royal — où les survivants se relocalisèrent après l\'hiver meurtrier à l\'île Sainte-Croix' }, credit: { en: 'Wikimedia Commons (public domain)', fr: 'Wikimedia Commons (domaine public)' }, placeId: 'port-royal' }],
  'dugua-beat-port-royal': [{ src: '/story/new-france-foundations/port-royal-habitation.jpg', alt: { en: 'Port-Royal Habitation — the first sustained French settlement', fr: 'Habitation de Port-Royal — le premier établissement français durable' }, credit: { en: 'Wikimedia Commons (public domain)', fr: 'Wikimedia Commons (domaine public)' }, placeId: 'port-royal' }],
  'dugua-beat-quebec-founding': [{ src: '/story/guillaume-couture/habitation-quebec.jpg', alt: { en: 'Québec — the trading post Dugua financed and Champlain built', fr: 'Québec — le poste de traite financé par Dugua et bâti par Champlain' }, credit: { en: 'Wikimedia Commons (public domain)', fr: 'Wikimedia Commons (domaine public)' }, placeId: 'quebec-city' }],
  'dugua-beat-legacy': [{ src: '/story/age-of-exploration/atlantic-crossing-16th-century.jpg', alt: { en: 'The Atlantic — the ocean Dugua\'s capital helped France cross', fr: 'L\'Atlantique — l\'océan que le capital de Dugua aida la France à traverser' }, credit: { en: 'Wikimedia Commons (public domain)', fr: 'Wikimedia Commons (domaine public)' } }],

  // ── Louis Hébert ──
  'lheb-beat-paris': [{ src: '/story/guillaume-couture/rouen-gomboust-1655.jpg', alt: { en: 'Rouen — the trading hub through which Hébert was recruited for New France', fr: 'Rouen — la plaque tournante commerciale par laquelle Hébert fut recruté pour la Nouvelle-France' }, credit: { en: 'Wikimedia Commons (public domain)', fr: 'Wikimedia Commons (domaine public)' }, placeId: 'rouen' }],
  'lheb-beat-acadia': [{ src: '/story/new-france-foundations/port-royal-habitation.jpg', alt: { en: 'Port-Royal — where Hébert first tasted life in the New World', fr: 'Port-Royal — où Hébert goûta pour la première fois la vie au Nouveau Monde' }, credit: { en: 'Wikimedia Commons (public domain)', fr: 'Wikimedia Commons (domaine public)' }, placeId: 'port-royal' }],
  'lheb-beat-crossing': [{ src: '/story/age-of-exploration/honfleur-port.jpg', alt: { en: 'Honfleur — from which the Hébert family sailed to Québec in 1617', fr: 'Honfleur — d\'où la famille Hébert navigua vers Québec en 1617' }, credit: { en: 'Wikimedia Commons (public domain)', fr: 'Wikimedia Commons (domaine public)' }, placeId: 'honfleur' }],
  'lheb-beat-first-farm': [{ src: '/story/new-france-foundations/chateau-richer-beauce-st-lawrence.jpg', alt: { en: 'St. Lawrence valley farmland — Hébert cleared the first European farm above Québec', fr: 'Terres agricoles du Saint-Laurent — Hébert défricha la première ferme européenne au-dessus de Québec' }, credit: { en: 'Wikimedia Commons (public domain)', fr: 'Wikimedia Commons (domaine public)' }, placeId: 'quebec-city' }],
  'lheb-beat-death': [{ src: '/story/guillaume-couture/habitation-quebec.jpg', alt: { en: 'Québec — where Hébert died in 1627, the first European farmer buried in Canada', fr: 'Québec — où Hébert mourut en 1627, premier agriculteur européen enterré au Canada' }, credit: { en: 'Wikimedia Commons (public domain)', fr: 'Wikimedia Commons (domaine public)' }, placeId: 'quebec-city' }],

  // ── Robert Giffard ──
  'rgif-beat-perche': [{ src: '/story/new-france-foundations/mortagne-sous-prefecture.jpg', alt: { en: 'Mortagne-au-Perche — Giffard\'s hometown and centre of his recruitment network', fr: 'Mortagne-au-Perche — ville natale de Giffard et centre de son réseau de recrutement' }, credit: { en: 'Wikimedia Commons (public domain)', fr: 'Wikimedia Commons (domaine public)' }, placeId: 'mortagne-au-perche' }],
  'rgif-beat-corridor': [{ src: '/story/age-of-exploration/dieppe-port.jpg', alt: { en: 'Dieppe — the embarkation port for Giffard\'s Percheron recruits', fr: 'Dieppe — le port d\'embarquement des recrues percheronnes de Giffard' }, credit: { en: 'Wikimedia Commons (public domain)', fr: 'Wikimedia Commons (domaine public)' }, placeId: 'dieppe' }],
  'rgif-beat-beauport': [{ src: '/story/new-france-foundations/montmorency-falls.jpg', alt: { en: 'Beauport area — the seigneury Giffard settled with Percheron families', fr: 'Région de Beauport — la seigneurie que Giffard peupla de familles percheronnes' }, credit: { en: 'Wikimedia Commons (public domain)', fr: 'Wikimedia Commons (domaine public)' }, placeId: 'beauport' }],
  'rgif-beat-families': [{ src: '/story/new-france-foundations/chateau-richer-beauce-st-lawrence.jpg', alt: { en: 'St. Lawrence farmland — the Percheron families worked seigneurial lots along the river', fr: 'Terres agricoles du Saint-Laurent — les familles percheronnes cultivaient les concessions seigneuriales le long du fleuve' }, credit: { en: 'Wikimedia Commons (public domain)', fr: 'Wikimedia Commons (domaine public)' }, placeId: 'chateau-richer' }],
  'rgif-beat-legacy': [{ src: '/story/new-france-foundations/mortagne-sous-prefecture.jpg', alt: { en: 'Mortagne — the modest town whose families founded a continent', fr: 'Mortagne — la modeste ville dont les familles fondèrent un continent' }, credit: { en: 'Wikimedia Commons (public domain)', fr: 'Wikimedia Commons (domaine public)' }, placeId: 'mortagne-au-perche' }],

  // ── Pierre Boucher ──
  'pbou-beat-perche': [{ src: '/story/new-france-foundations/mortagne-sous-prefecture.jpg', alt: { en: 'Mortagne-au-Perche — where Boucher was born before crossing at age thirteen', fr: 'Mortagne-au-Perche — où Boucher naquit avant de traverser à treize ans' }, credit: { en: 'Wikimedia Commons (public domain)', fr: 'Wikimedia Commons (domaine public)' }, placeId: 'mortagne-au-perche' }],
  'pbou-beat-interpreter': [{ src: '/story/guillaume-couture/france-foi-hurons.jpg', alt: { en: 'Living among the Wendat — Boucher learned Indigenous languages as a teenager', fr: 'Vie parmi les Wendats — Boucher apprit les langues autochtones adolescent' }, credit: { en: 'Wikimedia Commons (public domain)', fr: 'Wikimedia Commons (domaine public)' } }],
  'pbou-beat-trois-rivieres': [{ src: '/story/guillaume-couture/trois-rivieres.jpg', alt: { en: 'Trois-Rivières — the settlement Boucher governed and defended', fr: 'Trois-Rivières — l\'établissement que Boucher gouverna et défendit' }, credit: { en: 'Wikimedia Commons (public domain)', fr: 'Wikimedia Commons (domaine public)' }, placeId: 'trois-rivieres' }],
  'pbou-beat-paris-mission': [{ src: '/story/age-of-exploration/atlantic-crossing-16th-century.jpg', alt: { en: 'The Atlantic crossing — Boucher sailed to petition Louis XIV in person', fr: 'La traversée atlantique — Boucher navigua pour plaider auprès de Louis XIV en personne' }, credit: { en: 'Wikimedia Commons (public domain)', fr: 'Wikimedia Commons (domaine public)' } }],
  'pbou-beat-histoire': [{ src: '/story/guillaume-couture/trois-rivieres.jpg', alt: { en: 'Trois-Rivières — from which Boucher wrote his Histoire véritable', fr: 'Trois-Rivières — d\'où Boucher écrivit son Histoire véritable' }, credit: { en: 'Wikimedia Commons (public domain)', fr: 'Wikimedia Commons (domaine public)' }, placeId: 'trois-rivieres' }],
  'pbou-beat-legacy': [{ src: '/story/new-france-foundations/vieux-port-montreal.jpg', alt: { en: 'The St. Lawrence corridor — the world Boucher watched grow for ninety-five years', fr: 'Le corridor du Saint-Laurent — le monde que Boucher vit grandir pendant quatre-vingt-quinze ans' }, credit: { en: 'Wikimedia Commons (public domain)', fr: 'Wikimedia Commons (domaine public)' }, placeId: 'montreal' }],

  // ── Jean Talon ──
  'jtal-beat-origins': [{ src: '/story/guillaume-couture/rouen-gomboust-1655.jpg', alt: { en: 'France — the royal apparatus from which Talon was dispatched to New France', fr: 'France — l\'appareil royal d\'où Talon fut envoyé en Nouvelle-France' }, credit: { en: 'Wikimedia Commons (public domain)', fr: 'Wikimedia Commons (domaine public)' } }],
  'jtal-beat-arrival': [{ src: '/story/guillaume-couture/habitation-quebec.jpg', alt: { en: 'Québec — where Talon arrived as first intendant in 1665', fr: 'Québec — où Talon arriva comme premier intendant en 1665' }, credit: { en: 'Wikimedia Commons (public domain)', fr: 'Wikimedia Commons (domaine public)' }, placeId: 'quebec-city' }],
  'jtal-beat-census': [{ src: '/story/new-france-foundations/chateau-richer-beauce-st-lawrence.jpg', alt: { en: 'St. Lawrence settlements — Talon counted every colonist in 1666', fr: 'Établissements du Saint-Laurent — Talon recensa chaque colon en 1666' }, credit: { en: 'Wikimedia Commons (public domain)', fr: 'Wikimedia Commons (domaine public)' } }],
  'jtal-beat-filles-du-roi': [{ src: '/story/age-of-exploration/atlantic-crossing-16th-century.jpg', alt: { en: 'Atlantic crossing — the Filles du Roi sailed to transform the colony\'s demographics', fr: 'Traversée atlantique — les Filles du Roi naviguèrent pour transformer la démographie de la colonie' }, credit: { en: 'Wikimedia Commons (public domain)', fr: 'Wikimedia Commons (domaine public)' } }],
  ...
  'jtal-beat-exploration': [{ src: '/story/royal-new-france/sault-ste-marie-locks.jpg', alt: { en: 'Sault Sainte-Marie — where Talon\'s envoy proclaimed French sovereignty in 1671', fr: 'Sault Sainte-Marie — où l\'envoyé de Talon proclama la souveraineté française en 1671' }, credit: { en: 'Wikimedia Commons (public domain)', fr: 'Wikimedia Commons (domaine public)' }, placeId: 'sault-ste-marie' }],
  'jtal-beat-legacy': [{ src: '/story/guillaume-couture/habitation-quebec.jpg', alt: { en: 'Québec — the colony Talon transformed in seven years', fr: 'Québec — la colonie que Talon transforma en sept ans' }, credit: { en: 'Wikimedia Commons (public domain)', fr: 'Wikimedia Commons (domaine public)' }, placeId: 'quebec-city' }],

  // ── Marguerite Bourgeoys ──
  'mbou-beat-troyes': [{ src: '/story/guillaume-couture/rouen-gomboust-1655.jpg', alt: { en: 'France — Bourgeoys was born in Troyes, Champagne, in 1620', fr: 'France — Bourgeoys naquit à Troyes, en Champagne, en 1620' }, credit: { en: 'Wikimedia Commons (public domain)', fr: 'Wikimedia Commons (domaine public)' } }],
  'mbou-beat-crossing': [{ src: '/story/age-of-exploration/honfleur-port.jpg', alt: { en: 'Norman port — Bourgeoys sailed to Montréal in 1653', fr: 'Port normand — Bourgeoys navigua vers Montréal en 1653' }, credit: { en: 'Wikimedia Commons (public domain)', fr: 'Wikimedia Commons (domaine public)' }, placeId: 'honfleur' }],
  'mbou-beat-first-school': [{ src: '/story/new-france-foundations/vieux-port-montreal.jpg', alt: { en: 'Montréal — where Bourgeoys opened the first school in 1658', fr: 'Montréal — où Bourgeoys ouvrit la première école en 1658' }, credit: { en: 'Wikimedia Commons (public domain)', fr: 'Wikimedia Commons (domaine public)' }, placeId: 'montreal' }],
  'mbou-beat-congregation': [{ src: '/story/new-france-foundations/vieux-port-montreal.jpg', alt: { en: 'Montréal — home of the Congrégation de Notre-Dame', fr: 'Montréal — siège de la Congrégation de Notre-Dame' }, credit: { en: 'Wikimedia Commons (public domain)', fr: 'Wikimedia Commons (domaine public)' }, placeId: 'montreal' }],
  'mbou-beat-colony-schools': [{ src: '/story/new-france-foundations/chateau-richer-beauce-st-lawrence.jpg', alt: { en: 'St. Lawrence valley — the Congrégation built schools across the colony', fr: 'Vallée du Saint-Laurent — la Congrégation bâtit des écoles dans toute la colonie' }, credit: { en: 'Wikimedia Commons (public domain)', fr: 'Wikimedia Commons (domaine public)' } }],
  'mbou-beat-legacy': [{ src: '/story/new-france-foundations/vieux-port-montreal.jpg', alt: { en: 'Montréal — where Bourgeoys died in 1700, later canonized as a saint', fr: 'Montréal — où Bourgeoys mourut en 1700, canonisée ensuite' }, credit: { en: 'Wikimedia Commons (public domain)', fr: 'Wikimedia Commons (domaine public)' }, placeId: 'montreal' }],

  // ── Jeanne Mance ──
  'jman-beat-langres': [{ src: '/story/guillaume-couture/rouen-gomboust-1655.jpg', alt: { en: 'France — Mance was born in Langres, Champagne, in 1606', fr: 'France — Mance naquit à Langres, en Champagne, en 1606' }, credit: { en: 'Wikimedia Commons (public domain)', fr: 'Wikimedia Commons (domaine public)' } }],
  'jman-beat-crossing': [{ src: '/story/new-france-foundations/la-rochelle-vieux-port-lisch.jpg', alt: { en: 'La Rochelle — from which Mance sailed to New France in 1641', fr: 'La Rochelle — d\'où Mance embarqua pour la Nouvelle-France en 1641' }, credit: { en: 'Wikimedia Commons (public domain)', fr: 'Wikimedia Commons (domaine public)' }, placeId: 'la-rochelle' }],
  'jman-beat-ville-marie': [{ src: '/story/new-france-foundations/vieux-port-montreal.jpg', alt: { en: 'Ville-Marie (Montréal) — founded 17 May 1642, Mance present from day one', fr: 'Ville-Marie (Montréal) — fondé le 17 mai 1642, Mance présente dès le premier jour' }, credit: { en: 'Wikimedia Commons (public domain)', fr: 'Wikimedia Commons (domaine public)' }, placeId: 'montreal' }],
  'jman-beat-hotel-dieu': [{ src: '/story/new-france-foundations/vieux-port-montreal.jpg', alt: { en: 'Montréal — site of the Hôtel-Dieu hospital founded by Mance', fr: 'Montréal — site de l\'Hôtel-Dieu fondé par Mance' }, credit: { en: 'Wikimedia Commons (public domain)', fr: 'Wikimedia Commons (domaine public)' }, placeId: 'montreal' }],
  'jman-beat-iroquois-wars': [{ src: '/story/guillaume-couture/trois-rivieres.jpg', alt: { en: 'The St. Lawrence frontier — Mance held Montréal together during the Iroquois wars', fr: 'La frontière du Saint-Laurent — Mance maintint Montréal pendant les guerres iroquoises' }, credit: { en: 'Wikimedia Commons (public domain)', fr: 'Wikimedia Commons (domaine public)' }, placeId: 'trois-rivieres' }],
  'jman-beat-legacy': [{ src: '/story/new-france-foundations/vieux-port-montreal.jpg', alt: { en: 'Montréal — where Mance died in 1673, recognized as co-founder', fr: 'Montréal — où Mance mourut en 1673, reconnue co-fondatrice' }, credit: { en: 'Wikimedia Commons (public domain)', fr: 'Wikimedia Commons (domaine public)' }, placeId: 'montreal' }],

  // ── René-Robert Cavelier de La Salle ──
  'rlas-beat-rouen': [{ src: '/story/guillaume-couture/rouen-gomboust-1655.jpg', alt: { en: 'Rouen — La Salle was born here in 1643 to a wealthy merchant family', fr: 'Rouen — La Salle y naquit en 1643 dans une famille de marchands aisés' }, credit: { en: 'Wikimedia Commons (public domain)', fr: 'Wikimedia Commons (domaine public)' }, placeId: 'rouen' }],
  'rlas-beat-montreal': [{ src: '/story/new-france-foundations/vieux-port-montreal.jpg', alt: { en: 'Montréal — La Salle\'s base on the western frontier', fr: 'Montréal — la base de La Salle sur la frontière occidentale' }, credit: { en: 'Wikimedia Commons (public domain)', fr: 'Wikimedia Commons (domaine public)' }, placeId: 'montreal' }],
  'rlas-beat-frontenac': [{ src: '/story/royal-new-france/fort-michilimackinac.jpg', alt: { en: 'Fort Frontenac — La Salle\'s gateway to the Great Lakes', fr: 'Fort Frontenac — la porte de La Salle vers les Grands Lacs' }, credit: { en: 'Wikimedia Commons (public domain)', fr: 'Wikimedia Commons (domaine public)' }, placeId: 'fort-frontenac' }],
  'rlas-beat-illinois': [{ src: '/story/royal-new-france/green-bay-baie-des-puants.jpg', alt: { en: 'Illinois country — La Salle pushed deeper into the interior than any Frenchman before', fr: 'Pays des Illinois — La Salle pénétra plus loin dans l\'intérieur qu\'aucun Français avant lui' }, credit: { en: 'Wikimedia Commons (public domain)', fr: 'Wikimedia Commons (domaine public)' } }],
  'rlas-beat-mississippi': [{ src: '/story/royal-new-france/st-louis-mississippi-night.jpg', alt: { en: 'The Mississippi — La Salle descended the river to the Gulf in 1682', fr: 'Le Mississippi — La Salle descendit le fleuve jusqu\'au golfe en 1682' }, credit: { en: 'Wikimedia Commons (public domain)', fr: 'Wikimedia Commons (domaine public)' }, placeId: 'mississippi-confluence' }],
  'rlas-beat-murder': [{ src: '/story/royal-new-france/gulf-mexico-louisiana-coast.jpg', alt: { en: 'Gulf coast — where La Salle\'s final expedition ended in his murder', fr: 'Côte du golfe — où la dernière expédition de La Salle se termina par son assassinat' }, credit: { en: 'Wikimedia Commons (public domain)', fr: 'Wikimedia Commons (domaine public)' }, placeId: 'gulf-of-mexico-node' }],
  'rlas-beat-legacy': [{ src: '/story/royal-new-france/jackson-square-new-orleans-1885.jpg', alt: { en: 'Louisiana — the territory La Salle claimed for France in 1682', fr: 'Louisiane — le territoire que La Salle revendiqua pour la France en 1682' }, credit: { en: 'Wikimedia Commons (public domain)', fr: 'Wikimedia Commons (domaine public)' }, placeId: 'gulf-of-mexico-node' }],
};
