...
export const vikingBattleMarkers: VikingBattleMarker[] = [
  {
    ...
    year: 793,
    label: { en: 'Lindisfarne Raid (793)', fr: 'Raid de Lindisfarne (793)' },
  },
  {
    id: 'vbm-paris-845',
    kind: 'siege',
    ...
    year: 845,
    label: { en: 'Sack of Paris (845)', fr: 'Sac de Paris (845)' },
  },
  {
    id: 'vbm-rouen-841',
    kind: 'battle',
    ...
    year: 841,
    label: { en: 'Fall of Rouen (841)', fr: 'Chute de Rouen (841)' },
  },
  {
    id: 'vbm-paris-siege',
    kind: 'siege',
    ...
    year: 885,
    yearEnd: 886,
    label: { en: 'Siege of Paris (885–886)', fr: 'Siège de Paris (885–886)' },
  },
  {
    ...
    year: 841,
    label: { en: 'Dublin Founded (841)', fr: 'Fondation de Dublin (841)' },
  },
  {
    id: 'vbm-york-867',
    kind: 'battle',
    ...
    year: 867,
    label: { en: 'Capture of York (867)', fr: 'Prise de York (867)' },
  },
  {
    id: 'vbm-edington',
    kind: 'battle',
    ...
    year: 878,
    label: { en: 'Battle of Edington (878)', fr: 'Bataille d\'Edington (878)' },
  },
  {
    ...
    year: 1066,
    label: { en: 'Stamford Bridge (1066)', fr: 'Stamford Bridge (1066)' },
  },
  {
    id: 'vbm-hastings',
    kind: 'battle',
    ...
    year: 1066,
    label: { en: 'Hastings (1066)', fr: 'Hastings (1066)' },
  },
  {
    id: 'vbm-clontarf',
    kind: 'battle',
    ...
    year: 1014,
    label: { en: 'Clontarf (1014)', fr: 'Clontarf (1014)' },
  },
  {
    id: 'vbm-seville-844',
    kind: 'battle',
    ...
    year: 844,
    label: { en: 'Raid on Seville (844)', fr: 'Raid sur Séville (844)' },
  },
  {
    id: 'vbm-fleet-hedeby',
    kind: 'fleet',
    ...
    year: 800,
    yearEnd: 1066,
    label: { en: 'Fleet Base: Hedeby', fr: 'Base navale : Hedeby' },
  },
  {
    id: 'vbm-fleet-birka',
    kind: 'fleet',
    ...
    year: 790,
    yearEnd: 970,
    label: { en: 'Fleet Base: Birka', fr: 'Base navale : Birka' },
  },
  {
    ...
    year: 790,
    yearEnd: 930,
    label: { en: 'Fleet Base: Kaupang', fr: 'Base navale : Kaupang' },
  },
];
