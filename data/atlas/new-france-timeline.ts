...
export const NEW_FRANCE_PHASES: NewFrancePhase[] = [
  {
    ...
    yearStart: 1608,
    yearEnd: 1627,
    label: { en: 'Early Foothold', fr: 'Premiers pas', it: 'Primi insediamenti', de: 'Erste Schritte', nb: 'Tidlig fotfeste', sv: 'Tidig fotfäste', da: 'Tidligt fodfæste' },
    narrative: {
      ...
      nb: 'Champlain grunnla Québec i 1608, og etablerte en usikker handelspost på St. Lawrence. Fransk tilstedeværelse var begrenset til en håndfull sesongbaserte stillinger - Tadoussac, Québec - avhengig av pelshandel og urfolksallianser.',
      sv: 'Champlain grundade Québec 1608 och etablerade en otrygg handelsplats på St. Lawrence. Fransk närvaro var begränsad till en handfull säsongsbetonade tjänster - Tadoussac, Québec - beroende av pälshandeln och ursprungsallianser.',
      da: 'Champlain grundlagde Québec i 1608 og etablerede en usikker handelsstation på St. Lawrence. Fransk tilstedeværelse var begrænset til en håndfuld sæsonbestemte stillinger - Tadoussac, Québec - afhængig af pelshandel og indfødte alliancer.',
    },
  ...
  },
  {
    ...
    label: {
      ...
      nb: 'Company of One Hundred Associates',
      sv: 'Company of One Hundred Associates',
      da: 'Company of One Hundred Associates',
    },
    narrative: {
      ...
      nb: 'Under Compagnie des Cent-Associés ble kolonien forventet å vokse gjennom strukturert rekruttering. Fremgangen gikk sakte: Kirke-brødrene grep Québec (1629–1632), og irokesiske kriger truet den tynne korridoren av bosetninger langs St. Lawrence. Montréal ble grunnlagt i 1642.',
      sv: 'Under Compagnie des Cent-Associés förväntades kolonin växa genom strukturerad rekrytering. Framstegen gick långsamt: bröderna Kirke intog Québec (1629–1632), och Iroquois-krigen hotade den tunna korridoren av bosättningar längs St. Lawrence. Montréal grundades 1642.',
      da: 'Under Compagnie des Cent-Associés forventedes kolonien at vokse gennem struktureret rekruttering. Fremskridtet gik langsomt: Kirke-brødrene erobrede Québec (1629-1632), og Iroquois-krige truede den tynde korridor af bosættelser langs St. Lawrence. Montréal blev grundlagt i 1642.',
    },
  ...
  },
  {
    ...
    yearStart: 1663,
    yearEnd: 1701,
    label: { en: 'Royal Colony', fr: 'Colonie royale', it: 'Colonia reale', de: 'Königliche Kolonie', nb: 'Kongelig koloni', sv: 'Kunglig koloni', da: 'Kongelig Koloni' },
    narrative: {
      ...
      nb: 'Ludvig XIV tok direkte kontroll i 1663, og sendte Carignan-Salières-regimentet og Filles du Roi. Intendant Talon organiserte det seigneuriale systemet. Bosettingen utvidet seg langs St. Lawrence-korridoren, og oppdagelsesreisende presset inn i de store innsjøene.',
      sv: 'Ludvig XIV tog direkt kontroll 1663 och skickade Carignan-Salières regemente och Filles du Roi. Intendant Talon organiserade det seigneuriala systemet. Bosättningen expanderade längs St. Lawrence-korridoren och upptäcktsresande trängde in i de stora sjöarna.',
      da: 'Ludvig XIV tog direkte kontrol i 1663 og sendte Carignan-Salières-regimentet og Filles du Roi. Intendant Talon organiserede det seigneuriale system. Bebyggelsen udvidede sig langs St. Lawrence-korridoren, og opdagelsesrejsende trængte ind i De Store Søer.',
    },
  ...
  },
  {
    ...
    yearStart: 1701,
    yearEnd: 1754,
    label: { en: 'Continental Expansion', fr: 'Expansion continentale', it: 'Espansione continentale', de: 'Kontinentale Expansion', nb: 'Kontinental ekspansjon', sv: 'Kontinental expansion', da: 'Kontinental udvidelse' },
    narrative: {
      ...
      nb: 'Etter den store freden i Montréal (1701) nådde New France sin maksimale territorielle utstrekning. Et nettverk av fort, misjoner og handelsposter strakte seg fra St. Lawrence gjennom De store innsjøene til Mississippi-deltaet og Louisiana. Befolkningen i kjernekorridoren forble liten, men fransk innflytelse dekket et stort indre.',
      sv: 'Efter den stora freden i Montréal (1701) nådde Nya Frankrike sin maximala territoriella utsträckning. Ett nätverk av fort, beskickningar och handelsposter sträckte sig från St. Lawrence genom de stora sjöarna till Mississippideltat och Louisiana. Befolkningen i kärnkorridoren förblev liten, men franskt inflytande täckte ett stort inre.',
      da: 'Efter den store fred i Montréal (1701) nåede Ny Frankrig sin maksimale territoriale udstrækning. Et netværk af forter, missioner og handelsposter strakte sig fra St. Lawrence gennem De Store Søer til Mississippi-deltaet og Louisiana. Befolkningen i kernekorridoren forblev lille, men fransk indflydelse dækkede et stort indre.',
    },
  ...
  },
  {
    ...
    label: {
      ...
      nb: 'Sju års krig og tap',
      sv: 'Sju års krig och förlust',
      da: 'Syv års krig og tab',
    },
    narrative: {
      ...
      nb: 'Syvårskrigen (den franske og den indiske krigen i Nord-Amerika) brakte sammenbruddet av New France. Louisbourg falt i 1758, Québec i 1759 og Montréal i 1760. Paris-traktaten (1763) avstod hele New France til Storbritannia.',
      sv: 'Sjuåriga kriget (franska och indiska kriget i Nordamerika) ledde till kollapsen av Nya Frankrike. Louisbourg föll 1758, Québec 1759 och Montréal 1760. Parisfördraget (1763) överlät hela Nya Frankrike till Storbritannien.',
      da: 'Syvårskrigen (den franske og den indiske krig i Nordamerika) bragte Ny Frankrigs sammenbrud. Louisbourg faldt i 1758, Québec i 1759 og Montréal i 1760. Paris-traktaten (1763) afstod hele Ny Frankrig til Storbritannien.',
    },
