...
export const atlasJourneys: Journey[] = [
  // --- Deep time journeys ---
  {
    ...
    name: { en: 'Bronze Age Channel Trade', fr: 'Commerce transmanche à l\'âge du bronze', it: 'Commercio della Manica nell\'età del bronzo', de: 'Kanalübergreifender Handel in der Bronzezeit' },
  ...
  },
  {
    ...
    name: { en: 'Seine Corridor (Deep Time)', fr: 'Corridor de la Seine (temps profond)', it: 'Corridoio della Senna (tempo profondo)', de: 'Seine-Korridor (tiefe Zeit)' },
  ...
  // --- Viking-era journeys ---
  {
    ...
    name: { en: 'Viking Seine Raids', fr: 'Raids vikings sur la Seine', it: 'Incursioni vichinghe sulla Senna', de: 'Wikingerüberfälle auf die Seine' },
  ...
  },
  {
    ...
    name: { en: 'Seine River Corridor', fr: 'Corridor fluvial de la Seine', it: 'Corridoio fluviale della Senna', de: 'Seine-Flusskorridor' },
  ...
  },
  {
    ...
    name: { en: 'Viking Settlement of Normandy', fr: 'Implantation viking en Normandie', it: 'Insediamento vichingo in Normandia', de: 'Wikingersiedlung in der Normandie' },
  ...
  },
  {
    ...
    name: { en: 'Perche to Québec Corridor', fr: 'Corridor Perche–Québec', it: 'Corridoio Perche–Québec', de: 'Perche-Quebec-Korridor' },
  ...
  },
  {
    ...
    name: { en: 'Honfleur to Montréal Route', fr: 'Route Honfleur–Montréal', it: 'Rotta Honfleur–Montréal', de: 'Straße Honfleur–Montreal' },
  ...
  },
  {
    ...
    name: { en: 'La Rochelle to Acadia Corridor', fr: 'Corridor La Rochelle–Acadie', it: 'Corridoio La Rochelle–Acadia', de: 'La Rochelle-Acadia-Korridor' },
  ...
  },
  {
    ...
    name: { en: 'Saint-Malo to Louisbourg Corridor', fr: 'Corridor Saint-Malo–Louisbourg', it: 'Corridoio Saint-Malo–Louisbourg', de: 'Korridor Saint-Malo–Louisbourg' },
  ...
  // --- Viking / Norman migration flows ---
  {
    ...
    name: { en: 'Danish Migration to Seine', fr: 'Migration danoise vers la Seine', it: 'Migrazione danese verso la Senna', de: 'Dänische Migration an die Seine' },
  ...
  },
  {
    ...
    name: { en: 'Anglo-Scandinavian Settlement', fr: 'Colonisation anglo-scandinave', it: 'Insediamento anglo-scandinavo', de: 'Anglo-skandinavische Kolonisierung' },
    eraIds: ['norman-origins'],
    segmentIds: [
      'seg-danelaw-rouen',
      'seg-danelaw-caen',
  ...
  // --- Global Viking journeys ---
  {
    ...
    name: { en: 'Danish North Sea Lane', fr: 'Voie danoise de la mer du Nord', it: 'Via danese del Mare del Nord', de: 'Dänischer Nordseeweg' },
  ...
  },
  {
    ...
    name: { en: 'Loire Valley Raids', fr: 'Raids dans la vallée de la Loire', it: 'Incursioni nella valle della Loira', de: 'Razzien im Loiretal' },
    eraIds: ['frankish-carolingian', 'viking-age'],
  ...
  },
  {
    ...
    name: { en: 'Rhine / Meuse Raids', fr: 'Raids du Rhin / de la Meuse', it: 'Incursioni sul Reno / sulla Mosa', de: 'Überfälle auf Rhein und Maas' },
    eraIds: ['frankish-carolingian', 'viking-age'],
  ...
  },
  {
    ...
    name: { en: 'Baltic to Novgorod — Eastern Gateway', fr: 'Baltique vers Novgorod — porte orientale', it: 'Dal Baltico a Novgorod — porta orientale', de: 'Ostsee nach Nowgorod – östliches Tor' },
    eraIds: ['viking-age', 'norman-origins'],
    segmentIds: [
      'seg-birka-ladoga',
      'seg-ladoga-novgorod',
  ...
  },
  {
    ...
    name: { en: 'Dnieper Route — Varangians to the Greeks', fr: 'Route du Dniepr — des Varègues aux Grecs', it: 'Rotta del Dnepr — dai Variaghi ai Greci', de: 'Dnjepr-Route – von den Warägern zu den Griechen' },
    eraIds: ['viking-age', 'norman-origins'],
    segmentIds: [
      'seg-novgorod-kiev',
  ...
  },
  {
    ...
    name: { en: 'Volga Trade Route', fr: 'Route commerciale de la Volga', it: 'Rotta commerciale della Volga', de: 'Wolga-Handelsroute' },
    eraIds: ['viking-age'],
  ...
  },
  {
    ...
    name: { en: 'Atlantic Norse — Iceland to Vinland', fr: 'Norrois atlantique — Islande au Vinland', it: 'Nordici atlantici — Islanda al Vinland', de: 'Atlantik-Nordisch – Island in Vinland' },
    eraIds: ['viking-age', 'norman-origins'],
    segmentIds: [
      'seg-norway-iceland',
  ...
  // --- Age of Exploration journeys ---
  {
    ...
    name: { en: 'Verrazzano\'s Voyage (1524)', fr: 'Voyage de Verrazzano (1524)', it: 'Viaggio di Verrazzano (1524)', de: 'Reise von Verrazzano (1524)' },
  ...
  {
    id: 'journey-cartier',
    name: { en: 'Cartier\'s Voyages (1534–1542)', fr: 'Voyages de Cartier (1534–1542)', it: 'Viaggi di Cartier (1534–1542)', de: 'Reisen von Cartier (1534–1542)' },
    eraIds: ['age-of-exploration'],
    segmentIds: [
  ...
  },
  {
    ...
    name: { en: 'Champlain\'s Great Lakes Exploration', fr: 'Exploration des Grands Lacs par Champlain', it: 'Esplorazione dei Grandi Laghi di Champlain', de: 'Champlains Erkundung der Großen Seen' },
    eraIds: ['new-france-foundations'],
  ...
  },
  {
    ...
    name: { en: 'Brûlé\'s Interior Penetration', fr: 'Pénétration intérieure de Brûlé', it: 'Penetrazione nell\'interno di Brûlé', de: 'Brûlés innere Durchdringung' },
    eraIds: ['new-france-foundations'],
  ...
  },
  {
    ...
    name: { en: 'Radisson & Des Groseilliers', fr: 'Radisson et Des Groseilliers', it: 'Radisson e Des Groseilliers', de: 'Radisson und Des Groseilliers' },
    eraIds: ['new-france-foundations', 'royal-new-france'],
  ...
  },
  {
    ...
    name: { en: 'Jolliet & Marquette — Mississippi Discovery', fr: 'Jolliet et Marquette — Découverte du Mississippi', it: 'Jolliet e Marquette — Scoperta del Mississippi', de: 'Jolliet und Marquette – Entdeckung des Mississippi' },
    eraIds: ['royal-new-france'],
    segmentIds: [
  ...
  },
  {
    ...
    name: { en: 'La Salle — Mississippi to the Gulf', fr: 'La Salle — Mississippi au Golfe', it: 'La Salle — Mississippi fino al Golfo', de: 'La Salle – Von Mississippi bis zum Golf' },
    eraIds: ['royal-new-france'],
    segmentIds: [
  ...
  {
    id: 'journey-nicolet',
    name: { en: 'Jean Nicolet — Lake Michigan (1634)', fr: 'Jean Nicolet — Lac Michigan (1634)', it: 'Jean Nicolet — Lago Michigan (1634)', de: 'Jean Nicolet – Michigansee (1634)' },
    eraIds: ['new-france-foundations'],
    segmentIds: [
  ...
  {
    id: 'journey-hennepin',
    name: { en: 'Hennepin — Upper Mississippi (1680)', fr: 'Hennepin — Haut Mississippi (1680)', it: 'Hennepin — Alto Mississippi (1680)', de: 'Hennepin – Oberer Mississippi (1680)' },
    eraIds: ['royal-new-france'],
    segmentIds: [
  ...
  },
  {
    ...
    name: { en: 'd\'Iberville — Louisiana Founding (1699)', fr: 'd\'Iberville — Fondation de la Louisiane (1699)', it: 'd\'Iberville — Fondazione della Louisiana (1699)', de: 'd\'Iberville – Gründung von Louisiana (1699)' },
    eraIds: ['royal-new-france'],
    segmentIds: [
  ...
  },
  {
    ...
    name: { en: 'La Vérendrye — Western Prairies (1731–1743)', fr: 'La Vérendrye — Prairies de l\'Ouest (1731–1743)', it: 'La Vérendrye — Praterie occidentali (1731–1743)', de: 'La Vérendrye – Western Prairies (1731–1743)' },
