...
export const LETTERS_PHYLO_EXCEPT_R: Record<Exclude<HaplogroupMajorLetter, 'R'>, PhylogeographyLetterDataset> = {
  ...
  E: {
    ...
    nodes: [
      { id: 'e-deep', label: 'Deep African stem (illustrative)', ...DEEP_AFRICA },
      { id: 'e-sahel', label: 'Sahel / Horn hub', lat: 12, lng: 35 },
      { id: 'e-na', label: 'North Africa / Maghreb', lat: 32, lng: 5 },
      { id: 'e-lev', label: 'E1b1b (illustrative — see profile)', lat: 35, lng: 33, profileId: 'y-e1b1b' },
    ],
    edges: [
      { fromId: 'e-deep', toId: 'e-sahel' },
      { fromId: 'e-sahel', toId: 'e-na' },
      { fromId: 'e-sahel', toId: 'e-lev' },
    ],
  ...
  G: {
    ...
    nodes: [
      { id: 'g-deep', label: 'Southwest Asia stem (illustrative)', ...SW_ASIA_HUB },
      { id: 'g-cau', label: 'Greater Caucasus hub', lat: 42.5, lng: 44 },
      { id: 'g-ana', label: 'Anatolia', lat: 39, lng: 35 },
      { id: 'g-eu', label: 'Europe (illustrative pockets)', lat: 46, lng: 12 },
    ],
    edges: [
      { fromId: 'g-deep', toId: 'g-cau' },
      { fromId: 'g-cau', toId: 'g-ana' },
      { fromId: 'g-ana', toId: 'g-eu' },
    ],
  ...
  I: {
    ...
    nodes: [
      { id: 'i-deep', label: 'Southeast Europe stem (illustrative)', lat: 44, lng: 22 },
      { id: 'i-balk', label: 'Balkans / Danube hub', lat: 43, lng: 20 },
      { id: 'i-i1', label: 'I1 (North European branch)', lat: 60, lng: 15, profileId: 'y-i1' },
      { id: 'i-i2', label: 'I2a (illustrative)', lat: 46, lng: 18, profileId: 'y-i2a' },
    ],
    edges: [
      { fromId: 'i-deep', toId: 'i-balk' },
      { fromId: 'i-balk', toId: 'i-i1' },
      { fromId: 'i-balk', toId: 'i-i2' },
    ],
  ...
  J: {
    ...
    nodes: [
      { id: 'j-deep', label: 'Southwest Asia stem (illustrative)', ...SW_ASIA_HUB },
      { id: 'j-zag', label: 'Zagros / Mesopotamia hub', lat: 33, lng: 48 },
      { id: 'j-med', label: 'J2 — Mediterranean spread (illustrative)', lat: 37, lng: 22, profileId: 'y-j2' },
    ],
    edges: [
      { fromId: 'j-deep', toId: 'j-zag' },
      { fromId: 'j-zag', toId: 'j-med' },
    ],
  ...
  N: {
    ...
    nodes: [
      { id: 'n-deep', label: 'Altai / South Siberia hub', lat: 50, lng: 88 },
      { id: 'n-ural', label: 'Urals / West Siberia', lat: 58, lng: 62 },
      { id: 'n-fin', label: 'Baltic / Fennoscandia (illustrative)', lat: 62, lng: 25 },
    ],
    edges: [
      { fromId: 'n-deep', toId: 'n-ural' },
      { fromId: 'n-ural', toId: 'n-fin' },
    ],
  ...
  Q: {
    ...
    nodes: [
      { id: 'q-deep', label: 'Central / North Asia hub', lat: 52, lng: 95 },
      { id: 'q-ber', label: 'Beringian staging (illustrative)', lat: 66, lng: -165 },
      { id: 'q-na', label: 'North America', lat: 45, lng: -105 },
      { id: 'q-sa', label: 'South America (illustrative branch)', lat: -15, lng: -60 },
    ],
    edges: [
      { fromId: 'q-deep', toId: 'q-ber' },
      { fromId: 'q-ber', toId: 'q-na' },
      { fromId: 'q-na', toId: 'q-sa' },
    ],
