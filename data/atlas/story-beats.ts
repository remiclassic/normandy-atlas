...
export const atlasStoryBeats: StoryBeat[] = [
  // --- Deep-time continuity beats ---
  {
    ...
    copy: {
      ...
      body: {
        ...
        de: 'Lange bevor es schriftliche Aufzeichnungen gab, errichteten neolithische Gemeinden überall in der zukünftigen Normandie und auf den benachbarten Kanalinseln Steindenkmäler. Die Dolmen von Vauville, die Megalithen von Fontenay-le-Marmion, die Ganggräber von La Hougue Bie auf Jersey und die Bestattungen von Cairon markieren den ältesten menschlichen Abdruck in dieser Landschaft – eine Gründungsschicht, die allem, was folgt, zugrunde liegt.',
      },
    },
  },
  {
    ...
    copy: {
      ...
      body: {
        ...
        de: 'Zinn aus Cornwall, Kupfer aus Iberien und Bernstein aus der Ostsee gelangten während der Bronzezeit über den Ärmelkanal. Die Küste der Normandie war ein natürlicher Kreuzungspunkt – dieselben Häfen, die später Langschiffe der Wikinger anliefen, waren bereits seit über einem Jahrtausend Handelsschiffe.',
      },
    },
  },
  {
    ...
    copy: {
      ...
      body: {
        ...
        de: 'Die Calètes, die Véliocasses, die Unelles und die Abrincates schufen Gebiete, die als Verwaltungsgrenzen unter Rom und darüber hinaus bestehen blieben. Rotomagus – das zukünftige Rouen – beherrschte bereits die Seine. Die von ihnen errichteten Oppida befanden sich auf denselben strategischen Höhen, auf denen später normannische Burgen errichtet wurden.',
      },
    },
  },
  {
    ...
    copy: {
      ...
      body: {
        ...
        de: 'Nach Caesars Eroberung wurden die Stammesgebiete zu römischen Civitates. Straßen ersetzten Wege, Amphitheater entstanden neben Oppida und Rotomagus wurde zur Provinzhauptstadt. Dieselben Flusskorridore, die dem keltischen Handel dienten, beförderten jetzt römische Lastkähne – und dieselben Küstenfestungen beherbergten später die Verteidigungsanlagen des Litus Saxonicum.',
      },
    },
  },
  // --- Post-Roman → Medieval beats ---
  {
    ...
    copy: {
      ...
      body: {
        ...
        de: 'Nach dem Fall Roms teilten die Franken Gallien in Unterreiche auf. Neustrie – der westliche Teil – umfasste das Seinebecken mit Rouen und Paris als Ankerpunkten. Diese politische Geographie legte den Grundstein: Die Seine war bereits lange vor der Ankunft der Wikinger ein Machtkorridor.',
      },
    },
  ...
  },
  {
    ...
    copy: {
      ...
      body: {
        ...
        de: 'Das Reich Karls des Großen gliederte Neustrien in einen riesigen fränkischen Staat ein. Quentovics Handelszentrum verband Gallien mit dem Nordseehandel, während Nantes den nach Westen ausgedehnten bretonischen Marsch ankerte. Entlang der Seine blühten wohlhabende Abteien, aber die schiere Größe des Reiches stellte die Grenzverteidigung auf eine harte Probe – eine Schwachstelle, die sich als fatal erweisen würde, als die skandinavischen Flotten am Horizont auftauchten.',
      },
    },
    aiSlot: 'explain_selection',
  },
  {
    ...
    copy: {
      ...
      body: {
        ...
        de: 'Unter den Karolingern verband die untere Seine das königliche Kernland um Paris über Rouen mit der Kanalküste. Reiche Abteien wie Jumièges säumten den Fluss. Diese Konzentration politischer, wirtschaftlicher und klösterlicher Macht entlang einer einzigen Wasserstraße machte die Region außerordentlich wohlhabend – und außerordentlich verwundbar.',
      },
    },
    aiSlot: 'explain_selection',
  },
  {
    ...
    copy: {
      ...
      body: {
        ...
        de: 'Ab den 840er Jahren drangen skandinavische Flotten in die Seine-Mündung ein und segelten mit verheerender Effizienz den Fluss hinauf. Rouen wurde eingenommen, Jumièges geplündert und 885 belagerte eine riesige Flotte Paris. Der fränkische Staat konnte seinen eigenen Flusskorridor nicht verteidigen – ein Misserfolg, der die politische Landkarte Nordfrankreichs verändern würde.',
      },
    },
    aiSlot: 'explain_selection',
  },
  {
    ...
    copy: {
      ...
      body: {
        ...
        de: 'Wiederholte Einfälle verwandelten die untere Seine von einem freien Kernland in eine umkämpfte Grenze. Die karolingischen Könige, geschwächt durch Bürgerkriege und nicht in der Lage, die Raubzüge zu stoppen, entschieden sich schließlich für Verhandlungen. Im Jahr 911 überließ Karl der Einfältige das Gebiet der unteren Seine dem Wikingerführer Rollo im Austausch gegen einen Verteidigungspuffer – den Vertrag von Saint-Clair-sur-Epte. Es war kein Geschenk. Es war die Erkenntnis, dass die fränkische Macht bereits die Kontrolle über die Region verloren hatte.',
      },
    },
    aiSlot: 'explain_selection',
    readingLinks: [
      {
        label: { en: 'Treaty of Saint-Clair-sur-Epte (911) — Encyclopaedia Britannica', fr: 'Traité de Saint-Clair-sur-Epte (911) — Encyclopaedia Britannica', de: 'Vertrag von Saint-Clair-sur-Epte (911) — Encyclopaedia Britannica' },
        url: 'https://www.britannica.com/event/Treaty-of-Saint-Clair-sur-Epte',
        kind: 'popular',
      },
      {
        label: { en: 'Pierre Bauduin — Le monde franc et les Vikings', fr: 'Pierre Bauduin — Le monde franc et les Vikings', de: 'Pierre Bauduin — Le monde franc et les Vikings' },
        url: 'https://www.editions-albin-michel.fr/le-monde-franc-et-les-vikings-9782226448712',
        kind: 'synthesis',
        note: { en: 'Authoritative French-language study of Carolingian–Norse interaction', fr: 'Étude de référence sur les interactions carolingiennes–norses', de: 'Maßgebliche französischsprachige Studie zur karolingisch-nordischen Begegnung' },
      },
    ],
  },
  {
    ...
    copy: {
      ...
      body: {
        ...
        de: 'Aus dem Vertrag ging nicht einfach nur eine Wikingerkolonie hervor. Im Laufe der nächsten Jahrzehnte übernahmen skandinavische Siedler fränkische Institutionen, Sprache und Christentum, behielten aber eine Kriegeraristokratie und maritime Ausrichtung bei. Rouen wurde zur herzoglichen Hauptstadt; Siedlungskorridore erstreckten sich nach Westen. Mitte des 10. Jahrhunderts hatte das Gebiet einen Namen – Normandie – und eine eindeutige Identität: weder vollständig fränkisch noch skandinavisch, sondern etwas Neues, das im Schmelztiegel der unteren Seine geschmiedet wurde.',
      },
    },
    aiSlot: 'explain_selection',
  },
  {
    ...
    copy: {
      ...
      body: {
        ...
        de: 'Die Normandie galt nicht als Mythos einzigartigen Ursprungs, sondern als Küsten- und Flussgelenk zwischen der Bevölkerung im Landesinneren, dem maritimen Wissen und dem Abgang zum Atlantik.',
      },
    },
    aiSlot: 'explain_selection',
  },
  {
    ...
    copy: {
      ...
      body: {
        ...
        de: 'Die Karte sollte die Überfahrten als historische Korridore darstellen und nicht als perfekte Aufzeichnungen eines einzelnen Schiffes. Reisen beinhaltete oft Systeme von Häfen, Verträgen und wiederholten Abfahrten.',
      },
    },
    aiSlot: 'explain_selection',
  },
  {
    ...
    copy: {
      ...
      body: {
        ...
        de: 'Eine relativ kleine Zahl von Siedlern, die über wiederholte regionale Kanäle rekrutiert wurden, könnte einen bleibenden kulturellen Eindruck hinterlassen, wenn sie sich auf wichtige Kolonialsiedlungen konzentrierten.',
      },
    },
    aiSlot: 'explain_selection',
  },
  {
    ...
    copy: {
      ...
      body: {
        ...
        de: 'Neu-Frankreich zog Siedler aus dem gesamten atlantischen Frankreich an, aber einige Regionen boten weitaus mehr als andere. Auf den Nordwesten (Normandie, Bretagne, Perche) entfallen etwa 39 % aller Einwanderer, auf den mittleren Westen (Aunis, Saintonge, Poitou) weitere 19 %. Aus diesem Grund verfolgen heute so viele Frankokanadier normannische oder nahe Vorfahren: Wiederholte Rekrutierungskanäle über die Häfen und Gemeinden des Nordwestens sowie eine eingeschränkte Kolonialbasis haben einen unverhältnismäßigen Einfluss auf die Genealogie hinterlassen. Die Kanalinseln teilten sich den gleichen normannischen Kulturkreis, doch St. Peter Port und andere Inselhäfen waren nicht die wichtigsten dokumentierten Einschiffungspunkte der Kolonie – Schiffe fuhren hauptsächlich von Festlandhäfen wie Dieppe, Honfleur, La Rochelle und St. Malo ab. Öffnen Sie den Migrations-Explorer, um Kohorten zu vergleichen, lesen Sie den Kasten zu Inseln und aktivieren Sie Strömungskorridore (Hauptrouten im Vergleich zu diskreteren Inselverbindungen).',
      },
    },
    aiSlot: 'explain_selection',
  },
  {
    ...
    copy: {
      ...
      body: {
        ...
        de: 'Die Geschichte des Atlantiks geht über die Normandie hinaus. Häfen wie La Rochelle und Saint-Malo versorgten unterschiedliche, aber miteinander verbundene Kolonialkorridore über den Ozean.',
      },
    },
    aiSlot: 'explain_selection',
  },
  ...
  // ── New France Arc beats ──────────────────────────────────────────
  {
    ...
    copy: {
      ...
      body: {
        ...
        de: 'Neu-Frankreich zog Siedler aus der gesamten Atlantikküste Frankreichs an. Die Normandie, Perche, die Bretagne und der Mittlere Westen brachten jeweils unterschiedliche Kohorten mit – Gründerväter, Mannschaften, Soldaten und Ordensleute – die über einige kontinentale Einschiffungshäfen (Dieppe, Honfleur, La Rochelle, Saint-Malo) reisten. Die Kanalinseln gehörten kulturell und historisch zu dieser normannischen Sphäre, waren aber keine Massenterminals für koloniale Auswanderungen; Auf den Inseln geborene Menschen werden, wenn sie auftauchen, in den Registern am häufigsten in die umfassenderen „französischen“ oder „normannischen“ Kategorien eingeteilt. Französisch-kanadische Stammbäume heben die Normandie oft hervor, weil diese Kanäle dicht waren und die Gründungsbevölkerung des Sankt-Lorenz-Stroms klein war, und nicht, weil die Kolonie ausschließlich normannischen Ursprungs war.',
      },
    },
    anchorYear: 1608,
  },
  {
    ...
    copy: {
      ...
      body: {
        ...
        de: 'Die Schiffe verließen im Frühjahr Dieppe, La Rochelle, Honfleur und Saint-Malo, überquerten die Grenze in sechs bis zwölf Wochen und transportierten Siedler, Vorräte und Waren nach Kanada. Die Kolonie St. Lawrence war für viele das wichtigste demografische Ziel; Acadia schöpfte hauptsächlich aus La Rochelle und Saint-Malo aus dem gleichen Netzwerk kontinentaler Häfen – nicht aus Inselhäfen als großen Terminals. Die Rückreise brachte die Pelze zurück nach Frankreich.',
      },
    },
    anchorYear: 1620,
  },
  {
    ...
    copy: {
      ...
      body: {
        ...
        de: 'Die Kolonisierung konzentrierte sich entlang des Saint-Laurent in einem dünnen herrschaftlichen Band von Quebec über Trois-Rivières nach Montreal. Dieser Korridor war das Rückgrat von Neu-Frankreich – seine Verwaltungs-, Handels- und Militärachse.',
      },
    },
    anchorYear: 1645,
  },
  {
    ...
    copy: {
      ...
      body: {
        ...
        de: 'Entdecker wie Champlain, Brûlé und Radisson erweiterten die französische Präsenz im Herzen der Großen Seen. Festungen, Missionen und Handelsposten in Michilimackinac, Sault Sainte-Marie und Detroit bildeten die Knotenpunkte eines riesigen Binnennetzes, das über die Outaouais-Route mit Montreal verbunden war.',
      },
    },
    anchorYear: 1680,
  },
  {
    ...
    copy: {
      ...
      body: {
        ...
        de: 'Jolliet und Marquette (1673) bestätigten, dass der Mississippi nach Süden floss. La Salle, ein Rouennais, segelte 1682 den ganzen Fluss hinunter bis zum Golf von Mexiko und beanspruchte das Becken als Louisiana. In einem einzigen Akt verwandelte sich Neu-Frankreich von einer Flusskolonie in ein Kontinentalreich.',
      },
    },
    anchorYear: 1682,
  },
  {
    ...
    copy: {
      ...
      body: {
        ...
        de: 'Auf seinem Höhepunkt nach dem Großen Frieden von Montreal (1701) war Neu-Frankreich der größte europäische Gebietsanspruch in Nordamerika – er erstreckte sich vom Sankt-Lorenz-Golf über die Großen Seen bis zum Golf von Mexiko. Aber die Bevölkerung des Hauptkorridors überstieg nie 70.000 Siedler.',
      },
    },
    anchorYear: 1720,
  },
  {
    ...
    copy: {
      ...
      body: {
        ...
        de: 'Der Siebenjährige Krieg brachte das Ende. Louisbourg fiel 1758, Quebec 1759 auf den Abraham-Ebenen und Montreal kapitulierte 1760. Mit dem Pariser Vertrag (1763) wurde ganz Neu-Frankreich an Großbritannien abgetreten. Ein über 150 Jahre aufgebautes Kontinentalsystem verschwand von der Landkarte – aber weder aus der Erinnerung noch aus der Genealogie.',
      },
    },
    anchorYear: 1760,
  },
  ...
  // ── Guillaume Couture guided arc ──────────────────────────────────
  {
    ...
    copy: {
      ...
      body: {
        ...
        de: 'Guillaume Couture wurde am 14. Januar 1618 in Rouen, der normannischen Hauptstadt an der unteren Seine, getauft – dem gleichen Flusskorridor, der später Rekruten und Handwerker nach Atlantik-Kanada lieferte.',
      },
    },
    anchorYear: 1618,
  },
  {
    ...
    copy: {
      ...
      body: {
        ...
        de: 'Um 1640 übersiedelte er als Jesuiten-Laienhilfswerk für Missionen. Die Reise von den Häfen der Normandie nach Quebec dauerte Wochen und markierte den Wendepunkt zwischen europäischem Lernen und amerikanischem Überleben.',
      },
    },
    anchorYear: 1639,
  },
  {
    ...
    copy: {
      ...
      body: {
        ...
        de: 'Quebec war immer noch nur ein schwacher französischer Fuß am Sankt-Lorenz-Strom. Als talentierter Zimmermann betrat Couture eine Welt, in der Bündnisse mit indigenen Nationen kein Luxus waren, sondern die Voraussetzung zum Überleben.',
      },
    },
    anchorYear: 1640,
  },
  {
    ...
    copy: {
      ...
      body: {
        ...
        de: 'Im Jahr 1641 folgte er dem Outaouais-Korridor in Richtung der Wendate-Missionen (Huron). Dort erlernte er Sprachen und Fähigkeiten, die ihn zu einem der effektivsten Dolmetscher der Kolonie machen würden.',
      },
    },
    anchorYear: 1641,
  },
  {
    ...
    copy: {
      ...
      body: {
        ...
        de: 'Bei seiner Rückkehr mit Isaac Jogues wurde er von einer Mohawk-Gruppe entführt, gefoltert und dann adoptiert. Er war der erste französische Laie, der glaubwürdig in Haudenosaunee-Dörfern lebte – ein Wissen, das die Kolonie dringend brauchen würde.',
      },
    },
    anchorYear: 1642,
  },
  {
    ...
    copy: {
      ...
      body: {
        ...
        de: 'Nach 1645 begleitete er Friedensangebote und verhandelte entlang des Flusses. In Bezug auf die Lehnsherrschaft von Lauzon hatte er eine Konzession in Pointe-Lévy – nicht als Lord, sondern als Bewohner gegenüber von Quebec, der im Land verwurzelt war.',
      },
    },
    anchorYear: 1645,
  },
  {
    ...
    copy: {
      ...
      body: {
        ...
        de: 'Er begab sich an der Ausfahrt Dollard des Ormeaux in Richtung Outaouais. Die Belagerung von Long-Sault wurde zu einer der militärischen Gründungsgeschichten Französisch-Kanadas – Couture war als Dolmetscher und Kämpfer dabei.',
      },
    },
    anchorYear: 1660,
  },
  {
    ...
    copy: {
      ...
      body: {
        ...
        de: 'Im Jahr 1663 führte er Kanus durch den Saguenay zum Mistassini-See, einer der tiefsten französischen Streifzüge in die Subarktis. Er starb 1701 in Quebec; Seine Nachkommen tragen noch immer die Geschichte der Normannen und Laurentianer in ganz Nordamerika weiter.',
      },
    },
    anchorYear: 1663,
  },
  ...
  // ── Neolithic Normandy Arc beats ─────────────────────────────────
  {
    ...
    copy: {
      ...
      body: {
        ...
        de: 'Um 5000 v. Chr. Chr. erreichte die neolithische Revolution die Flusstäler und Küstenebenen der zukünftigen Normandie. Landwirtschaftliche Gemeinschaften, die aus dem Süden und Osten einwanderten, brachten domestizierten Weizen, Gerste, Vieh und eine radikal neue Lebensweise mit. Zum ersten Mal ließen sich die Menschen dauerhaft nieder – sie rodeten Wälder, bestellten den Boden und bauten Dörfer entlang derselben Flussterrassen und Küstentiefebenen, die jede nachfolgende Zivilisation bewohnen würde. Die Landschaft wurde beansprucht, und die ersten Markierungen dieses Anspruchs würden bald in Stein entstehen.',
      },
    },
    anchorYear: -5000,
  },
  {
    ...
    copy: {
      ...
      body: {
        ...
        de: 'Der Dolmen von Vauville liegt an der windgepeitschten Küste des Cotentin und ist eines der ältesten Megalithdenkmäler der Normandie. Dolmen waren kollektive Grabkammern – riesige Steinplatten, die errichtet wurden, um die Gebeine der Vorfahren der Gemeinschaft zu beherbergen. Sie waren nicht versteckt, sondern prominent auf Landzungen, Hügeln und Flussufern platziert, wo sie schon von weitem sichtbar waren. Einen Dolmen zu bauen bedeutete zu erklären: Wir gehören zu diesem Land und unsere Toten wachen darüber. Der Dolmen von Vauville stand hier dreitausend Jahre lang, bevor der erste keltische Krieger geboren wurde.',
      },
    },
    anchorYear: -4500,
  },
  {
    ...
    copy: {
      ...
      body: {
        ...
        de: 'Die megalithische Dynamik, die die Küste des Cotentin prägte, erstreckte sich auch auf die Kanalinseln. La Hougue Bie in Jersey – ein zwanzig Meter langes Ganggrab, ausgerichtet auf den Sonnenaufgang zur Tagundnachtgleiche – ist eines der schönsten neolithischen Denkmäler in Westeuropa. In der Nähe bezeugen La Pouquelaye de Faldouet mit seiner massiven Dachplatte und Doppelkammer sowie Le Déhus in Guernsey, dass die Inseln keine Randlage, sondern vollständig in die atlantische Steinwelt integriert waren. Diese Gemeinden blickten auf das Meer und waren durch dieselben Seenetze verbunden, die später Bronze, Eisen und Siedler transportierten.',
      },
    },
    anchorYear: -4300,
  },
  {
    ...
    copy: {
      ...
      body: {
        ...
        de: 'Auf dem Kalksteinplateau rund um das heutige Caen markierte eine dichte Gruppe megalithischer Monumente eine der bedeutendsten neolithischen Rituallandschaften in Nordfrankreich. Der Komplex von Fontenay-le-Marmion – mit seinen langen Hügeln und Grabkammern – und der benachbarte Ort Cairon bildeten eine heilige Geographie, die jahrhundertelang das Leben und Sterben landwirtschaftlicher Gemeinschaften regelte. Hierbei handelte es sich nicht um isolierte Bestattungen, sondern um miteinander verbundene Zeremonienzentren, die entlang von Sichtlinien und saisonalen Wegen angeordnet waren. Die Ebene von Caen war das Herz der neolithischen Normandie.',
      },
    },
    anchorYear: -4200,
  },
  {
    ...
    copy: {
      ...
      body: {
        ...
        de: 'Der überdachte Gehweg in Bretteville-sur-Laize ist eine Galeriebestattung – ein langer, schmaler Gang, der mit Steinplatten bedeckt ist und für die Unterbringung von Generationen von Toten gedacht ist. Diese Korridorgräber gehörten zu den ehrgeizigsten architektonischen Errungenschaften des neolithischen Europas: Einige erstreckten sich über zwanzig Meter, ihre Wände waren mit eingravierten Motiven verziert. Es handelte sich um Denkmäler der Gemeinschaft, die bekräftigten, dass die Gemeinschaft – und nicht der Einzelne – zählte. Jede Generation fügte auf dem Weg ihren Tod hinzu und überlagerte so die Gegenwart mit der Vergangenheit in einem Ritual, das tausend Jahre andauern sollte.',
      },
    },
    anchorYear: -3800,
  },
  {
    ...
    copy: {
      ...
      body: {
        ...
        de: 'Menhire – große stehende Steine ​​– sind die rätselhaftesten neolithischen Denkmäler. Der Menhir de Dol, nahe der Grenze zwischen der Bretagne und der Normandie, erhebt sich wie ein Wächter aus der Ebene. Waren sie Grenzmarkierungen, astronomische Sichtsteine ​​oder Objekte der Verehrung? Vielleicht alle drei. Sicher ist, dass die Menhire mit Absicht platziert wurden: an Kreuzungen, auf Bergrücken, an Territorialgrenzen. Sie waren die ersten von Menschenhand geschaffenen Wahrzeichen in einer Landschaft, die bisher nur Bäume und Flüsse kannte. Ihre Lage war ein Vorgeschmack auf die Logik jeder darauffolgenden Grenze, Straßenmarkierung und jedes Kirchturms.',
      },
    },
    anchorYear: -3500,
  },
  {
    ...
    copy: {
      ...
      body: {
        ...
        de: 'Nicht alle Denkmäler standen an der Küste. Der Teufelstisch in Passais, im Herzen des Bocage der südlichen Normandie, beweist, dass die Gemeinden im Landesinneren ebenso in das Megalithritual investiert waren. Dieser „Teufelstisch“ – eine riesige, auf Pfosten balancierte Dachplatte – markiert eine Grabstätte fernab des Meeres, in hügeligem Ackerland, das fünftausend Jahre lang bemerkenswert unverändert bleiben sollte. Die neolithische Normandie war nicht nur ein Küstenphänomen; es erstreckte sich bis in jedes Flusstal und jede Waldlichtung, wo die Bauern Wurzeln schlagen konnten.',
      },
    },
    anchorYear: -3200,
  },
  {
    ...
    copy: {
      ...
      body: {
        ...
        de: 'Zusammengenommen offenbaren die Megalithdenkmäler der Normandie und der Kanalinseln eine Landschaft, die von ihren frühesten landwirtschaftlichen Gemeinschaften bewusst organisiert wurde. Dolmen an der Küste des Cotentin, Ganggräber in Jersey und Guernsey, überdachte Gehwege in der Ebene von Caen, Menhire an Territorialgrenzen, Grabgruppen an Ritualzentren: Dies waren keine zufällig platzierten Steine, sondern eine zusammenhängende Geographie des Heiligen und des Politischen, die sich vom Kontinent bis zu benachbarten Inseln erstreckte. Die gleichen Orte, die die neolithischen Menschen für ihre Denkmäler wählten – Vorgebirge, Flussübergänge, Plateauränder – wurden immer wieder von keltischen Führern, römischen Ingenieuren, fränkischen Königen und normannischen Herren ausgewählt. Die erste Karte der Normandie wurde in Stein gezeichnet.',
      },
    },
    anchorYear: -2800,
  },
  {
    ...
    copy: {
      ...
      body: {
        ...
        de: 'Um 2000 v. Chr. Chr. machte die neolithische Welt etwas Neuem Platz. Das Wissen über Metallurgie – zuerst Kupfer, dann Bronze – verbreitete sich von Osten und Süden. Die große Ära des Megalithbaus ging zu Ende, aber die Denkmäler blieben still und langlebig. Neue Völker würden ankommen, neue Technologien würden die Wirtschaft verändern und der Ärmelkanal würde zur Autobahn für den Zinnhandel werden. Doch die Dolmen, Menhire und überdachten Gehwege, die von den ersten Bauern der Normandie und der Kanalinseln errichtet wurden, würden – wie auch heute noch – die älteste Schicht menschlicher Erinnerung darstellen, die in eine Landschaft eingeschrieben ist, die nie aufhört, sich zu verändern.',
      },
    },
    anchorYear: -2000,
  },
  ...
  // ── Bronze Age Channel Arc beats ─────────────────────────────────
  {
    ...
    copy: {
      ...
      body: {
        ...
        de: 'Lange bevor es schriftliche Aufzeichnungen gab, war der Ärmelkanal eine der verkehrsreichsten Wasserstraßen Europas. Ab etwa 2000 v. Chr. Chr. verwandelte die Nachfrage nach Bronze – einer Legierung aus Kupfer und Zinn – die enge Meerenge in eine Seestraße. Zinn aus Cornwall und Kupfer vom Kontinent mussten den Ärmelkanal überqueren, und die Küste der zukünftigen Normandie lag direkt auf der Route. Hautboote und Kanus transportierten Edelmetalle, Bernstein und Ideen zwischen der Insel Bretagne und dem Kontinent. Der Kanal war kein Hindernis; es war eine Brücke.',
      },
    },
    anchorYear: -2000,
  },
  {
    ...
    copy: {
      ...
      body: {
        ...
        de: 'Cornwall war einer der wenigen Orte in Europa, wo Zinn in großen Mengen gefunden werden konnte. Ohne Zinn keine Bronze; ohne Bronze, ohne Waffen, Werkzeuge oder Prestigegüter, die diese Ära prägten. Kornisches Zinn war das begehrteste Handelsgut in Westeuropa, und die Gemeinden, die seinen Export kontrollierten, übten enormen Einfluss aus. Zwei Hauptseewege transportierten dieses Zinn nach Süden über den Ärmelkanal: einer zur Cotentin-Küste, der andere zu den Kreideküsten des Pays de Caux. Beide Routen machten die Küste der Normandie zu einem wichtigen Kreuzungspunkt in einem kontinentalen Handelsnetz.',
      },
    },
    anchorYear: -1800,
  },
  {
    ...
    copy: {
      ...
      body: {
        ...
        de: 'Die Halbinsel Cotentin ragte wie ein Kai in den Ärmelkanal hinein und bot die kürzeste Überfahrt südwestlich der Bretagne. Seine geschützten Buchten und natürlichen Häfen machten es zu einem idealen Anlegepunkt für Fellboote und Kanus, die Zinn, Kupfer und Waren transportierten. Nahe der Küste häuften sich Siedlungen, und auf den Landzungen standen noch antike neolithische Denkmäler wie der Vauville-Dolmen – stille Zeugen einer Landschaft, die bereits durch Jahrtausende menschlicher Aktivität geprägt war. Der Cotentin war der Treffpunkt der atlantischen und kontinentalen Welt.',
      },
    },
    anchorYear: -1600,
  },
  {
    ...
    copy: {
      ...
      body: {
        ...
        de: 'Um 1500 v. Chr. Chr. erreichte der kanalübergreifende Handel seinen Höhepunkt. Zwei gut ausgebaute Seekorridore verbanden Cornwall mit der Küste der Normandie: eine westliche Route nach Cotentin und eine östliche Route nach Caux. Von diesen Anlegestellen aus gelangten die Waren über Flüsse und Wege ins Landesinnere bis zur Seine-Mündung und darüber hinaus – ins Herz Kontinentaleuropas. In ganz Nordfrankreich gefundene Bronzeartefakte tragen die chemische Signatur von kornischem Zinn und beweisen, dass es sich hierbei nicht um Gelegenheitshandel, sondern um ein nachhaltiges und organisiertes Handelssystem handelte. Der Kanal war die Autobahn seiner Zeit.',
      },
    },
    anchorYear: -1500,
  },
  {
    ...
    copy: {
      ...
      body: {
        ...
        de: 'Die Seine-Mündung war der Ort, an dem die maritime Welt des Ärmelkanals auf die Flusswelt des gallischen Binnenlandes traf. Auf dem Seeweg ankommende Waren – Zinn, Kupfer, Bernstein, Salz – wurden hier auf Flussschiffe umgeladen, die sie flussaufwärts nach Paris brachten, das später einmal werden sollte. Dieser Umschlagplatz war der Vorläufer jedes Hafens, der später diesen Küstenabschnitt besetzen sollte: der römische Rotomagus, das Wikinger-Rouen, die mittelalterlichen Hafenstädte der Seine. Die Geographie der Flussmündung – breit, gezeitenabhängig und schiffbar – machte sie zu einem natürlichen Tor, und jede nachfolgende Zivilisation würde es als solches nutzen.',
      },
    },
    anchorYear: -1300,
  },
  {
    ...
    copy: {
      ...
      body: {
        ...
        de: 'Die östliche Kanalroute brachte kornisches Zinn an die Kreideküste des Pays de Caux – die spektakulären weißen Klippen nördlich der Seine. Hier dienten geschützte Strände zwischen den Landzungen als Anlegestellen für Handelsschiffe. Die Caux-Küste war direkt mit dem Gebiet der späteren eisenzeitlichen Calètes verbunden, und die von ihr bereitgestellten Häfen mit Blick auf den Kanal dienten allen Seefahrervölkern, von Händlern aus der Bronzezeit bis hin zu normannischen Fischern. Die gleiche Küstengeographie, die Zinnhändler anzog, würde eines Tages Wikingerräuber anlocken, die auf der Suche nach der Seine waren.',
      },
    },
    anchorYear: -1200,
  },
  {
    ...
    copy: {
      ...
      body: {
        ...
        de: 'Die über die Landschaft verstreuten großen Steindenkmäler der Jungsteinzeit – Dolmen, Menhire und überdachte Gehwege – standen noch in der Bronzezeit und waren bereits uralt. Die Dolmen von Vauville an der Küste des Cotentin und die Megalithgruppe in Fontenay-le-Marmion waren Tausende von Jahren alt und wurden von landwirtschaftlichen Gemeinschaften erbaut, deren Welt verschwunden war. Den Menschen der Bronzezeit waren sie jedoch nicht unbekannt: Sie nutzten Grabkammern wieder, hinterließen Opfergaben an antiken heiligen Stätten und richteten ihre eigenen Einrichtungen auf diese Ahnenmarkierungen aus. Die Landschaft war geschichtet und selbst die Frühankömmlinge bauten auf der Vergangenheit eines anderen auf.',
      },
    },
    anchorYear: -1000,
  },
  {
    ...
    copy: {
      ...
      body: {
        ...
        de: 'Um 800 v. Chr. Chr. breitete sich in Europa ein neues Metall aus: Eisen. Eisen war billiger und häufiger vorkommend als Bronze und erforderte keinen Fernhandel mit Zinn, der die Kanalnetze angetrieben hatte. Die großen Seekorridore begannen sich zu verschieben, und die Küstengemeinden, die als Zwischenhändler im Zinnhandel erfolgreich waren, erlebten, wie sich ihre Welt veränderte. Aber das Erbe der Bronzezeit blieb bestehen: Häfen, Seewege, Kenntnisse über Kanalüberquerungen und Siedlungsmuster entlang der Küste blieben bis in die Eisenzeit erhalten. Keltische Stämme würden eine Landschaft erben, die bereits durch jahrhundertelangen Seehandel kartiert wurde – und der Ärmelkanal würde eine Autobahn bleiben, die darauf wartete, dass die nächste Flotte sie durchquerte.',
      },
    },
    anchorYear: -800,
  },
  ...
  // ── Iron Age Gaul Arc beats ──────────────────────────────────────
  {
    ...
    copy: {
      ...
      body: {
        ...
        de: 'Ab etwa 800 v. Chr. Im Jahr 5000 v. Chr. breiteten sich eisenbewaffnete keltische Völker im Norden Galliens aus und veränderten die Landschaft durch neue Technologien, soziale Strukturen und Kriegeraristokratien. Die Region zwischen der Seine und dem Ärmelkanal – später als Normandie bekannt – war zwischen mächtigen Stämmen aufgeteilt, die Gallisch sprachen, ein Pantheon von Naturgöttern verehrten und ihren Reichtum auf Landwirtschaft, Metallurgie und Handel gründeten. Es war kein Hinterland: Der Seine-Korridor und die Kanalküste machten es zu einer der am besten verbundenen Regionen des vorrömischen Europas.',
      },
    },
    anchorYear: -800,
  },
  {
    ...
    copy: {
      ...
      body: {
        ...
        de: 'Die Véliocasses waren der dominierende Stamm im unteren Seine-Tal. Ihre Hauptstadt Rotomagus (heute Rouen) kontrollierte den Punkt, an dem der Gezeitenfluss auf die Binnenwasserstraße traf – ein strategischer Engpass, der zwei Jahrtausende lang das Schicksal der Region bestimmen sollte. Ihr Oppidum befand sich auf den Anhöhen mit Blick auf den Fluss, und Satellitenfestungen wie Duclair bewachten die Zugänge. Die Kontrolle über die Seine gab den Véliocasses die Kontrolle über den Binnenhandel: Zinn, Salz, Getreide und Sklaven zogen alle durch ihr Gebiet. Rotomagus war bis auf den Namen bereits eine Stadt.',
      },
    },
    anchorYear: -500,
  },
  {
    ...
    copy: {
      ...
      body: {
        ...
        de: 'Nördlich der Seine kontrollierten die Calètes das Pays de Caux – das spektakuläre Kreideplateau, das in weißen Klippen entlang des Ärmelkanals abfällt. Ihr Territorium verschaffte ihnen Zugang zu reichen Fischgründen vor der Küste und zum Handel über den Ärmelkanal mit der Insel Bretagne. Ihre Hauptsiedlung in der Nähe des heutigen Lillebonne (später römisches Juliobona) lag an der Kreuzung von Land- und Flusswegen. Die Calètes waren Vermittler: Sie befanden sich zwischen den Véliocasses der Seine und der maritimen Welt dahinter und profitierten von jedem Austausch.',
      },
    },
    anchorYear: -450,
  },
  {
    ...
    copy: {
      ...
      body: {
        ...
        de: 'Westlich der Seine hielten zwei kleinere, aber strategisch wichtige Stämme die Halbinsel Cotentin und die Bucht von Mont-Saint-Michel. Die Unellen mit Sitz in Cosedia (dem heutigen Coutances) beherrschten die Überquerung des Ärmelkanals zur Insel Bretagne und kontrollierten eine der umstrittensten Küsten Galliens. Die Abrincates, die rund um Abrincae (Avranches) ansässig waren, bewachten das Tor zwischen der Armorikanischen Bretagne und der Welt der Seine. Obwohl sie weniger mächtig als die Veliocas waren, kontrollierten diese westlichen Stämme die Meeresränder, die den keltischen Atlantik mit dem gallischen Binnenland verbanden.',
      },
    },
    anchorYear: -400,
  },
  {
    ...
    copy: {
      ...
      body: {
        ...
        de: 'Schon lange vor Rom war die Seine eine wichtige Handelsader. Von Lutèce – der Inselsiedlung der Parisii – gelangten Waren flussabwärts über die Véliocasses zum Ärmelkanal und darüber hinaus. Kornisches Zinn, baltischer Bernstein, mediterraner Wein: Alles gelangte durch diesen Korridor in die Hände der Kelten. Der Fluss hat der Landschaft eine Logik aufgezwungen, die keine politische Veränderung jemals verändern würde. Jede Macht, die die Seine kontrollierte – Kelten, Römer, Franken, Wikinger, Normannen – gedieh; Jede Macht, die sie verlor, fiel.',
      },
    },
    anchorYear: -350,
  },
  {
    ...
    copy: {
      ...
      body: {
        ...
        de: 'Im dritten Jahrhundert v. Chr. Im Jahr 5000 v. Chr. errichteten gallische Stämme Oppida – befestigte Bergsiedlungen, die als Hauptstädte, Märkte und Zufluchtsorte dienten. Dabei handelte es sich nicht um einfache Festungen: Die größeren enthielten Werkstätten, Getreidespeicher, Münzstätten und religiöse Anlagen. Das Oppidum von Rotomagus überblickte die Seine; Juliobona befehligte das Kalkland Calètes; Cosedia ankerte im Cotentin des Unelles; Abrincae wachte über die Bucht. Diese Standorte wählten dieselben strategischen Höhen – Flussmäander, Küstenvorgebirge, Plateauränder –, die später römische Städte, fränkische Paläste und normannische Burgen einnehmen würden. Die Geographie diktierte die Karte, bevor irgendein Imperium sie zeichnete.',
      },
    },
    anchorYear: -300,
  },
  {
    ...
    copy: {
      ...
      body: {
        ...
        de: 'Als Julius Caesars Legionen in den 50er Jahren v. Chr. in Gallien einmarschierten. Chr. wehrten sich die Stämme der Seine und des Cotentin. Viridovix, Anführer der Unellen, bildete 56 v. Chr. eine riesige Koalition, um Rom Widerstand zu leisten. n. Chr. – wurde aber von Sabinus in der Schlacht von Unelles besiegt. Die Veliocasser, gefangen zwischen römischer Macht und ihrem eigenen Stolz, unterwarfen sich diskreter. Auch die Calètes und die Abrincates beugten das Knie. Der Widerstand war erbittert, aber zersplittert: Jeder Stamm kämpfte alleine und Rom eroberte sie einen nach dem anderen. Die keltische Welt im Norden Galliens ging zu Ende.',
      },
    },
    anchorYear: -56,
  },
  {
    ...
    copy: {
      ...
      body: {
        ...
        de: 'Im Jahr 52 v. Chr. war Caesars Eroberung abgeschlossen. Die Stammesgebiete, die Nordgallien jahrhundertelang geprägt hatten – die Véliocasses entlang der Seine, die Calètes an der Kreideküste, die Unelles im Cotentin, die Abrincates in der Nähe der Bucht – würden nun in römische Civitates umgezeichnet. Aber die tieferen Muster blieben bestehen: der Flusskorridor, die strategischen Höhen, die Handelsrouten an der Küste, die Stammesgrenzen, die Rom nur umbenennen würde. Die Eisenzeit ging zu Ende, aber die von ihr geprägte Geographie – und die Orte, die sie wählte – blieben in jeder folgenden Ära bestehen.',
      },
    },
    anchorYear: -52,
  },
  ...
  // ── Roman Gaul Arc beats ─────────────────────────────────────────
  {
    ...
    copy: {
      ...
      body: {
        ...
        de: 'Im Jahr 52 v. Chr. vollendete Julius Cäsar die Eroberung Galliens und stellte die keltischen Stämme des Seinebeckens unter römische Herrschaft. Die Veliocas in Rotomagus, die Caletes entlang der Kanalküste und ihre Nachbarn wurden in die gewaltige Maschinerie der Römischen Republik integriert. Die Stammes-Oppida wurden nicht zerstört, sondern wieder umgewandelt: Ihre Hochburgen auf den Höhen wurden zum Kern neuer römischer Städte. Die Seine, bereits ein alter Handelskorridor, diente nun einem Imperium.',
      },
    },
    anchorYear: -52,
  },
  {
    ...
    copy: {
      ...
      body: {
        ...
        de: 'Rom organisierte die keltischen Stammesgebiete in civitates um – Verwaltungsbezirke, die die Stammesgrenzen bewahrten und gleichzeitig römisches Recht, Steuern und Stadtplanung durchsetzten. Die Véliocasses wurden zur Civitas von Rotomagus, die Calètes konzentrierten sich auf Juliobona (Lillebonne), die Unelles auf Cosedia (Coutances) und die Abrincates auf Abrincae (Avranches). Jede Civitas-Hauptstadt erhielt römische Denkmäler – Foren, Bäder, Tempel –, die die antike keltische Landschaft überlagerten. Die Stammeskarte Galliens wurde mit römischer Tinte neu gezeichnet.',
      },
    },
    anchorYear: -10,
  },
  {
    ...
    copy: {
      ...
      body: {
        ...
        de: 'Im zweiten Jahrhundert hatte sich Rotomagus (Rouen) von einem keltischen Oppidum zu einer der wichtigsten Städte im römischen Gallien entwickelt. Als Hauptstadt des zweiten Lyonnaise verwaltete sie eine riesige Provinz, die sich von der Seine bis zur Halbinsel Cotentin erstreckte. Das römische Rotomagus verfügte über ein Forum, öffentliche Bäder, ein Amphitheater und einen Flusshafen, der es sowohl mit dem Landesinneren als auch mit dem Ärmelkanal verband. Die strategische Lage der Stadt – dort, wo das Gezeitenwasser auf den Fluss traf – machte sie zum natürlichen Tor zwischen Nordgallien und dem Meer, eine Rolle, die sie niemals aufgeben würde.',
      },
    },
    anchorYear: 100,
  },
  {
    ...
    copy: {
      ...
      body: {
        ...
        de: 'Unter Rom wurde die Seine zu einer verwalteten Handelsader. Getreidekähne transportierten Getreide von der Île-de-France zu den Häfen am Kanal; Wein, Öl und Töpferwaren kamen von den Handelsrouten im Mittelmeerraum zurück. Lutèce (Paris) und Rotomagus (Rouen) waren die beiden Hauptknotenpunkte dieser Wasserstraße, die durch einen Korridor aus Villen, Anwesen und Relais verbunden waren. Römische Ingenieure verbesserten die Schiffbarkeit des Flusses und kaiserliche Steuereintreiber sorgten dafür, dass jede Ladung ihren Beitrag leistete. Der Wohlstand dieses Korridors würde in jeder folgenden Ära nachhallen.',
      },
    },
    anchorYear: 150,
  },
  {
    ...
    copy: {
      ...
      body: {
        ...
        de: 'Jenseits des Seine-Korridors veränderte die römische Kultur die Provinzstädte. Juliobona (Lillebonne) erhielt ein großes Amphitheater, das Tausende von Zuschauern fassen konnte – seine Ruinen stehen noch heute. Cosedia (Coutances) und Abrincae (Avranches) erhielten eigene römische Denkmäler und Straßenverbindungen. Diese Städte waren keine bloßen Kopien Roms; Es handelte sich um hybride Orte, an denen keltische Traditionen unter einem römischen Deckmantel überlebten. Lokale Götter wurden mit römischen Gottheiten synchronisiert, keltische metallurgische Techniken mit römischen Stilen verschmolzen und Stammesaristokraten erfanden sich als in Toga gekleidete Richter neu.',
      },
    },
    anchorYear: 200,
  },
  {
    ...
    copy: {
      ...
      body: {
        ...
        de: 'Die zweite Provinz Lyonnaise umfasste den größten Teil der späteren Normandie. Von Rotomagus aus regiert, war es durch römische Straßen mit Lutetia, den Kanalhäfen und dem weiteren kaiserlichen Netzwerk verbunden. Die Identität der Provinz wurde durch die Seine bestimmt: flussaufwärts befand sich das politische Zentrum rund um Paris, flussabwärts das Meer und die Handelswege zur Insel Bretagne. Römische Infrastruktur – Straßen, Brücken, Aquädukte – bedeckte die keltische Landschaft, aber die zugrunde liegende Geographie blieb dieselbe: der Flusskorridor, die Küstenränder, das landwirtschaftlich genutzte Kernland. Jede zukünftige Macht würde dasselbe Terrain beherrschen.',
      },
    },
    anchorYear: 250,
  },
  {
    ...
    copy: {
      ...
      body: {
        ...
        de: 'Mitte des vierten Jahrhunderts war die Kanalküste bedroht. Sächsische und fränkische Piraten plünderten immer dreister die Küsten Galliens und der Bretagne. Rom reagierte mit dem Litus Saxonicum – der Sächsischen Küste – einer Kette von Küstenfestungen und Signalstationen, die den Kanalübergang und die Flussmündungen schützen sollten. Die Seine-Mündung erhielt Befestigungen; Wachtürme suchten den Horizont nach feindlichen Segeln ab. Es war ein Verteidigungssystem, das aus Schwäche und nicht aus Stärke entstand – ein Reich, das Plünderer nicht länger daran hindern konnte, seine Küsten zu erreichen, sondern sie nur noch verlangsamen konnte. Der Plan für das, was kommen würde, wurde gelegt.',
      },
    },
    anchorYear: 350,
  },
  {
    ...
    copy: {
      ...
      body: {
        ...
        de: 'Zu Beginn des fünften Jahrhunderts konnte Rom Nordgallien nicht mehr halten. Legionen wurden zur Verteidigung Italiens abberufen, Grenzgarnisonen wurden nicht mehr bezahlt und die Rheingrenze brach unter dem Druck der einwandernden germanischen Völker zusammen. Die Straßen führten noch immer, die Aquädukte führten noch immer Wasser und das Amphitheater von Juliobona stand noch – aber die Kraft, die es gebaut hatte, war verschwunden. Rotomagus und Lutetia befanden sich auf der Strecke, und ihre Bischöfe nahmen den Platz ein, an den sich die Gouverneure zurückgezogen hatten. Das römische Gallien ging zu Ende – aber die Infrastruktur, Städte und Flusskorridore, die es schuf, würden das tausendjährige Reich überdauern.',
      },
    },
    anchorYear: 400,
  },
  ...
  // ── Post-Roman Gaul Arc beats ────────────────────────────────────
  {
    ...
    copy: {
      ...
      body: {
        ...
        de: 'Zu Beginn des fünften Jahrhunderts konnte das Römische Reich Nordgallien nicht mehr verteidigen. Legionen wurden abgezogen, um in den Bürgerkriegen in Italien zu kämpfen, Grenzgarnisonen wurden nicht mehr bezahlt und germanische Kriegstrupps überquerten zunehmend ungestraft den Rhein. Rotomagus (Rouen) und Lutèce (Paris) – einst wohlhabende Provinzstädte – waren von der kaiserlichen Unterstützung abgeschnitten. Römische Straßen durchzogen noch immer die Landschaft, Aquädukte standen noch, aber die Macht, die sie gebaut hatte, war verschwunden. In Nordgallien herrschte ein Zwielicht zwischen zwei Reichen.',
      },
    },
    anchorYear: 410,
  },
  {
    ...
    copy: {
      ...
      body: {
        ...
        de: 'Obwohl sich das Reich zurückzog, verschwanden seine Städte nicht. Rotomagus (Rouen) und Lutetia (Paris) überlebten als Inseln der römischen Kultur in einem Meer des Wandels. An die Stelle der Gouverneure traten Bischöfe als primäre bürgerliche Autoritäten, die für die Aufrechterhaltung der Ordnung, die Erhebung von Steuern und die Verhandlungen mit germanischen Neuankömmlingen sorgten. Latein blieb die Sprache des Rechts und der Liturgie. Alte römische Straßenpläne, Mauern und Kirchen gaben diesen Städten eine Kontinuität, die die klassische und mittelalterliche Welt verband – ein Fundament, das die Franken eher erben als zerstören würden.',
      },
    },
    anchorYear: 420,
  },
  {
    ...
    copy: {
      ...
      body: {
        ...
        de: 'Die Franken waren kein einzelnes Volk, sondern ein Zusammenschluss germanischer Stämme vom Niederrhein. Einige hatten als römische Föderierte gedient – ​​alliierte Soldaten, die die Grenze im Tausch gegen Land verteidigten. Als die kaiserliche Kontrolle zusammenbrach, zogen die fränkischen Führer tiefer in den Norden Galliens vor und ließen sich in den reichen landwirtschaftlichen Gebieten zwischen Rhein, Somme und Seine nieder. Sie haben die gallo-römische Zivilisation nicht zerstört; Sie machten sich huckepack, übernahmen lokale Bräuche, verbündeten sich durch Heirat mit römischen Familien und beanspruchten den Mantel der Autorität, den die Legionen hinterlassen hatten.',
      },
    },
    anchorYear: 440,
  },
  {
    ...
    copy: {
      ...
      body: {
        ...
        de: 'Zwischen dem fränkischen Norden und dem westgotischen Süden blieb eine bemerkenswerte Enklave römischer Macht bestehen. Syagrius, Sohn eines römischen Generals, regierte von Soissons aus einen Reststaat – manchmal auch als letzte römische Festung in Gallien bezeichnet. Sein Herrschaftsbereich erstreckte sich ungefähr von der Somme bis zur Loire und umfasste Lutetia und Rotomagus. Jahrzehntelang hielt er die römische Verwaltung, Währung und das römische Recht in einer nachrömischen Welt aufrecht. Aber sein Königreich war eine Insel, und die fränkische Flut erhob sich um ihn herum.',
      },
    },
    anchorYear: 465,
  },
  {
    ...
    copy: {
      ...
      body: {
        ...
        de: 'Im Jahr 486 besiegte der junge Frankenkönig Chlodwig Syagrius in der Schlacht von Soissons und brach damit die letzte römische Autorität in Nordgallien. Es war ein entscheidender Moment: Das Seinebecken mit seinen Städten, seinen Straßen und seinem landwirtschaftlichen Reichtum ging von römischen Händen in fränkische Hände über. Clovis zerstörte nicht, was er eroberte – er absorbierte es. Römische Steuerunterlagen, kirchliche Netzwerke und städtische Infrastruktur blieben unter neuer Führung erhalten. Das fränkische Königreich, das Chlodwig baute, hatte eine römische Form, aber eine germanische Stärke.',
      },
    },
    anchorYear: 486,
  },
  {
    ...
    copy: {
      ...
      body: {
        ...
        de: 'Um 496 ließ sich Chlodwig als katholischer Christ taufen – eine politische Meisterleistung ebenso wie eine religiöse Bekehrung. Während andere germanische Könige in den Augen Roms arianische Ketzer waren, schloss sich Chlodwig den katholischen Bischöfen an, die noch immer die Städte Galliens regierten. Die Kirche bot ihr Legitimität, Schriftkultur und ein Verwaltungsnetz, das jede Stadt erreichte. Im Gegenzug schenkte Chlodwig der Kirche ein Schwert. Dieses Bündnis zwischen der fränkischen Krone und der katholischen Kirche sollte tausend Jahre lang die politische Landschaft Westeuropas prägen.',
      },
    },
    anchorYear: 496,
  },
  {
    ...
    copy: {
      ...
      body: {
        ...
        de: 'Clovis wählte Paris als seine Hauptstadt – eine römische Stadt, die als fränkischer Königssitz wiedergeboren wurde. Die antike Inselfestung Lutetia, wo einst römische Statthalter Hof gehalten hatten, war nun die Heimat eines germanischen Königs, der in seinem Kriegsrat in den Messen lateinisch und freimütig sprach. Die spätere Basilika Saint-Denis entstand am Rande der Stadt und begann ihre lange Geschichte als Grabkirche der Könige von Frankreich. Die zentrale Lage von Paris an der Seine machte es zum natürlichen Zentrum eines Königreichs, das sich vom Rhein bis zur Loire erstreckte.',
      },
    },
    anchorYear: 508,
  },
  {
    ...
    copy: {
      ...
      body: {
        ...
        de: 'Als Chlodwig im Jahr 511 starb, wurde sein Königreich unter seinen vier Söhnen aufgeteilt – nicht aus Schwäche, sondern gemäß der fränkischen Erbtradition, die das Königreich als Familienbesitz behandelte. Der westliche Teil, der sich auf das Seine-Becken mit Paris und Rouen als Ankerpunkten konzentriert, würde zu Neustrien werden. Die nachrömische Welt war vorbei: Nordgallien war nun zweifellos fränkisch, katholisch und mittelalterlich. Römische Straßen verliefen noch immer, Bischöfe regierten noch immer ihre Städte, aber eine neue politische Ordnung hatte sich etabliert – eine, die den Seine-Korridor für die kommenden Jahrhunderte prägen sollte.',
      },
    },
    anchorYear: 511,
  },
  ...
  // ── Neustria Arc beats ───────────────────────────────────────────
  {
    ...
    copy: {
      ...
      body: {
        ...
        de: 'Als Chlodwig – der erste christliche König der Franken – im Jahr 511 starb, wurde sein Königreich nach fränkischem Brauch unter seinen Söhnen aufgeteilt. Der westliche Teil, der sich von der Loire bis zur Manche erstreckte und sich auf das Seinebecken konzentrierte, wurde zu Neustrien – dem „neuen westlichen Land“. Paris und Rouen verankerten dieses Unterkönigreich, dessen Identität mehr als zwei Jahrhunderte lang die politische Geographie Nordgalliens prägen sollte.',
      },
    },
    anchorYear: 511,
  },
  {
    ...
    copy: {
      ...
      body: {
        ...
        de: 'Die Seine verband die beiden großen Städte Neustriens. Paris diente auf seiner befestigten Insel als königlicher Sitz und Knotenpunkt; Rouen, flussabwärts, kontrollierter Zugang zum Ärmelkanal und zum Meer. Zwischen den beiden verlief ein Flusskorridor, der Zölle, Getreide und königliche Orden transportierte. Diese Achse Paris–Rouen war das Rückgrat der Macht Neustriens – wer auch immer die beiden Städte besaß, dominierte das Unterkönigreich. Derselbe Korridor sollte später zur Hauptstraße der Wikinger-Invasion werden.',
      },
    },
    anchorYear: 540,
  },
  {
    ...
    copy: {
      ...
      body: {
        ...
        de: 'Über Generationen hinweg wetteiferten Neustrien und sein östlicher Rivale Austrasien um die Vorherrschaft über die fränkische Welt. Bürgerkriege, Attentate und wechselnde Bündnisse bestimmten die merowingische Politik. Neustriens Stärke lag im reichen landwirtschaftlichen Becken der Seine und seinem Zugang zum Ärmelkanalhandel, während Austrasien seine Macht aus dem Rheinland bezog. Diese Bruderkonflikte erschöpften die beiden Königreiche, hielten aber ihre kampferprobten Aristokratien – und ihre Grenzen in ständiger Bewegung.',
      },
    },
    anchorYear: 575,
  },
  {
    ...
    copy: {
      ...
      body: {
        ...
        de: 'Bis zum siebten Jahrhundert hatte sich die tatsächliche Macht in Neustrien von den merowingischen Königen auf ihre Palastbürgermeister verlagert – oberste Minister, die die Armeen befehligten und die Schirmherrschaft kontrollierten. Könige wurden zu zeremoniellen Figuren, die später als „faule Könige“ verspottet wurden. Diese Aushöhlung der königlichen Autorität bedeutete, dass das Schicksal Neustriens nicht von gekrönten Häuptern, sondern von rivalisierenden aristokratischen Fraktionen rund um Paris und die Île-de-France entschieden wurde.',
      },
    },
    anchorYear: 640,
  },
  {
    ...
    copy: {
      ...
      body: {
        ...
        de: 'Die um 654 gegründete Abtei von Jumièges lag an einer bewaldeten Seineschleife zwischen Rouen und dem Meer. Es war Teil einer Welle merowingischer Klostergründungen, die die untere Seine in einen Korridor des Gebets, des Wissens und – was entscheidend war – des Reichtums verwandelte. Klöster erhielten königliche Zuwendungen, erhoben Flusszölle und zogen Pilger an. Am Ende der neustrischen Zeit befanden sich im Seine-Tal einige der reichsten Ordenshäuser in ganz Gallien – eine Ansammlung von Schätzen, die sich für zukünftige Plünderer als unwiderstehlich erweisen würde.',
      },
    },
    anchorYear: 654,
  },
  {
    ...
    copy: {
      ...
      body: {
        ...
        de: 'Am Westrand Neustriens bewachte Nantes die Loiremündung und die spannungsgeladene Grenze zur bretonischen Halbinsel. Die Bretonen – keltophone Völker, die aus Großbritannien eingewandert waren – widersetzten sich der fränkischen Autorität und starteten Raubzüge nach Osten, wann immer die neustrische Macht schwankte. Nantes wechselte mehrmals den Besitzer und diente sowohl als fränkische Garnisonsstadt als auch als Ziel bretonischer Ambitionen. Diese westliche Instabilität führte dazu, dass Neustrien immer noch an zwei Fronten kämpfte: gegen Austrasien im Osten und gegen die Bretagne im Westen.',
      },
    },
    anchorYear: 600,
  },
  {
    ...
    copy: {
      ...
      body: {
        ...
        de: 'Im Jahr 687 schlug der Bürgermeister des austrasischen Palastes, Pippin von Herstal, die neustrische Armee in der Schlacht von Tertry bei Saint-Quentin. Dies war ein Wendepunkt: Neustrien verlor seine Unabhängigkeit und geriet unter österreichische Herrschaft. Pippin und seine Nachkommen – die Pippiniden, später Karolinger genannt – regierten nun praktisch das gesamte fränkische Königreich. Die merowingischen Könige blieben als Aushängeschilder auf dem Thron, doch die eigentliche Macht hatte sich nach Osten verlagert. Die Tage Neustriens als rivalisierendes Königreich waren gezählt.',
      },
    },
    anchorYear: 687,
  },
  {
    ...
    copy: {
      ...
      body: {
        ...
        de: 'Im Jahr 751 setzte Pippin der Kleine – Enkel des Siegers von Tertrien – den letzten merowingischen König ab und gründete die karolingische Dynastie. Die zweihundertjährige Geschichte Neustriens als unabhängiges fränkisches Unterkönigreich ging zu Ende, aber sein Erbe blieb bestehen: Der Seine-Korridor, den es zur politischen und klösterlichen Macht ausgebaut hatte, sollte zur ertragreichsten Verkehrsader des neuen karolingischen Reiches werden. Die Abteien, der Flusshandel, die Achse Paris–Rouen – alles, was Neustrien geschaffen hatte, würde Karl der Große erben, und alles, was Karl der Große unverteidigt ließ, würde von den Wikingern beschlagnahmt werden.',
      },
    },
    anchorYear: 751,
  },
  ...
  // ── Frankish & Carolingian Frontier Arc beats ────────────────────
  {
    ...
    copy: {
      ...
      body: {
        ...
        de: 'Im Jahr 751 setzte Pippin der Kleine den letzten merowingischen König ab und gründete mit päpstlichem Segen die karolingische Dynastie. Neustrien, lange Zeit ein rivalisierendes fränkisches Unterkönigreich mit Schwerpunkt im Seine-Tal, wurde in eine einzige königliche Domäne integriert. Paris und Rouen – einst Sitze rivalisierender merowingischer Gerichte – wurden zu Städten, die in einem vereinten Königreich verwaltet wurden. Diese Machtkonzentration würde die untere Seine von einem politischen Markt in das wirtschaftliche Herz Westeuropas verwandeln.',
      },
    },
    anchorYear: 751,
  },
  {
    ...
    copy: {
      ...
      body: {
        ...
        de: 'Karl der Große wurde 800 in Rom zum Kaiser gekrönt und errichtete den größten Staat Westeuropas seit der Antike. Er organisierte die Kirche neu, vereinheitlichte die Währung und stärkte die Handelsnetzwerke. Der Seine-Korridor wurde zu einer wichtigen Achse, die das Herzstück der Île-de-France mit den Häfen am Ärmelkanal verband. Abteien wie Jumièges erhielten königliche Urkunden und wurden sagenhaft reich, während Quentovics Handelszentrum den Handel über den Ärmelkanal mit dem angelsächsischen England abwickelte. Der Erfolg des Reiches führte jedoch zu einem Muster unverteidigten Reichtums entlang der schiffbaren Flüsse.',
      },
    },
    anchorYear: 800,
  },
  {
    ...
    copy: {
      ...
      body: {
        ...
        de: 'An der unteren Seine lagen einige der reichsten Klöster der Christenheit. Jumièges, Saint-Wandrille und Fontenelle kontrollierten riesige Herrschaftsgebiete, erhoben Zölle und produzierten illuminierte Manuskripte. Rouen diente als wichtigster städtischer Knotenpunkt, der diesen klösterlichen Reichtum flussaufwärts mit Paris und flussabwärts mit dem Ärmelkanal verband. Der königliche Schutz schützte die Abteien – aber dieser Schutz hing von einer starken, ungeteilten Krone ab. Der Fluss, der ihren Reichtum trug, würde bald ihre Zerstörer tragen.',
      },
    },
    anchorYear: 810,
  },
  {
    ...
    copy: {
      ...
      body: {
        ...
        de: 'Quentovic, in der Nähe des heutigen Étaples an der Kanalküste, war das erste Handelszentrum des Karolingischen Reiches. Hier trafen sich friesische Kaufleute, angelsächsische Händler und fränkische Beamte und tauschten Waren, Geld und Ideen über die Meerenge aus. Karl der Große regelte die Hafenzölle und seine Münzstätte prägte Münzen, die von Northumbria bis ins Rheinland zirkulierten. Der Wohlstand des Handelszentrums hing von friedlichen Meeren ab – ein Zustand, der bald verschwinden würde.',
      },
    },
    anchorYear: 815,
  },
  {
    ...
    copy: {
      ...
      body: {
        ...
        de: 'Ludwig der Fromme erbte 814 das Reich Karls des Großen und hielt es eine Generation lang zusammen – allerdings unter enormen Kosten. Seine Söhne revoltierten wiederholt und die daraus resultierenden Bürgerkriege belasteten die Grenzverteidigung mit militärischen Mitteln. Die Küstengarnisonen schrumpften, die Flusspatrouillen wurden eingestellt und die örtlichen Grafen standen ohne Verstärkung da. Die Struktur, die das Reich stark gemacht hatte – die zentralisierte Führung –, wurde zu seiner Schwäche: Als das Zentrum ins Wanken geriet, wurde die Peripherie bloßgelegt.',
      },
    },
    anchorYear: 830,
  },
  {
    ...
    copy: {
      ...
      body: {
        ...
        de: 'Ludwig der Fromme starb im Jahr 840 und das Reich stürzte sofort in einen Bürgerkrieg. Der Vertrag von Verdun im Jahr 843 teilte das karolingische Königreich in drei Königreiche. Westfranken – ungefähr das moderne Frankreich – fiel an Karl den Kahlen, aber seine Autorität war brüchig. Die Militärmaschinerie, die Karl der Große zur Verteidigung der Küsten und Flüsse aufgebaut hatte, reagierte nicht mehr auf einen einzigen Befehl. Die Grenzen des Ärmelkanals und der Seine, einst innere Korridore eines riesigen Reiches, waren nun freiliegende Ränder eines geschwächten Staates.',
      },
    },
    anchorYear: 840,
  },
  {
    ...
    copy: {
      ...
      body: {
        ...
        de: 'Im Jahr 841, im Jahr nach Ludwigs Tod, fuhren skandinavische Langschiffe zum ersten Mal in die Seine-Mündung ein. Die Plünderer griffen Rouen fast widerstandslos an und plünderten die große Abtei von Jumièges. Dies waren keine zufälligen Angriffe: Skandinavische Kaufleute wussten schon lange um den Reichtum, der entlang der Seine floss, und die karolingischen Bürgerkriege signalisierten, dass die Verteidigungsanlagen des Flusses zusammengebrochen waren. Bei den ersten Razzien handelte es sich um Aufklärungsangriffe, bei denen eine Grenze getestet wurde, die nicht länger halten konnte.',
      },
    },
    anchorYear: 841,
  },
  {
    ...
    copy: {
      ...
      body: {
        ...
        de: 'Im Jahr 841 wurde die Bühne bereitet. Das karolingische Reich, das die Korridore von Seine und Loire bereichert hatte, hatte diese durch seinen Zusammenbruch auch wehrlos gemacht. Skandinavische Flotten überwachten nun jede größere Flussmündung, von Nantes bis Quentovic. Was als saisonale Überfälle begann, eskalierte zu umfassenden Invasionen, Winterlagern und schließlich zu einer dauerhaften Kolonisierung. Die fränkische und karolingische Ära endete nicht in friedlicher Abfolge, sondern mit Rauch, der über den Abteien der unteren Seine aufstieg – der Eröffnungsakt der Wikingerzeit.',
      },
    },
    anchorYear: 841,
  },
  ...
  // ── Viking Age Arc beats ─────────────────────────────────────────
  {
    ...
    copy: {
      ...
      body: {
        ...
        de: 'Im Jahr 841 drangen skandinavische Langschiffe zum ersten Mal in die Seine-Mündung ein und überraschten die fränkische Verteidigung. Die Plünderer griffen Rouen an und plünderten die große Abtei von Jumièges. Dies waren keine zufälligen Streifzüge: Die Seine war eine Autobahn zu einer der reichsten Regionen des Karolingischen Reiches, gesäumt von wohlhabenden Klöstern und wehrlosen Flussstädten. Die ersten Razzien kündigten ein Muster an, das sich über Jahrzehnte wiederholen sollte.',
      },
    },
    anchorYear: 841,
  },
  {
    ...
    copy: {
      ...
      body: {
        ...
        de: 'In den 840er bis 880er Jahren nutzten Wikingerflotten die Seine immer wieder als Invasionskorridor. Sie überwinterten auf Flussinseln, erpressten Danegeld aus fränkischen Städten und drangen jedes Jahr tiefer vor. Klöster wie Jumièges, Saint-Wandrille und Fontenelle wurden geplündert und aufgegeben. Der Fluss, der einst das größte Kapital des karolingischen Kernlandes gewesen war – er verband Paris mit dem Meer – wurde zu seiner verhängnisvollen Verwundbarkeit.',
      },
    },
    anchorYear: 856,
  },
  {
    ...
    copy: {
      ...
      body: {
        ...
        de: 'Die Seine war nicht das einzige Ziel. Die Wikinger plünderten 843 Nantes, nutzten die Loire als Route nach Mittelfranken und schickten Flotten den Rhein und die Maas hinauf, um Dorestad, Utrecht und Köln zu verwüsten. Jeder große schiffbare Fluss im karolingischen Franken wurde durchdrungen. Das Reich wurde vom Atlantik bis zu den Niederlanden angegriffen, und die dezentrale militärische Reaktion der Franken – Grafen und Bischöfe organisierten improvisierte Verteidigungsanlagen – konnten nicht mit der Geschwindigkeit und Koordination der skandinavischen Flotten mithalten.',
      },
    },
    anchorYear: 862,
  },
  {
    ...
    copy: {
      ...
      body: {
        ...
        de: 'Im Jahr 885 segelte eine riesige skandinavische Flotte – vielleicht 300 Schiffe und 30.000 Mann – die Seine hinauf und belagerte Paris. Mehr als ein Jahr lang widerstand die Garnison der Île de la Cité unter der Führung von Graf Eudes und Bischof Gozlin wiederholten Angriffen. Der fränkische Kaiser Karl der Dicke traf schließlich mit einer Armee ein – aber anstatt zu kämpfen, bezahlte er die Wikinger für den Rückzug und die Plünderung Burgunds. Die Demütigung zerstörte den Rest der militärischen Glaubwürdigkeit der Karolinger im Westen.',
      },
    },
    anchorYear: 885,
  },
  {
    ...
    copy: {
      ...
      body: {
        ...
        de: 'Die Große Heidenarmee marschierte 865 in England ein, und innerhalb eines Jahrzehnts geriet ein Großteil Ost- und Nordenglands unter skandinavische Kontrolle – die Danelaw. York wurde unter dem Namen Jórvík, einer wohlhabenden Wikingerstadt, zu ihrer Hauptstadt. Das Danelaw existierte über ein Jahrhundert lang und schuf ein Reservoir anglo-skandinavischer Siedler, Krieger und Kaufleute. Einige dieser Danelaw-Familien überquerten später nach 911 den Kanal in die Normandie und fügten der normannischen Bevölkerung eine weitere Schicht hinzu.',
      },
    },
    anchorYear: 878,
  },
  {
    ...
    copy: {
      ...
      body: {
        ...
        de: 'Die norwegischen Wikinger errichteten Ende des 8. Jahrhunderts ein Seenetz quer durch Schottland, die Hebriden, die Isle of Man und Irland. Dublin, um 841 als Longphort gegründet, wurde zu einem Zentrum des Sklavenhandels und zum politischen Anker einer nordisch-gälischen Welt, in der skandinavische und keltische Kulturen verschmolzen. Die unter norwegischer Souveränität stehende Grafschaft Orkney kontrollierte die nördlichen Zufahrtswege. Diese westliche skandinavische Sphäre würde Siedler über die Keltische Seeroute in die Normandie bringen – einen ausgeprägten Migrationsstrom, der parallel zum dänischen Seine-Korridor verläuft.',
      },
    },
    anchorYear: 870,
  },
  {
    ...
    copy: {
      ...
      body: {
        ...
        de: 'Während die Dänen und Norweger nach Westen vordrangen, erschlossen die schwedischen Waräger die Flusssysteme Osteuropas. Von Birka und Haithabu aus überquerten Kaufleute die Ostsee nach Staraja Ladoga und Nowgorod und folgten dann dem Dnjepr nach Süden nach Kiew und Konstantinopel oder der Wolga nach Osten zu den islamischen Silbermärkten von Bulgar. Diese Routen schufen die Kiewer Rus, versorgten die byzantinische Warägergarde mit Energie und brachten Tausende arabischer Dirham nach Skandinavien. Die Wikingerwelt war nicht nur ein atlantisches Phänomen – sie erstreckte sich von Vinland bis Bagdad.',
      },
    },
    anchorYear: 880,
  },
  {
    ...
    copy: {
      ...
      body: {
        ...
        de: 'Zu Beginn des 10. Jahrhunderts hatten jahrzehntelange Raubzüge die untere Seine von einem freien Kernland in eine umkämpfte Grenze verwandelt. Skandinavische Kriegsbanden hatten sich halbständig entlang des Flusses niedergelassen. Die karolingischen Könige, geschwächt durch Bürgerkriege und nicht in der Lage, die Raubzüge zu stoppen, entschieden sich für Verhandlungen. Im Jahr 911 überließ Karl der Einfältige das Gebiet der unteren Seine dem Wikingerführer Rollo als Gegenleistung für einen Verteidigungspuffer gegen künftige skandinavische Einfälle. Der Vertrag von Saint-Clair-sur-Epte markierte das Ende der Wikingerzeit an der Seine – und den Beginn der Normandie.',
      },
    },
    anchorYear: 911,
  },
  ...
  // ── Norman Origins Arc beats ──────────────────────────────────────
  {
    ...
    copy: {
      ...
      body: {
        ...
        de: 'Im Jahr 911 überließ der fränkische König Karl der Einfältige das Gebiet der unteren Seine dem Wikingerführer Rollo im Gegenzug für das Versprechen, den Fluss gegen weitere skandinavische Überfälle zu verteidigen. Der Vertrag von Saint-Clair-sur-Epte war kein großzügiges Geschenk, sondern die Anerkennung einer vollendeten Tatsache: Die fränkische Macht hatte bereits die Kontrolle über die Region verloren. Rollo und seine Anhänger erhielten Rouen und die Gebiete rund um die Seine-Mündung – den Kern dessen, was später zur Normandie werden sollte.',
      },
    },
    anchorYear: 911,
  },
  {
    ...
    copy: {
      ...
      body: {
        ...
        de: 'Die Siedler, die die frühe Normandie besiedelten, bildeten keine einzige Gruppe. Der politische Kern um Rouen stützte sich stark auf dänische Netzwerke – dieselben Nordseerouten, die die Grande Armée und die Danelaw versorgt hatten. Auch anglo-skandinavische Familien aus dem Danelaw reisten nach 911 als Bauern und Kaufleute in die Normandie und stärkten so die skandinavische Bevölkerung von Bessin und dem inneren Tiefland. Die Kolonie war skandinavisch, aber schon von Anfang an vielfältig.',
      },
    },
    anchorYear: 920,
  },
  {
    ...
    copy: {
      ...
      body: {
        ...
        de: 'Ein zweiter, weniger bekannter Migrationskorridor versorgte den Westen der Normandie. Norwegische Wikinger ließen sich auf den Hebriden, der Isle of Man und Irland nieder und segelten durch das Keltische Meer und um Cornwall herum nach Süden, um in den Ärmelkanal einzudringen und die Halbinsel Cotentin und die Kanalinseln zu erreichen. Archäologische Funde, Cotentin-Toponyme mit skandinavischen Wurzeln und besondere Bestattungspraktiken verbinden die westliche Normandie mit diesem Netzwerk der Irischen See – und erinnern uns daran, dass das Herzogtum aus mehreren Wikingerströmen und nicht nur aus dem dänischen Seine-Korridor entstanden ist.',
      },
    },
    anchorYear: 930,
  },
  {
    ...
    copy: {
      ...
      body: {
        ...
        de: 'Rollons ursprüngliche Konzession erstreckte sich nur auf die untere Seine um Rouen. Seine Nachfolger expandierten stetig nach Westen: Bessin wurde 924 annektiert, dann Cotentin und Avranchin im Jahr 933. Mitte des 10. Jahrhunderts erstreckte sich das Herzogtum vom Fluss Epte bis zur Atlantikküste von Cotentin – ungefähr die Form der historischen Normandie, die jahrhundertelang bestehen sollte. Jede Annexion brachte neue Bevölkerungsgruppen unter normannische Herrschaft und erweiterte die herzogliche Grenze.',
      },
    },
    anchorYear: 933,
  },
  {
    ...
    copy: {
      ...
      body: {
        ...
        de: 'Als William Longue-Épée im Jahr 933 Cotentin und Avranchin annektierte, gelangten die benachbarten Kanalinseln in die gleiche herzogliche Umlaufbahn. Jersey, Guernsey und ihre kleineren Nachbarn waren Stützpunkte auf der norwegischen Keltischen Seeroute, die die westliche Normandie versorgte – derselbe Korridor, der von Archäologen beschrieben wurde, die skandinavische Toponyme und Bestattungsbräuche im gesamten Cotentin aufspürten. Unter herzoglicher Autorität wurden die Inseln zu einer Inselerweiterung der Normandie: Sie unterliegen demselben Gesetz, sind derselben Kirche zugeordnet und in die maritime Wirtschaft integriert, die die Küste des Cotentin mit der normannischen Welt verbindet. Sie waren nie peripher – sie bildeten die westliche Seegrenze des Herzogtums.',
      },
    },
    anchorYear: 933,
  },
  {
    ...
    copy: {
      ...
      body: {
        ...
        de: 'Innerhalb von zwei oder drei Generationen hatten die skandinavischen Siedler die französische Sprache, fränkische Rechtsbräuche und das Christentum übernommen. Rollo selbst wurde im Rahmen des Vertrags von 911 getauft. Die während der Wikingerzeit geplünderten Klöster – Jumièges, Mont-Saint-Michel, Saint-Wandrille – wurden von den neuen normannischen Herzögen restauriert und reich ausgestattet. Das Kriegerethos, das maritime Wissen und die Vorliebe für ehrgeizige militärische Unternehmungen blieben jedoch erhalten. Das Ergebnis war eine hybride Kultur: französischsprachig, zutiefst christlich, aber mit einem skandinavischen Touch, der die Normannen von ihren Nachbarn unterschied.',
      },
    },
    anchorYear: 960,
  },
  {
    ...
    copy: {
      ...
      body: {
        ...
        de: 'Mit der Konsolidierung des normannischen Herzogtums erreichte die Wikingerwelt ihren Höhepunkt. Die skandinavischen Handelsrouten erstreckten sich von Vinland im Westen bis nach Konstantinopel und Bagdad im Osten. Das Danelaw in England, die norso-gälischen Königreiche Irland und Schottland, die Kiewer Rus sowie die isländischen und grönländischen Kolonien bildeten ein miteinander verbundenes Netzwerk. Die Normandie war ein Knotenpunkt in diesem riesigen System – ihre Siedler stammten aus diesen Netzwerken, und ihr früher herzoglicher Hof unterhielt noch lange nach der Übernahme der französischen Kultur Verbindungen in ganz Skandinavien.',
      },
    },
    anchorYear: 1000,
  },
  {
    ...
    copy: {
      ...
      body: {
        ...
        de: 'Mitte des 11. Jahrhunderts war die Normandie das am besten regierte Fürstentum Frankreichs. Herzog Wilhelm (später „der Eroberer“) erbte ein Territorium mit einer reformierten Kirche, einem Netzwerk von Burgen, die herzogliche Autorität durchsetzten, und einer feudalen Aristokratie, die an persönliche Loyalität gebunden war. Verwaltungsinnovationen – umherziehende Richter, detaillierte Grundbücher, eine zentralisierte Währungswerkstatt in Rouen – verschafften dem Herzog eine Kontrolle, die mit der des Königs von Frankreich konkurrierte. Caen wurde zur zweiten herzoglichen Hauptstadt und seine beiden Abteien (Abbaye aux Hommes und Abbaye aux Dames) waren ein Zeichen normannischer Frömmigkeit und Ehrgeiz. Das Herzogtum war bereit, seine Macht nach außen zu projizieren.',
      },
    },
    anchorYear: 1050,
  },
  {
    ...
    copy: {
      ...
      body: {
        ...
        de: 'Als Eduard der Bekenner im Januar 1066 starb, bestieg Herzog Wilhelm den englischen Thron. In weniger als 150 Jahren hatte sich aus einer Kriegskonzession der Wikinger an der unteren Seine eine der beeindruckendsten politischen Einheiten Europas entwickelt – französischsprachig, christlich, administrativ fortschrittlich und angeführt von einem Herzog, dessen Ehrgeiz seinen Ressourcen entsprach. Die in Saint-Valéry-sur-Somme versammelte Invasionsflotte würde nicht nur Soldaten, sondern ein ganzes Regierungssystem über den Kanal transportieren. Alles, was folgte – die Eroberung Englands, die normannischen Königreiche Siziliens, die Kreuzfahrerfürstentümer – entstand aus dem Schmelztiegel dieses kleinen Herzogtums an der Seine.',
      },
    },
    anchorYear: 1066,
  },
  {
    ...
    copy: {
      ...
      body: {
        ...
        de: 'Bis 1066 waren die Kanalinseln über ein Jahrhundert lang Teil des Herzogtums. Sie teilten ihre reformierte Kirche, ihre feudalen Besitztümer und ihre französisch-normannische Sprache. Als Herzog Wilhelm den Kanal überquerte, um die englische Krone an sich zu reißen, gingen die Inseln eine Personalunion ein: Ihr Herr war nun sowohl Herzog der Normandie als auch König von England. Hierbei handelte es sich nicht um eine englische Übernahme fremden Territoriums – es handelte sich um eine normannische Einheit, deren Souverän England zu seinen Herrschaftsgebieten hinzufügte. Das Schicksal der Inseln würde von dieser Unterscheidung abhängen, wenn die Union zerfiel.',
      },
    },
    anchorYear: 1066,
  },
  ...
  // ── Norman Expansion Arc beats ────────────────────────────────────
  {
    ...
    copy: {
      ...
      body: {
        ...
        de: 'Mitte des 11. Jahrhunderts war das Herzogtum Normandie die militärisch bedeutendste politische Einheit in Nordfrankreich. Eine Kriegeraristokratie, ein Schlossbau im industriellen Maßstab und eine reformierte Kirche verschafften Herzog Wilhelm eine beispiellose Machtbasis. Diese konzentrierte Energie würde bald ausbrechen – über den Ärmelkanal, ins Mittelmeer und bis zu den Toren Jerusalems.',
      },
    },
    anchorYear: 1066,
  },
  {
    ...
    copy: {
      ...
      body: {
        ...
        de: 'Wilhelms Sieg bei Hastings im Jahr 1066 schuf ein anglonormannisches Königreich, das sich über beide Seiten des Ärmelkanals erstreckte. England veränderte sich: eine neue Aristokratie, von Burgnetzwerken vom Tower of London über walisische Märsche, das Domesday Book bis hin zur Einführung der französisch-normannischen Sprache in Recht und Kultur. Die Eroberung machte die Normandie zum Zentrum eines kanalübergreifenden Reiches – verband aber auch das Schicksal des Herzogtums mit der englischen Krone.',
      },
    },
    anchorYear: 1066,
  },
  {
    ...
    copy: {
      ...
      body: {
        ...
        de: 'Normannische Abenteurer – Kadetten ohne Aussichten in ihrer Heimat – kamen zu Beginn des 11. Jahrhunderts als Söldner nach Süditalien. Innerhalb weniger Jahrzehnte hatte die Familie Hauteville Apulien, Kalabrien und dann Sizilien von den Arabern erobert. Roger II. vereinte diese Eroberungen im Jahr 1130 im Königreich Sizilien und verschmolz normannische, byzantinische, arabische und lateinische Traditionen zu einem der raffiniertesten Staaten des mittelalterlichen Europas.',
      },
    },
    anchorYear: 1130,
  },
  {
    ...
    copy: {
      ...
      body: {
        ...
        de: 'Normannische Herren gehörten zu den prominentesten Anführern des Ersten Kreuzzugs (1096–1099). Bohemund von Tarent eroberte das Fürstentum Antiochia; sein Neffe Tancred hielt Galiläa. Normannische Militärtechniken – schwere Kavallerieangriffe, Burgbau, feudale Organisation – wurden zum Vorbild für die Kreuzfahrerstaaten in der Levante. Ein Jahrhundert später eroberte Richard Löwenherz (normannischer Abstammung) Zypern auf dem Weg zum Dritten Kreuzzug.',
      },
    },
    anchorYear: 1098,
  },
  {
    ...
    copy: {
      ...
      body: {
        ...
        de: 'Die anglonormannische Expansion machte nicht vor den alten Grenzen Englands Halt. Die Herren der Marken drangen bereits in den 1070er Jahren nach Wales ein und bauten Burgen in Chepstow, Pembroke und Caernarfon. Im Jahr 1169 überquerte Strongbow die Irische See und eroberte Leinster, wodurch Irland für Jahrhunderte anglonormannischer Herrschaft geöffnet wurde. Diese Feldzüge weiteten normannische Feudalstrukturen – Burgen, Herrenhäuser und Stadtrechte – bis ins Herz der keltischen Welt aus.',
      },
    },
    anchorYear: 1169,
  },
  {
    ...
    copy: {
      ...
      body: {
        ...
        de: 'Robert Guiscards (1081–1085) Invasion auf dem Balkan stellte eine direkte Herausforderung für das Byzantinische Reich dar – die normannische Kavallerie erreichte die westlichen Zugänge zu Konstantinopel. Gleichzeitig weitete Roger II. die sizilianische Macht im zentralen Mittelmeerraum aus und errichtete kurzzeitig ein „Königreich Afrika“ an der tunesischen Küste (1135–1160). Die normannischen Ambitionen erstreckten sich von der Irischen See bis zum Bosporus.',
      },
    },
    anchorYear: 1135,
  },
  {
    ...
    copy: {
      ...
      body: {
        ...
        de: 'Im 13. Jahrhundert verschmolz die normannische Welt mit breiteren Identitäten – Englisch, Französisch, Sizilianisch. Das Festland der Normandie wurde 1204 von Philipp Augustus erobert und trennte damit das Herzogtum von der englischen Krone. Dennoch blieben normannische Hinterlassenschaften bestehen: das Gewohnheitsrecht in England, die Architektur der Kathedralen von Durham bis Monreale, das feudale Landbesitzsystem Irlands in der Levante und eine Diaspora von Nachnamen, Urkunden und Burgruinen auf drei Kontinenten.',
      },
    },
    anchorYear: 1204,
  },
  {
    ...
    copy: {
      ...
      body: {
        ...
        de: 'Als Philipp Augustus 1204 das Festland der Normandie eroberte, wurde das kanalübergreifende Herzogtum in zwei Teile geteilt. Das Festland der Normandie wurde Teil des Königreichs Frankreich. Aber die Kanalinseln entschieden sich für die englische Krone oder wurden von ihr behalten. Die Inselbewohner schworen König John nicht als englische Untertanen, sondern als Volk des Herzogs die Treue: Sie behielten ihr normannisches Gewohnheitsrecht, ihre feudalen Besitztümer und ihre eigenen Gerichte. Diese Anomalie wurde dauerhaft. Die Inseln wurden nie von England übernommen, nie vom Parlament regiert und verloren nie ihre normannische Rechtsidentität. Die Teilung von 1204 führte zur Entstehung der heutigen Crown Dependencies – selbstverwaltete Gebiete, die mit der Krone verbunden, aber verfassungsrechtlich vom Vereinigten Königreich verschieden sind.',
      },
    },
    anchorYear: 1205,
  },
  {
    ...
    copy: {
      ...
      body: {
        ...
        de: 'Nach 1204 wurden die Kanalinseln zu einer umstrittenen Grenze zwischen den Kronen Frankreichs und Englands. Das Schloss Mont Orgueil an der Ostküste von Jersey – das den maritimen Zugang von der Normandie aus dominiert – wurde in einem Ausmaß befestigt, das den strategischen Wert der Inseln widerspiegelte. Im 13. und 14. Jahrhundert kam es wiederholt zu französischen Überfällen; Castle Cornet in Guernsey schützte Saint Peter Port. Zwischen den Belagerungen unterhielten die Inseln eine zweisprachige Seewirtschaft, die mit der französischen und englischen Küste Handel trieb. Ihre Gerichte verwalteten normannisches Gewohnheitsrecht, lange nachdem der Kontinent das römisch-kanonische Verfahren übernommen hatte. Jèrriais und Guernsey – Inselnachkommen des Frankormannischen – überlebten als lebende gesprochene Sprachen bis in die Neuzeit. Dabei handelte es sich nicht um eingefrorene Relikte aus dem Jahr 1066, sondern um gewachsene Gemeinschaften, die eine ausgeprägte normannische rechtliche und sprachliche Identität bewahrten, gerade weil ihre Trennung vom Kontinent nach 1204 sie vor der Pariser Zentralisierung schützte.',
      },
    },
    anchorYear: 1300,
  },
  ...
  // ── Normandy to the New World — transatlantic arc ────────────────
  {
    ...
    copy: {
      ...
      body: {
        ...
        de: 'Bis zum Ende des 15. Jahrhunderts waren die Häfen am Kanal der Normandie – Dieppe, Honfleur, Le Havre – jahrhundertelang Handelszentren gewesen. Dieselbe maritime Infrastruktur, die dem Handel über den Ärmelkanal diente, wandte sich nun dem offenen Atlantik zu. Normannische Fischer machten sich bereits auf den Weg zu den Grand Banks, bevor es zu einer offiziellen Erkundung durch Frankreich kam, und die Kaufmannsfamilien von Rouen begannen, die Reisen zu finanzieren, die einen neuen Kontinent erschließen würden.',
      },
    },
    anchorYear: 1500,
  },
  {
    ...
    copy: {
      ...
      body: {
        ...
        de: 'Verrazzano verließ Dieppe 1524, um die nordamerikanische Küste zu kartieren. Cartier folgte 1534 aus Saint-Malo und öffnete das Tor zum Saint-Laurent. Diese Reisen starteten in denselben normannischen und bretonischen Häfen, die jahrhundertelang den Kanalhandel ankerten – der Beginn einer transatlantischen Geschichte, die beide Kontinente neu gestalten sollte.',
      },
    },
    anchorYear: 1534,
  },
  {
    ...
    copy: {
      ...
      body: {
        ...
        de: 'Champlain gründete Quebec im Jahr 1608 und die Siedler kamen in Strömen an – viele aus der Normandie und Perche. Guillaume Couture, Zacharie Cloutier, Jean Gagnon, die Langlois und die Boucher: normannische Nachnamen, die die Gründungslinien des französischen Kanadas werden sollten. Die Côte de Beaupré und die Île d’Orléans wurden zu ihrer neuen normannischen Landschaft entlang des Saint-Laurent.',
      },
    },
    anchorYear: 1634,
  },
  {
    ...
    copy: {
      ...
      body: {
        ...
        de: 'Port-Royal in Acadia wurde Frankreichs zweiter Ankerplatz im Atlantik – eine Landwirtschafts- und Fischereigemeinde, die ihre eigene Identität entwickelte. Viele akadische Familien gingen auf dieselben normannischen Hafennetze zurück, die die Kolonie St. Lawrence versorgten. Als Frankreich 1713 Akadien an Großbritannien verlor, überlebten die normannischen Nachnamen der Akadier die Vertreibung und Vertreibung.',
      },
    },
    anchorYear: 1670,
  },
  {
    ...
    copy: {
      ...
      body: {
        ...
        de: 'Der in Rouen geborene René-Robert Cavelier de La Salle reiste 1682 den gesamten Mississippi hinunter bis zum Golf von Mexiko und beanspruchte das gesamte Becken für Frankreich unter dem Namen „Louisiana“. Ein einziger normannischer Entdecker erweiterte das französische Territorium vom Sankt-Lorenz-Golf bis zum Golf von Mexiko – die spektakulärste Erweiterung in der Geschichte Neufrankreichs.',
      },
    },
    anchorYear: 1682,
  },
  {
    ...
    copy: {
      ...
      body: {
        ...
        de: 'Der Vertrag von Paris von 1763 beendete die französische Souveränität über Neu-Frankreich. Aber die sechzigtausend französisch-kanadischen Einwohner – Couture, Gagnon, Tremblay, Boucher, Langlois, Cloutier, Pelletier, Fournier – blieben. Ihre normannischen Nachnamen, ihre Sprache und ihre Identität überlebten den Reichswechsel. Heute tragen Millionen von Quebecern Namen, die direkt auf die Häfen der Normandie zurückgehen.',
      },
    },
    anchorYear: 1763,
  },
  ...
  // ── Rollo lifetime guided arc ────────────────────────────────────
  {
    ...
    copy: {
      ...
      body: {
        ...
        de: 'Der Mann, aus dem Rollo werden sollte, wurde um 860 irgendwo in Skandinavien geboren – der genaue Ort bleibt jedoch umstritten. Der normannische Chronist Dudon de Saint-Quentin nennt es ein Jahrhundert später dänisch. Die isländischen Sagen nennen ihn Hrólfr, Sohn eines norwegischen Jarls aus Møre. Keine zeitgenössische Quelle entscheidet. Sicher ist, dass er aus derselben nordischen Kriegerkultur stammte, die Westeuropa neu gestaltete, und dass er ab dem Ende des 9. Jahrhunderts bewaffnete Banden zur reichsten Beute des Kontinents führte: dem Seine-Tal in Frankreich.',
      },
    },
    anchorYear: 860,
  },
  {
    ...
    copy: {
      ...
      body: {
        ...
        de: 'In den 870er und 880er Jahren griffen nordische Flotten wiederholt die fränkische Küste an. Ob Rollo zu den ersten Räubern gehörte oder später eintraf, bleibt unbekannt, aber in den 890er Jahren befehligte ein Anführer dieses Namens die Streitkräfte an der unteren Seine. Die Migrationsroute war gut etabliert: von Dänemark aus über die Nordsee, über den Ärmelkanal und in die breite Mündung der Seine – eine Flussstraße, die direkt zu den reichsten Klöstern und Städten Frankens führte.',
      },
    },
    anchorYear: 876,
  },
  {
    ...
    copy: {
      ...
      body: {
        ...
        de: 'Die untere Seine war sowohl Autobahn als auch Jagdrevier. Wikingerbanden hatten Rouen im Jahr 841 geplündert und die Abtei Jumièges niedergebrannt. Bereits in den 880er Jahren überwinterten nordische Gruppen auf den Inseln des Flusses und plünderten flussaufwärts bis Paris und flussabwärts bis zur Kanalküste. Rollo agierte in dieser gewalttätigen Landschaft – einer der Anführer unter vielen, aber zunehmend die dominierende Figur an der unteren Seine. Die Klöster, die einst den Fluss säumten, lagen verlassen da; der fränkische Militärapparat war zusammengebrochen.',
      },
    },
    anchorYear: 885,
  },
  {
    ...
    copy: {
      ...
      body: {
        ...
        de: 'Nach der großen Belagerung von Paris 885–886 versuchten es die Frankenkönige mit Tribut, Diversion und militärischer Gewalt – auf Dauer gelang ihnen nichts. In den 890er und 900er Jahren festigte Rollons Band ihren Einfluss auf die untere Seine. Er belagerte Städte, erpresste Tribut und plünderte das fränkische Landesinnere stark aus. Der karolingische Hof, der von seinen eigenen Nachfolgekrisen zerrissen war, verfügte nicht über die Mittel, eine Streitmacht zu vertreiben, die die untere Seine de facto zu einem nordischen Korridor gemacht hatte.',
      },
    },
    anchorYear: 890,
  },
  {
    ...
    copy: {
      ...
      body: {
        ...
        de: 'Im Sommer 911 führte Rollo seine Streitkräfte nach Süden, um Chartres zu belagern – ein Vorstoß gefährlich tief in das fränkische Kernland. Ein Entsatzheer unter Robert von Neustrien und Richard von Burgund besiegte die Nordländer vor den Stadtmauern. Doch der fränkische Sieg war ein Pyrrhussieg: Sie konnten eine Schlacht gewinnen, aber den Raubzügen kein Ende setzen. Beide Lager waren sich darüber im Klaren, dass Verhandlungen und nicht Krieg das Schicksal der unteren Seine regeln würden. Der Grundstein für den folgenreichsten Vertrag in der mittelalterlichen Geschichte Frankreichs war gelegt.',
      },
    },
    anchorYear: 911,
  },
  {
    ...
    copy: {
      ...
      body: {
        ...
        de: 'Im Herbst 911 schlossen Rollo und König Karl der Einfältige in Saint-Clair-sur-Epte am Fluss Epte – der natürlichen Grenze zwischen dem fränkischen Landesinneren und der unteren Seine – ein Abkommen. Rollo erhielt Rouen und das umliegende Gebiet. Im Gegenzug erklärte er sich bereit, die Seine gegen weitere Einfälle der Wikinger zu verteidigen, die christliche Taufe anzunehmen und der fränkischen Krone nominell zu huldigen. Der Vertrag war kein Geschenk, sondern die Anerkennung einer Realität: Die fränkische Macht hatte bereits die Kontrolle über die Region verloren. Der Kern der Normandie – das Land der Nordmänner – war geboren.',
      },
    },
    anchorYear: 911,
  },
  {
    ...
    copy: {
      ...
      body: {
        ...
        de: 'Kurz nach dem Vertrag ließ sich Rollo in Rouen taufen und nahm den Vornamen Robert an – nach seinem Paten Robert, Herzog von Frankreich. Er heiratete oder verbündete sich mit Poppa, einer fränkischen Adligen, deren familiäre Bindungen ihn in lokalen aristokratischen Netzwerken verankerten. Die Taufe war sowohl ein spiritueller als auch ein politischer Akt: Sie signalisierte, dass der neue Herr der Seine beabsichtigte, durch fränkische Institutionen und nicht nur durch Plünderung zu regieren. Spätere Chronisten verschönerten die Zeremonie – die berühmte Geschichte von Rollo, der sich weigerte, den Fuß des Königs zu küssen, ist eine literarische Überlieferung, keine dokumentierte Tatsache.',
      },
    },
    anchorYear: 912,
  },
  {
    ...
    copy: {
      ...
      body: {
        ...
        de: 'In den 910er und 920er Jahren festigte Rollo sein Territorium. Die nordischen Siedler breiteten sich von der Seine-Mündung nach Westen aus und heirateten mit der fränkischen und galloromanischen Bevölkerung. Aus Raubzügen wurden Siedlungskorridore. Rollo gewährte seinen Anhängern Land, ernannte Verwalter und begann mit der Wiederherstellung der zerstörten Kirchen und Abteien, deren Unterstützung er brauchte. Er hielt seine Bündnisse mit dem fränkischen Hof aufrecht und förderte gleichzeitig die weitere skandinavische Einwanderung. Das Ergebnis war eine hybride Herrschaft – eine nordische Militäraristokratie, aufgepfropft auf fränkische Rechts- und Kirchentraditionen – von bemerkenswerter Wirksamkeit.',
      },
    },
    anchorYear: 920,
  },
  {
    ...
    copy: {
      ...
      body: {
        ...
        de: 'Rollo starb um 928 in Rouen, nachdem er sein Territorium etwa siebzehn Jahre lang regiert hatte. Sein Sohn Guillaume Longue-Épée folgte ihm nach, indem er das Herzogtum nach Westen bis nach Bessin ausdehnte und seine Integration in die fränkische politische Ordnung vertiefte. Über drei Generationen hinweg übernahmen die nordischen Siedler die französische Sprache, das fränkische Recht und die christliche Frömmigkeit – und behielten dabei den Expansionsdrang ihrer Vorfahren bei. Das bescheidene Zugeständnis von 911 wurde zum dynamischsten Herzogtum Europas, zum Sprungbrett für die normannische Eroberung Englands, der Königreiche Süditalien und Sizilien und zu einem Erbe, das über den Atlantik bis nach Neu-Frankreich reichen sollte.',
      },
    },
    anchorYear: 928,
  },
  ...
  // ── William the Conqueror lifetime guided arc ────────────────────
  {
    ...
    copy: {
      ...
      body: {
        ...
        de: 'Um 1028 wurde William auf Schloss Falaise geboren – der uneheliche Sohn von Robert I., Herzog der Normandie, und Herleva, einer Frau aus bescheidenen Verhältnissen aus der Stadt. Seine Illegitimität sollte seine frühen Jahre prägen: ein von seinem Vater gesetzlich anerkanntes, aber sozial prekäres Recht auf das Herzogtum. Robert starb 1035 auf einer Pilgerreise, und der siebenjährige Wilhelm erbte ein Herzogtum, dessen Aristokratie ein verwaistes uneheliches Kind eher als Chance denn als Hindernis betrachtete.',
      },
    },
    anchorYear: 1028,
  },
  {
    ...
    copy: {
      ...
      body: {
        ...
        de: 'Die Jahre zwischen 1035 und 1047 waren die gewalttätigsten in der Geschichte des Herzogtums. Drei von Williams Vormündern wurden nacheinander ermordet. Die normannischen Barone kämpften gegeneinander um die Vorherrschaft, und das Überleben des jungen Herzogs hing von Loyalisten ab, die ihn während der schlimmsten Verschwörungen von Burg zu Burg weitergaben. Die über ein Jahrhundert von den Nachkommen Rollos aufgebaute herzogliche Autorität stand kurz vor dem Zusammenbruch. William wuchs in dieser Welt voller Hinterhalte und Verrat auf – und daraus wurde ein Herrscher von außergewöhnlicher Grausamkeit und politischer Intelligenz.',
      },
    },
    anchorYear: 1040,
  },
  {
    ...
    copy: {
      ...
      body: {
        ...
        de: 'Im Jahr 1047 versuchte eine Koalition rebellischer normannischer Barone unter der Führung von Guy von Burgund, den jungen Herzog zu stürzen. Guillaume, damals etwa neunzehn Jahre alt, traf sie zu Fuß in der Nähe von Caen in Val-ès-Dunes. Mit der entscheidenden Unterstützung von König Heinrich I. von Frankreich schlug er die Rebellenarmee in einem Kavalleriekampf in der Ebene. Dies war der Wendepunkt für seine Minderheit: Nach Val-ès-Dunes würde keine interne Koalition seine Herrschaft ernsthafter gefährden. William hatte bewiesen, dass er wusste, wie man kämpft, und dass er jeden vernichten würde, der seine Autorität in Frage stellte.',
      },
    },
    anchorYear: 1047,
  },
  {
    ...
    copy: {
      ...
      body: {
        ...
        de: 'In den 1050er Jahren zerstörte Wilhelm systematisch jede noch so kleine Widerstandsquelle. Er besiegte den Grafen von Anjou, wehrte zwei Invasionen seines ehemaligen Verbündeten König Heinrich I. von Frankreich ab, heiratete Mathilde von Flandern, um seine Nordgrenze zu sichern, und startete ein ehrgeiziges Programm zum Burgbau und zur Kirchenreform. Caen entstand als zweite herzogliche Hauptstadt, verankert durch zwei Abteien – die Abbaye aux Hommes und die Abbaye aux Dames – die die Frömmigkeit und den Ehrgeiz der Normannen in Stein gemeißelt zum Ausdruck brachten. Im Jahr 1060 war die Normandie das am besten regierte Fürstentum Frankreichs und Wilhelm ihr unbestrittener Herrscher.',
      },
    },
    anchorYear: 1055,
  },
  {
    ...
    copy: {
      ...
      body: {
        ...
        de: 'Edward der Bekenner, der kinderlose angelsächsische König, hatte jahrzehntelang im Exil in der Normandie gelebt, bevor er 1042 den englischen Thron bestieg. William behauptete später, Edward habe ihm die Nachfolge versprochen – eine Behauptung, die bestärkt wurde, als Harold Godwinson, Englands mächtigster Graf, bei einem Besuch in der Normandie um 1064 einen Eid geschworen hatte, mit dem er Williams Rechte anerkannte. Als Edward am 5. Januar 1066 starb und Harold Als er die Krone eroberte, erklärte Wilhelm ihn zum Meineid und begann mit der Planung der gewagtesten Militäroperation des Mittelalters.',
      },
    },
    anchorYear: 1064,
  },
  {
    ...
    copy: {
      ...
      body: {
        ...
        de: 'Im Sommer 1066 stellte Wilhelm eine Invasionstruppe von etwa 7.000 Mann und vielleicht 700 Schiffen zusammen – rekrutiert nicht nur aus der Normandie, sondern auch aus der Bretagne, Flandern und ganz Nordfrankreich. Die Flotte versammelte sich an der Mündung der Dives und zog dann nach Saint-Valéry-sur-Somme, um auf günstige Winde zu warten. Es war ein kolossales logistisches Unterfangen: Pferde, Rüstungen, Belagerungsholz und Vorräte für eine Armee, die sofort nach ihrer Landung kämpfen musste. Wilhelm erhielt den päpstlichen Segen für seine Sache und verwandelte ein dynastisches Wagnis in etwas, das einem Kreuzzug ähnelte.',
      },
    },
    anchorYear: 1066,
  },
  {
    ...
    copy: {
      ...
      body: {
        ...
        de: 'Die normannische Flotte überquerte in der Nacht vom 27. auf den 28. September den Ärmelkanal und landete in Pevensey an der Küste von Sussex. Harold, der gerade eine norwegische Invasion an der Stamford Bridge im Norden niedergeschlagen hatte, unternahm mit seiner erschöpften Armee einen Gewaltmarsch nach Süden. Die beiden Streitkräfte trafen am 14. Oktober in Senlac Hill in der Nähe von Hastings aufeinander. Die Schlacht dauerte den ganzen Tag – ein brutaler Zusammenstoß zwischen schwerer normannischer Kavallerie und dem angelsächsischen Schildwall. Harold wurde der Überlieferung nach durch einen Pfeil durch das Auge getötet, und bei Einbruch der Dunkelheit war die englische Armee besiegt. Ein einziger Kampftag entschied über das Schicksal Englands.',
      },
    },
    anchorYear: 1066,
  },
  {
    ...
    copy: {
      ...
      body: {
        ...
        de: 'Wilhelm wurde am Weihnachtstag 1066 in der Westminster Abbey zum König von England gekrönt. Aber die Krone zu gewinnen und das Königreich zu behalten, waren zwei verschiedene Dinge. In den nächsten fünf Jahren schlug er eine Rebellion nach der anderen nieder – die brutalste war die „Verwüstung des Nordens“ in den Jahren 1069–70, als er Yorkshire systematisch verwüstete, um den anglo-skandinavischen Widerstand zu brechen. Im ganzen Land erhob sich eine Burg nach der anderen: der Tower of London, Windsor, Warwick, York. Die alte angelsächsische Aristokratie wurde fast vollständig durch normannische und französische Herren ersetzt. England wurde neu gemacht.',
      },
    },
    anchorYear: 1067,
  },
  {
    ...
    copy: {
      ...
      body: {
        ...
        de: 'In den letzten zwanzig Jahren seines Lebens regierte Wilhelm ein Königreich am Ärmelkanal – die Normandie auf der einen und England auf der anderen Seite. Er verbrachte jeweils etwa die Hälfte seiner Zeit damit, den Ärmelkanal wiederholt zu überqueren, um Krisen zu bewältigen. Das Domesday Book von 1086, eine umfassende Bestandsaufnahme englischer Ländereien und Reichtümer, bewies eine in Europa einzigartige Fähigkeit zur administrativen Kontrolle. Die französisch-normannische Sprache drang in das englische Recht, die englische Sprache und die englische Kultur ein. Die Architektur der Macht – Steinburgen, romanische Kathedralen – veränderte die englische Landschaft. Aber der kanalübergreifende Zustand war von Natur aus instabil, da seine beiden Hälften in entgegengesetzte Richtungen zogen.',
      },
    },
    anchorYear: 1080,
  },
  {
    ...
    copy: {
      ...
      body: {
        ...
        de: 'Im September 1087 wurde Wilhelm während seines Feldzugs gegen den französischen König in Vexin tödlich verwundet, als sein Pferd über die brennenden Ruinen von Mantes stolperte. Er wurde in das Priorat Saint-Gervais in der Nähe von Rouen transportiert, wo er am 9. September starb. Sein Königreich wurde geteilt: Robert Courteheuse erhielt die Normandie, William le Roux erhielt England. Er wurde in seiner eigenen Stiftung, der Abbaye aux Hommes in Caen, beigesetzt. Der Bastard von Falaise hatte ein kleines Herzogtum in ein kanalübergreifendes Reich verwandelt, die englische Sprache und das englische Recht umgestaltet und ein normannisches Erbe ins Leben gerufen, das von Sizilien bis zu den Mauern Jerusalems – und Jahrhunderte später über den Atlantik bis nach Neu-Frankreich – nachhallen sollte.',
      },
    },
    anchorYear: 1087,
  },
  ...
  // ── Roger II lifetime guided arc ─────────────────────────────────
  {
    ...
    copy: {
      ...
      body: {
        ...
        de: 'Zu Beginn des 11. Jahrhunderts kamen normannische Abenteurer – landlose Kadetten der kleinen Aristokratie von Cotentin und Bessin – als angeheuerte Söldner nach Süditalien. Sie kämpften für langobardische Fürsten, byzantinische Gouverneure und jeden, der zahlen konnte. Unter ihnen waren die Söhne von Tancrède de Hauteville, einem Kleinherrn aus der Gegend um Coutances. Aus dieser unbekannten Familie stammten Robert Guiscard, der Apulien und Kalabrien eroberte, und sein jüngerer Bruder Roger I., der den Arabern Sizilien entriss. Ende des 11. Jahrhunderts besaßen die Hautevilles das größte normannische Herrschaftsgebiet außerhalb der Normandie.',
      },
    },
    anchorYear: 1030,
  },
  {
    ...
    copy: {
      ...
      body: {
        ...
        de: 'Roger II. wurde am 22. Dezember 1095 in Sizilien geboren – höchstwahrscheinlich in Mileto in Kalabrien – als Sohn von Roger I., dem Großgrafen, der dreißig Jahre damit verbracht hatte, die Insel von ihren arabischen Herrschern zu erobern. Sizilien war eine Welt, die in Nordeuropa ihresgleichen suchte: hellenischsprachige Christen, arabischsprachige Muslime, jüdische Gemeinden und eine dünne normannische Militärelite, die alles regierte. Roger I. starb 1101 und hinterließ den sechsjährigen Roger II. unter der Regentschaft seiner Mutter Adelaide. Das Kind erbte nicht nur eine Insel, sondern auch die Herausforderung, die Einheit einer der vielfältigsten Bevölkerungen der mittelalterlichen Welt aufrechtzuerhalten.',
      },
    },
    anchorYear: 1095,
  },
  {
    ...
    copy: {
      ...
      body: {
        ...
        de: 'Als sein Cousin Wilhelm, Herzog von Apulien, 1127 ohne Erben starb, nutzte Roger seine Chance. Er überquerte die Straße von Messina und beanspruchte die normannischen Festlandgebiete – Apulien, Kalabrien und das Fürstentum Capua. Die kontinentalen Barone, die sich nicht von einem sizilianischen Grafen regieren lassen wollten, revoltierten mehrmals. Roger unterwarf sie mit einer Mischung aus militärischer Gewalt und politischer List, indem er Rebellenhochburgen belagerte und diejenigen kaufte, die erobert werden konnten. Im Jahr 1129 zwang er die letzten Widerspenstigen zur Unterwerfung. Zum ersten Mal unterstand jedes normannische Territorium in Süditalien und Sizilien einem einzigen Herrn.',
      },
    },
    anchorYear: 1127,
  },
  {
    ...
    copy: {
      ...
      body: {
        ...
        de: 'Am Weihnachtstag 1130 wurde Roger in der Kathedrale von Palermo von einem päpstlichen Legaten zum König von Sizilien gekrönt. Das neue Königreich vereinte Sizilien, Kalabrien, Apulien, Capua und Neapel unter einer einzigen Krone – die erste Vereinigung dieser Gebiete seit dem Fall Roms. Papst Anakletus II. hatte den Titel im Austausch für Rogers Unterstützung in einem päpstlichen Schisma verliehen; der rivalisierende Papst Innozenz II. verurteilte ihn. Rogers Reaktion war charakteristisch direkt: Er besiegte Innozenz\' deutsche und normannische Verbündete im Feld, nahm den Papst selbst in der Schlacht von Galluccio im Jahr 1139 gefangen und zwang ihn, das Königreich zu bestätigen. Für Roger war Legitimität etwas, das man sich mit Gewalt erkämpfte und das dann in eine Zeremonie gekleidet wurde.',
      },
    },
    anchorYear: 1130,
  },
  {
    ...
    copy: {
      ...
      body: {
        ...
        de: 'Roger machte Palermo zu einer der bemerkenswertesten Städte der mittelalterlichen Welt. Arabische Geographen, griechische Gelehrte, lateinische Geistliche und normannische Administratoren arbeiteten Seite an Seite. Der königliche Hof operierte auf Arabisch, Griechisch und Latein. Roger ließ die Palatinkapelle errichten, deren Innenraum byzantinische Mosaike, arabische Muqarna-Decken und lateinische Liturgie in einem schillernden Raum vereinte. In Cefalù baute er eine Kathedrale, deren Christus-Pantokrator-Mosaik bis heute eines der höchsten Meisterwerke der mittelalterlichen Kunst ist. Kein anderer Herrscher in Europa regierte mit so bewusstem multikulturellen Ehrgeiz.',
      },
    },
    anchorYear: 1140,
  },
  {
    ...
    copy: {
      ...
      body: {
        ...
        de: 'Roger baute eine Verwaltungsmaschinerie von außerordentlicher Raffinesse. Er stützte sich auf arabische Finanztraditionen, byzantinische bürokratische Methoden und normannische Feudalstrukturen und schuf einen zentralisierten Staat, der in der Lage war, in einem riesigen und vielfältigen Königreich Steuern zu erheben, Gesetze zu erlassen und königliche Autorität durchzusetzen. Die Assisen von Ariano (1140) kodifizierten die Gesetze für das gesamte Königreich. Ein Netzwerk königlicher Bürgerwehren sorgte für den Frieden des Königs. Der Diwān – eine Schatzkammer nach dem Vorbild des fatimidischen Ägypten – verfolgte die Einnahmen mit einer Präzision, die in Westeuropa nur durch die Anjou-Reformen in England erreicht werden konnte. Roger bewies, dass ein normannischer Herrscher nicht nur erobern, sondern auch herrschen konnte.',
      },
    },
    anchorYear: 1140,
  },
  {
    ...
    copy: {
      ...
      body: {
        ...
        de: 'Rogers Ambitionen reichten über das Meer hinaus. Zwischen 1135 und 1153 eroberten seine Flotten eine Reihe von Küstenstädten entlang der nordafrikanischen Küste – Mahdia, Tripolis, Sfax, Gabès – und gründeten so das, was Chronisten das „Königreich Afrika“ nannten. Dies war das einzige Mal, dass zwischen der Römerzeit und der frühen Neuzeit eine europäische christliche Macht Territorium an der nordafrikanischen Küste besaß. Roger überfiel auch das Byzantinische Reich, plünderte Korfu, Korinth und Theben und brachte griechische Seidenweber nach Palermo zurück. Das zentrale Mittelmeer war zu einem normannischen See geworden.',
      },
    },
    anchorYear: 1148,
  },
  {
    ...
    copy: {
      ...
      body: {
        ...
        de: 'Im Jahr 1154 vollendete der arabische Geograph Muhammad al-Idrisi die Tabula Rogeriana – das „Buch Rogers“ – die genaueste im Mittelalter erstellte Weltkarte. Im Auftrag von Roger wurde es auf einer riesigen Silberscheibe eingraviert und von einem geografischen Text begleitet, der griechische, arabische und normannische Kenntnisse zusammenfasst. Das Projekt verkörperte alles, wofür Rogers Hof stand: intellektueller Ehrgeiz, interkulturelle Zusammenarbeit und ein König, der sich nicht als Herrscher eines einzelnen Volkes, sondern als Förderer des universellen Wissens verstand. Keine andere normannische Errungenschaft zeigte so deutlich den Weg, den die Nachkommen skandinavischer Plünderer eingeschlagen hatten.',
      },
    },
    anchorYear: 1154,
  },
  {
    ...
    copy: {
      ...
      body: {
        ...
        de: 'Roger II. starb am 26. Februar 1154 in Palermo im Alter von achtundfünfzig Jahren. Sein Königreich ging an seinen Sohn Wilhelm I. über, dann an seinen Enkel Wilhelm II., der die Kathedrale von Monreale bauen ließ – das letzte große Meisterwerk des normannischen Siziliens. Die Hauteville-Dynastie endete 1194 mit der Eroberung des Königreichs durch Kaiser Heinrich VI., doch die von Roger errichteten Bauwerke blieben erhalten. Sein Gesetzbuch, seine multikulturelle Verwaltung und seine architektonische Pracht prägten Sizilien über Jahrhunderte hinweg. Die Palatinskapelle, Cefalù und Monreale stehen immer noch als Denkmäler für einen Moment, als normannischer Ehrgeiz, arabische Gelehrsamkeit und byzantinische Kunst zu etwas verschmolzen, das die Welt noch nie gesehen hatte – und nie wieder sehen würde.',
      },
    },
    anchorYear: 1154,
  },
  ...
  // ── Robert Guiscard lifetime guided arc ──────────────────────────
  {
    ...
    copy: {
      ...
      body: {
        ...
        de: 'Tancrède de Hauteville war ein kleiner normannischer Lord in der Nähe von Coutances im Cotentin – ein Mann mit bescheidenen Mitteln, mit zwölf Söhnen und ohne Land, das er den meisten von ihnen geben konnte. Ab den 1030er Jahren verließen die älteren Brüder die Normandie und zogen nach Süditalien, wo die zersplitterte Politik der lombardischen Fürstentümer, der byzantinischen Provinzen und des von Arabern kontrollierten Siziliens Möglichkeiten für erfahrene Kämpfer bot. Der erste normannische Stützpunkt war Aversa, dem 1030 die Grafschaft verliehen wurde. Robert, der sechste Sohn von Tancred, kam um 1047 nach Italien – jung, ehrgeizig und völlig mittellos. Er würde der beeindruckendste Eroberer seiner Zeit werden.',
      },
    },
    anchorYear: 1035,
  },
  {
    ...
    copy: {
      ...
      body: {
        ...
        de: 'Robert kam mit nichts als seinem Schwert und seiner List in Kalabrien an. Er erhielt den Spitznamen „Guiscard“ – der „Cunful“ oder „Wise“ –, indem er sowohl seine Feinde als auch seine eigenen normannischen Rivalen plünderte, erpresste und überlistete. Er agierte als Banditenführer im kalabrischen Hochland und baute durch eine Mischung aus persönlichem Charisma, kalkulierter Gewalt und dem Versprechen von Beute eine bewaffnete Bande aus dem Nichts auf. Als sein älterer Bruder Humphrey im Jahr 1057 starb, übernahm Robert die Kontrolle über den Familienbesitz in Italien. Er befehligte nun jeden normannischen Kämpfer in Apulien.',
      },
    },
    anchorYear: 1047,
  },
  {
    ...
    copy: {
      ...
      body: {
        ...
        de: 'Im Jahr 1059 vollzog Papst Nikolaus II. einen erstaunlichen Sinneswandel. Das Papsttum hatte erfolglos versucht, die Normannen aus Süditalien zu vertreiben; Sie beschließt nun, sie zurückzubekommen. In Melfi ernannte der Papst Robert zum Herzog von Apulien, Kalabrien und – in einer inspirierten juristischen Fiktion – von Sizilien, das noch unter arabischer Herrschaft stand. Im Gegenzug wurde Robert ein päpstlicher Vasall und versprach ihm militärische Unterstützung. Der Vertrag verwandelte Robert von einem räuberischen Kriegsherrn in einen legitimen Feudalfürsten mit päpstlicher Genehmigung. Es war eines der folgenreichsten diplomatischen Abkommen des 11. Jahrhunderts: Die Normannen erlangten Legitimität, das Papsttum erhielt ein Schwert.',
      },
    },
    anchorYear: 1059,
  },
  {
    ...
    copy: {
      ...
      body: {
        ...
        de: 'Bari war mehr als drei Jahrhunderte lang die Hauptstadt des byzantinischen Italiens – der Anker der westlichen Präsenz Konstantinopels. Robert belagerte es drei Jahre lang und schnitt die Land- und Seeversorgung ab. Im April 1071 kapitulierte die Stadt. Mit dem Fall von Bari endete die byzantinische Herrschaft in Italien endgültig. Ein Reich, das die Region seit Justinian beherrscht hatte, verlor seine letzte Basis an eine Familie normannischer Abenteurer aus Cotentin. Robert kontrollierte nun alles von der Adriaküste bis zu den Bergen Kalabriens – dem größten normannischen Herrschaftsgebiet außerhalb Englands.',
      },
    },
    anchorYear: 1071,
  },
  {
    ...
    copy: {
      ...
      body: {
        ...
        de: 'Während Robert Apulien festigte, vertraute er seinem jüngsten Bruder Roger die Eroberung Siziliens an. Der Feldzug dauerte dreißig Jahre (1061–1091). Messina fiel zuerst, dann drangen die Normannen nach Westen über eine gebirgige Insel vor, die von mit dem Gelände vertrauten arabischen Emiren verteidigt wurde. Palermo, der Hauptpreis, wurde 1072 nach einer gemeinsamen Belagerung durch Robert und Roger eingenommen. Robert behielt nominell die Oberherrschaft, aber es war Roger, der blieb und regierte – und den Grundstein für das legte, was unter seinem Sohn Roger II. zum Königreich Sizilien werden sollte.',
      },
    },
    anchorYear: 1072,
  },
  {
    ...
    copy: {
      ...
      body: {
        ...
        de: 'Im Jahr 1076 eroberte Robert Salerno, das letzte unabhängige langobardische Fürstentum, und machte es zu seiner Hauptstadt. Die berühmte medizinische Fakultät der Stadt – die älteste in Europa – blieb unter dem normannischen Regime bestehen. Robert heiratete die lombardische Prinzessin Sichelgaite, die an seiner Seite in voller Rüstung in die Schlacht ritt. Er begann mit dem Bau einer großen Kathedrale, die mit jeder in Nordeuropa konkurrieren konnte. Von Salerno aus regierte Robert ein Herrschaftsgebiet, das sich von den Abruzzen bis nach Sizilien erstreckte – aber seine Ambitionen richteten sich bereits nach Osten, auf den reichsten Schatz von allen: das Byzantinische Reich.',
      },
    },
    anchorYear: 1076,
  },
  {
    ...
    copy: {
      ...
      body: {
        ...
        de: 'Im Jahr 1081 überquerte Robert die Adria und fiel in das Byzantinische Reich ein. Sein Ziel war Durazzo (Dyrrachium), der westliche Endpunkt der Via Egnatia – der Straße nach Konstantinopel. Der byzantinische Kaiser Alexios I. Komnenus konfrontierte ihn mit einer Armee, zu der auch die Elite der Warägergarde gehörte. Am 18. Oktober 1081 durchbrach Roberts normannische Kavallerie in einer der großen Schlachten des Mittelalters die byzantinische Linie. Durazzo fiel. Zum ersten Mal seit den Westgoten rückte eine westliche Armee entlang der antiken Römerstraße in Richtung Konstantinopel vor. Es war der gewagteste Feldzug, den ein Norman je unternommen hatte.',
      },
    },
    anchorYear: 1081,
  },
  {
    ...
    copy: {
      ...
      body: {
        ...
        de: 'Im Jahr 1084 wurde Papst Gregor VII. auf der Engelsburg vom römisch-deutschen Kaiser Heinrich IV. belagert. Der Papst rief seinen normannischen Vasallen um Hilfe. Robert marschierte mit einer riesigen Armee nach Norden, vertrieb die germanischen Streitkräfte und befreite den Papst – doch dann plünderten seine Truppen Rom mit einer Gewalt, die die gesamte Christenheit schockierte. Ganze Stadtviertel wurden in Brand gesteckt. Die Römer, die ihn als Befreier willkommen geheißen hatten, verfluchten die Normannen als schlimmer als die Barbaren der alten Zeit. Gregory, zu gedemütigt, um zu bleiben, verließ Rom mit Robert und starb im Exil in Salerno. Es war ein typischer Guiscard-Moment: Der Sieg wurde errungen, aber zu einem Preis, der selbst seine Verbündeten bestürzte.',
      },
    },
    anchorYear: 1084,
  },
  {
    ...
    copy: {
      ...
      body: {
        ...
        de: 'Robert Guiscard starb am 17. Juli 1085 auf der Insel Kefalonia, mitten im zweiten Balkanfeldzug gegen Byzanz. Er war etwa siebzig Jahre alt. Als er mit nichts in Italien ankam, hinterließ er ein Herrschaftsgebiet, das sich von der Adria bis nach Sizilien erstreckte, hatte das Byzantinische Reich von der italienischen Halbinsel vertrieben, die letzten arabischen Bastionen Siziliens erobert, Rom geplündert und das größte Reich der Welt bis zum Ende bekämpft. Sein Sohn Bohemond trug während des Ersten Kreuzzugs den normannischen Namen nach Antiochia. Die Linie seines Bruders Roger würde Roger II. und das Königreich Sizilien hervorbringen. Der listige sechste Sohn von Hauteville hatte die Karte des mittelalterlichen Mittelmeerraums neu gezeichnet.',
      },
    },
    anchorYear: 1085,
  },
  ...
  // ── Bohemond of Antioch lifetime guided arc ──────────────────────
  {
    ...
    copy: {
      ...
      body: {
        ...
        de: 'Bohemond wurde um 1054 als ältester Sohn von Robert Guiscard und seiner ersten Frau Alberada de Buonalbergo geboren. Er wuchs in der gewalttätigen Welt des normannischen Süditaliens auf, wurde von Kindheit an für den Krieg ausgebildet und kämpfte an der Seite seines Vaters in der entscheidenden Schlacht von Durazzo im Jahr 1081 – wo er mit gerade einmal 27 Jahren den Kavallerieangriff anführte, der die byzantinische Linie durchbrach. Doch als Guiscard die lombardische Prinzessin Sichelgaite erneut heiratete, sicherte sie ihrem eigenen Sohn, Roger Borsa, die Nachfolge. Bohemund wurde entlassen. Dem größten Krieger seiner Generation blieb nichts anderes übrig als sein Ruf und das Beispiel seines Vaters: Ein landloser Normanne konnte mit Waffengewalt ein Königreich errichten.',
      },
    },
    anchorYear: 1054,
  },
  {
    ...
    copy: {
      ...
      body: {
        ...
        de: 'Nach Guiscards Tod im Jahr 1085 kämpfte Bohemond ein Jahrzehnt lang gegen seinen Halbbruder Roger Borsa um einen Anteil am Erbe. Er war ein brillanter Soldat, aber ein schlechter Politiker, und Borsa hatte den herzoglichen Titel und die päpstliche Unterstützung inne. Schließlich eroberte Bohemond das Fürstentum Tarent – ​​den Absatz des italienischen Stiefels – als bescheidenes Reich für einen Mann mit seinen Ambitionen. Er hielt es ungeduldig, immer auf der Suche nach einer größeren Bühne. Als Papst Urban II. 1095 in Clermont den Ersten Kreuzzug predigte, sah Bohemond etwas, das kein anderer normannischer Herrscher erkannte: die Gelegenheit, sein eigenes Fürstentum im Osten aufzubauen, außerhalb der Reichweite der byzantinischen Brüder, Päpste und Kaiser.',
      },
    },
    anchorYear: 1090,
  },
  {
    ...
    copy: {
      ...
      body: {
        ...
        de: 'Im Jahr 1096 belagerte Bohemond Amalfi, als ihn die Nachricht vom Kreuzzug erreichte. Der Legende nach zerriss er seinen besten Mantel, um an Ort und Stelle Kreuze für seine Männer anzufertigen. Er versammelte das normannische Kontingent – ​​erfahrene Veteranen der italienischen Kriege, von denen viele von Söldnern abstammten, die Jahrzehnte zuvor zum ersten Mal in den Süden gekommen waren. Sie überquerten die Adria bei Durazzo, folgten 1081 der Invasionsroute seines Vaters und marschierten über Land durch den Balkan nach Konstantinopel. Bohemond kannte die Route, kannte den Feind und kannte den byzantinischen Kaiser Alexios I. Komnenos persönlich – da er ihm auf dem Schlachtfeld gegenübergetreten war.',
      },
    },
    anchorYear: 1096,
  },
  {
    ...
    copy: {
      ...
      body: {
        ...
        de: 'Alexios Comnenus betrachtete die Kreuzfahrer mit tiefem Misstrauen – insbesondere die Normannen, die erst fünfzehn Jahre zuvor in sein Reich eingedrungen waren. Er verlangte von jedem Kreuzfahrer einen Eid, alle zuvor eroberten byzantinischen Gebiete zurückzugeben. Die meisten taten dies widerwillig. Bohemond fluchte bereitwillig, sogar eifrig – und die byzantinische Prinzessin Anna Comnena, die Jahre später schrieb, fing seine imposante Statur ein: groß, blond, breitschultrig, mit einem ständigen halben Lächeln, das jedem, der ihn traf, Unbehagen bereitete. Alexis verlieh ihm den Titel Großdomäne des Orients. Bohemond akzeptierte die Schmeichelei und ignorierte die Verpflichtung. Er hatte nicht die Absicht, etwas zurückzugeben.',
      },
    },
    anchorYear: 1097,
  },
  {
    ...
    copy: {
      ...
      body: {
        ...
        de: 'Die Kreuzfahrerarmee drang nach Kleinasien ein und belagerte Nicäa, das sich den byzantinischen Agenten ergab, bevor die Kreuzfahrer es stürmen konnten – was ihr Misstrauen gegenüber Alexios verstärkte. Dann, am 1. Juli 1097, überfiel der seldschukische Sultan Kilij Arslan Bohemonds Vorhut bei Dorylaeum. Die Normannen waren zahlenmäßig unterlegen und umzingelt. Bohemond hielt seine Linie stundenlang im brutalen Nahkampf und befahl seinen Rittern abzusteigen und an der Seite der Infanterie zu kämpfen – eine unkonventionelle Taktik, die verhinderte, dass die Armee überwältigt wurde. Als die Verstärkungen von Gottfried von Bouillon eintrafen, griffen die Kreuzfahrer die seldschukische Armee an und schlugen sie in die Flucht. Es war die entscheidende Landschlacht des Ersten Kreuzzugs und sie machte Bohemund zum ersten militärischen Befehlshaber des Kreuzzugs.',
      },
    },
    anchorYear: 1097,
  },
  {
    ...
    copy: {
      ...
      body: {
        ...
        de: 'Antiochia war der Hauptpreis – eine Stadt mit massiven römischen Mauern, alten Kirchen und strategischer Kontrolle über den Weg nach Jerusalem. Die Kreuzfahrer belagerten es acht Monate lang (Oktober 1097 – Juni 1098) und litten unter Hungersnot, Desertionen und Pest. Nur Bohemond blieb cool. Er verhandelte heimlich mit einem armenischen Turmwächter namens Firouz, der sich bereit erklärte, ein Tor zu öffnen. In der Nacht vom 2. auf den 3. Juni 1098 erklommen Bohemonds Normannen die Mauern, Firouz öffnete den Turm der Zwei Schwestern und die Kreuzfahrer stürmten hinein. Die Stadt verfiel in eine Nacht chaotischer Gewalt. Drei Tage später traf eine riesige seldschukische Hilfsarmee unter Kerbogha von Mossul ein und belagerte die Belagerer. Bohemond, der nun in der Stadt gefangen war, die er gerade eingenommen hatte, sah sich der Vernichtung gegenüber.',
      },
    },
    anchorYear: 1098,
  },
  {
    ...
    copy: {
      ...
      body: {
        ...
        de: 'Hungrig und verzweifelt hinter den Mauern von Antiochia versammelten sich die Kreuzfahrer um eine wundersame Entdeckung: Ein provenzalischer Bauer namens Pierre Barthélemy behauptete, eine Vision habe ihm die Heilige Lanze offenbart – den Speer, der die Seite Christi durchbohrte –, der unter der Kathedrale St. Peter begraben lag. Sie gruben und fanden eine eiserne Speerspitze. Ob Bohemund an die Reliquie glaubte, ist zweifelhaft, aber er verstand ihre Macht. Am 28. Juni 1098 führte er die gesamte Kreuzfahrerarmee in einem Masseneinsatz durch die Stadttore. Die hungrigen und halb verrückten Kreuzfahrer griffen Kerboghas weit überlegene Streitmacht an – und zerschmetterten sie. Die seldschukische Armee löste sich auf. Antiochia war sicher. Bohemond beanspruchte es als sein Eigentum und berief sich dabei auf eine Vereinbarung mit den anderen Häuptlingen vor der Belagerung. Die anderen Prinzen protestierten. Bohemund ignorierte sie.',
      },
    },
    anchorYear: 1098,
  },
  {
    ...
    copy: {
      ...
      body: {
        ...
        de: 'Bohemond etablierte sich als Prinz von Antiochia, während die anderen Kreuzfahrer nach Jerusalem marschierten. Er regierte einen polyglotten Staat aus Franken, Armeniern, Griechen und syrischen Christen und zwang einer Stadt im Osten einen Feudalismus im normannischen Stil auf. Doch im Jahr 1100 geriet er während eines Feldzugs gegen die Danishmendid-Türken in einen Hinterhalt und wurde gefangen genommen. Er verbrachte drei Jahre in Gefangenschaft (1100–1103), während derer sein Neffe Tankred – ein weiterer Hauteville – in seiner Abwesenheit Antiochia regierte. Sein Lösegeld war enorm: 100.000 Golddinar, teilweise bezahlt vom armenischen Herrscher von Edessa. Sogar in der Gefangenschaft wuchs die Legende von Bohemond – muslimische Chronisten bemerkten seinen Trotz und seine Weigerung, zu konvertieren.',
      },
    },
    anchorYear: 1100,
  },
  {
    ...
    copy: {
      ...
      body: {
        ...
        de: 'Nach seiner Befreiung im Jahr 1103 kehrte Bohemond nach Europa zurück, um eine neue Armee aufzustellen – nicht für das Heilige Land, sondern für seine wahre Obsession: die Zerstörung von Byzanz. Er heiratete Konstanze, die Tochter von König Philipp I. von Frankreich, rekrutierte eine riesige Streitmacht und überquerte 1107 die Adria, um Durazzo zu belagern – genau wie sein Vater es 1081 getan hatte. Doch dieses Mal war Alexios bereit. Die Belagerung scheiterte. Im Jahr 1108 musste Bohemond den demütigenden Vertrag von Devol unterzeichnen, der Antiochia als byzantinische Festung anerkannte. Er kehrte nie in den Orient zurück. Er starb 1111 in Apulien, wahrscheinlich etwa siebenundfünfzig Jahre alt, ein Mann, dessen Ambitionen schon immer seine Möglichkeiten überstiegen hatten. Doch das Fürstentum Antiochia überlebte fast zwei Jahrhunderte, und der Name Hauteville hallte von der Normandie bis zum Euphrat wider – der weitesten Reichweite, die jemals eine normannische Dynastie erreichte.',
      },
    },
    anchorYear: 1111,
  },
  ...
  // ── Tancred of Galilee & Richard the Lionheart beats ─────────────
  {
    ...
    copy: {
      ...
      body: {
        ...
        de: 'Während sich Bohemond in Antiochia niederließ, marschierte sein Neffe Tankred mit dem Großteil der Kreuzfahrerarmee nach Süden. Nach dem Fall Jerusalems im Juli 1099 errichtete Tancred in Galiläa eine Herrschaft mit Schwerpunkt auf Tiberias und erlegte einer Landschaft aus galiläischen Hügeln, arabischen Dörfern und christlichen Wallfahrtsorten einen Feudalismus im normannischen Stil auf. Er gehörte zu den ersten Kreuzfahrern, die Jerusalem betraten, und eroberte Bethlehem am Tag vor dem Fall der Stadt. Als Bohemond im Jahr 1100 von den Danishmendid-Türken erobert wurde, kehrte Tankred nach Norden zurück, um als Regent Antiochia zu regieren – der einzige Normanne, der in beiden Kreuzfahrerstaaten die Macht innehatte. Er starb im Jahr 1112, noch nicht einmal vierzig, nachdem er sein ganzes Erwachsenenleben damit verbracht hatte, im Osten zu kämpfen.',
      },
    },
    anchorYear: 1099,
  },
  {
    ...
    copy: {
      ...
      body: {
        ...
        de: 'Ein Jahrhundert nach Bohemond erreichte ein weiteres normannisches Erbe das Heilige Land. Richard I. von England – der Ururenkel von Wilhelm dem Eroberer – brach 1190 zum Dritten Kreuzzug auf. Unterwegs wurde seine Flotte von einem Sturm vor der Küste Zyperns zerstreut. Der Herr der Insel, der byzantinische Rebell Isaac Comnenus, nahm Richards schiffbrüchige Soldaten und seine Verlobte Berengaria von Navarra gefangen. Richard reagierte mit seiner charakteristischen Wut: Er eroberte die gesamte Insel innerhalb weniger Wochen und heiratete Bérengère im Mai 1191 in Limassol. Anschließend verkaufte er Zypern an die Templer und dann an Guy de Lusignan und gründete ein Kreuzfahrerkönigreich, das alle fränkischen Besitztümer auf dem Kontinent überdauern sollte. Richard eroberte Acre zurück und kämpfte gegen Saladin zu einem Waffenstillstand – aber es war die Eroberung Zyperns, eine aus einem Sturm entstandene Improvisation, die sich als nachhaltigste Errungenschaft der normannischen Abstammung in den späten Kreuzzügen erwies.',
      },
    },
    anchorYear: 1191,
  },
  ...
  // ── Leif Erikson cinematic arc ─────────────────────────────────────
  {
    ...
    copy: {
      ...
      body: {
        ...
        de: 'Die nordische Expansion über den Nordatlantik war kein einzelner Sprung, sondern eine Kette von Generationen. Um 870 kolonisierten norwegische Häuptlinge, getrieben von der Gier nach Land und Fehden, erstmals Island. Ein Jahrhundert später segelte Erik der Rote – wegen Mordes verbannt – nach Westen und gründete um 985 die Kolonien Grönlands. Sein Sohn Leif wuchs an dieser Grenze auf, Erbe der nautischen Kenntnisse und Sorgen, die seine Vorfahren von den Fjorden Norwegens bis an die Enden der bekannten Welt geführt hatten.',
      },
    },
    anchorYear: 985,
    impactVariant: {
      copy: {
        ...
        body: {
          ...
          de: 'Jede Generation verschob die Grenze ein Stück weiter: von den Fjorden zu den Färöer-Inseln, von den Färöer-Inseln nach Island, von Island nach Grönland. Dieses Muster aus Trittsteinen – kurze Überfahrten, die einen riesigen Ozean miteinander verbinden – stellte die nordische Methode der Eroberung des Atlantiks dar, ein Modell, das fünf Jahrhunderte später wiederholt wurde, als andere Europäer die gleichen Küsten erreichten.',
        },
      },
    },
  },
  {
    ...
    copy: {
      ...
      body: {
        ...
        de: 'Ende des 20. Jahrhunderts bildeten die grönländischen Kolonien den westlichsten Außenposten der europäischen Zivilisation – eine Reihe von Bauernhöfen, eingekeilt zwischen der Eisdecke und der Davisstraße. Die östliche Siedlung rund um Brattahlíð zählte auf ihrem Höhepunkt vielleicht 3.000 Seelen. Holz war knapp, die Vegetationsperioden waren hart und das Überleben hing vom Walross-Elfenbeinhandel mit Europa ab. In der Kolonie kursierten Gerüchte über bewaldete Gebiete im Südwesten. Für Leif Erikson, der an dieser kargen Peripherie aufgewachsen ist, war die nächste Überfahrt keine Rücksichtslosigkeit – sie war logisch.',
      },
    },
    anchorYear: 998,
    impactVariant: {
      copy: {
        ...
        body: {
          ...
          de: 'Grönlands Kolonien waren immer noch prekär: Sie waren von einem einzigen Handelsgut – Walross-Elfenbein – und ein paar Schiffen pro Jahr aus Island und Norwegen abhängig. Als sich die europäische Nachfrage dem Elfenbein afrikanischer Elefanten zuwandte und sich das Klima im 14. Jahrhundert abkühlte, schwand die Lebensader. Grönland erinnert uns daran, dass Entdeckungen ohne dauerhafte Verbindung vergänglich sind.',
        },
      },
    },
  },
  {
    ...
    copy: {
      ...
      body: {
        ...
        de: 'Um das Jahr 1000 verließ Leif Erikson Brattahlíð mit einer Besatzung von fünfunddreißig Mann und folgte dabei den Geschichten von Bjarni Herjólfsson, der unbekannte Küsten gesichtet hatte. Die Saga-Tradition beschreibt drei Anlaufhäfen: Helluland (wahrscheinlich Baffin Island), eine karge Felsplatte; Markland (wahrscheinlich Labrador), dicht bewaldet; und schließlich Vínland, wo sie wilde Trauben, Lachs und milde Winter fanden. Die Überfahrt von Grönland aus – rund 1.800 Kilometer offenes Meer – war der westlichste Punkt, den ein Europäer jemals im Atlantik erreichte.',
      },
    },
    anchorYear: 1000,
  },
  {
    ...
    copy: {
      ...
      body: {
        ...
        de: 'Die archäologische Stätte L\'Anse aux Meadows an der Nordspitze Neufundlands ist die einzige bestätigte nordische Siedlung in Amerika. Bei der Ausgrabung durch Helge und Anne Stine Ingstad in den 1960er-Jahren wurden Torf-Langhäuser, eine Schmiede mit Eisenschlacke und bronzene Ringbroschen im eindeutig nordischen Stil entdeckt. Die Radiokarbondatierung geht von der Besetzung um das Jahr 1000 n. Chr. aus – genau zu der Zeit, als Leif den Sagen zufolge seine Häuser baute. Der Standort war wahrscheinlich ein saisonales Basislager für weitere Erkundungen im Süden und keine dauerhafte Siedlung.',
      },
    },
    anchorYear: 1000,
  },
  {
    ...
    copy: {
      ...
      body: {
        ...
        de: 'Die Nordmänner kehrten mehrmals nach Vinland zurück, nachdem Leif – sein Bruder Thorvald – von Ureinwohnern getötet worden war; Thorfinn Karlsefni brachte Vieh und versuchte eine dauerhafte Siedlung. Doch das Unternehmen brach innerhalb eines Jahrzehnts zusammen. Die Entfernung war das zentrale Problem: Vinland lag 4.500 Kilometer von Norwegen entfernt und war nur über die kleine Bevölkerung Grönlands erreichbar. Konflikte mit der einheimischen Bevölkerung – die die Nordmänner Skrælingjar nannten – machten eine dauerhafte Besiedlung gefährlich. Ohne großstädtische Unterstützung, Versorgungsleitungen oder Bevölkerungsmasse war das Establishment nicht nachhaltig. Die Nordmänner zogen sich zurück und der Atlantik schloss sich fünf Jahrhunderte lang hinter ihnen.',
      },
    },
    anchorYear: 1010,
    impactVariant: {
      copy: {
        ...
        body: {
          ...
          de: 'Vinland scheiterte aus demselben Grund wie viele frühe Außenposten: Entdeckung ist keine Kolonisierung. Ohne staatliche Unterstützung, regelmäßige Schifffahrt oder genügend Menschen, um Verluste aufzufangen, kann ein Ankerpunkt nicht halten. Als die Franzosen fünf Jahrhunderte später in derselben Region ankamen, brachten sie einen königlichen Apparat, Jesuitennetzwerke und den Pelzhandel mit – kaum ausreichend. Das Scheitern der Norse ist das Spiegelbild dessen, was Neu-Frankreich möglich gemacht hat.',
        },
      },
    },
  },
  {
    ...
    copy: {
      ...
      body: {
        ...
        de: 'Fünfhundert Jahre lang ist die Geschichte von Vinland nur in isländischen Sagen überliefert – der Grœnlendinga-Saga und der Eiríks-Saga rauða. Das mittelalterliche Europa hat dieses Wissen nie verinnerlicht. Es wurde keine Karte aktualisiert, keine Handelsroute eröffnet, keine päpstliche Bulle herausgegeben. Kolumbus, die Cabots und Cartier segelten nach Westen, ohne zu wissen, dass nordische Kiele diese Gewässer bereits befahren hatten. Erst im 19. Jahrhundert begannen Gelehrte, die Sagen als etwas anderes als Legenden zu behandeln, und erst 1960 in L\'Anse aux Meadows bestätigte die Archäologie, was die Texte immer behauptet hatten.',
      },
    },
    anchorYear: 1050,
    impactVariant: {
      copy: {
        ...
        body: {
          ...
          de: 'Die nordische Entdeckung hatte keine nachgelagerten Auswirkungen auf die europäische Expansion. Es wurden keine kartografischen Daten übermittelt, kein nautisches Wissen zirkulierte über Island hinaus und die grönländischen Siedlungen selbst verschwanden um das 14. Jahrhundert. Es ist eine starke Erinnerung daran, dass Entdeckungen ohne Weitergabe historisch wirkungslos sind. Der Atlantik musste „wiederentdeckt“ werden – dieses Mal von Unternehmen mit Druckmaschinen, Staatsflotten und globalen Ambitionen.',
        },
      },
    },
  },
  {
    ...
    copy: {
      ...
      body: {
        ...
        de: 'Fast genau zu dem Zeitpunkt, als Leif Vinland erreichte, vollendeten seine entfernten Verwandten in Frankreich eine andere Verwandlung. Rollos Nachkommen – dieselbe nordische Linie, aus der auch die Atlantikforscher hervorgegangen waren – waren französischsprachige, christliche Herzöge geworden, die ein mächtiges Gebiet rund um die untere Seine regierten. Um das Jahr 1000 war die Normandie in Sprache und Religion nicht mehr skandinavisch, aber das Erbe der Wikinger setzte sich in ihrer Militärkultur, ihrem maritimen Selbstvertrauen und ihrem Drang nach Expansion fort. Der Faden, der einen grönländischen Bauernhof mit einer normannischen Burg verbindet, ist keine Metapher – es ist Genealogie.',
      },
    },
    anchorYear: 1000,
    impactVariant: {
      copy: {
        ...
        body: {
          ...
          de: 'Die Verwandlung vom Wikingerräuber zum normannischen Herzog dauerte nur vier Generationen. Im Jahr 1000 sprachen die Kolonisten Französisch, bauten Steinkirchen und regierten nach dem fränkischen Feudalrecht – doch behielten sie ihre rastlose Dynamik bei. Wilhelm der Eroberer, die Hautevilles von Sizilien, Bohemond von Antiochien: Sie alle waren Produkte dieser kulturellen Alchemie. Die Nordmänner, die Vinland erreichten, und die Normannen, die England eroberten, hatten dieselben Ururgroßeltern.',
        },
      },
      focus: {
        placeIds: ['rouen'],
  ...
  },
  {
    ...
    copy: {
      ...
      body: {
        ...
        de: 'Als Samuel de Champlain 1608 von Honfleur aus aufbrach und Quebec gründete, startete er ein Kolonialunternehmen, das in denselben normannischen Häfen angesiedelt war, die einst die Langschiffe der Wikinger abgefertigt hatten. Viele der Siedler, die Neu-Frankreich bevölkerten, stammten aus der Normandie und Perche – Nachkommen derselben Nordmänner, die einst nach Westen über den Atlantik geschaut hatten. L\'Anse aux Meadows liegt knapp 1.200 Kilometer von Quebec City entfernt. Die Nordmänner erreichten diese Küste fünf Jahrhunderte zu früh; Den französischsprachigen Erben der Normannen gelang es schließlich, dort zu bleiben. Von Vinland nach Neu-Frankreich schließt sich der Kreis – die Atlantiküberquerung, die Leif allein versuchte, wurde durch die Zivilisation vollendet, an deren Aufbau seine Lieben beteiligt waren.',
      },
    },
    anchorYear: 1608,
    impactVariant: {
      copy: {
        ...
        body: {
          ...
          de: 'Die Linie von Norse Vinland nach Französisch-Quebec ist kein direkter Kausalzusammenhang – es ist ein Reim. Die gleiche geografische Logik, die Leif südwestlich von Grönland zog, zog Cartier und Champlain nordwestlich der Normandie an. Der St.-Lorenz-Korridor, der Kabeljau der Grand Banks, die waldreiche Küste: Diese Ressourcen beanspruchten nacheinander jede atlantische Zivilisation. Das Verständnis von Leifs gescheitertem Versuch gibt Aufschluss darüber, warum Neu-Frankreich erfolgreich war – und warum die normannisch-atlantische Welt von Rollo bis Champlain einen einzigen kontinuierlichen Bogen bildet.',
        },
      },
      camera: {
        target: 'bbox',
  ...
  // ── William Iron Arm lifetime guided arc ─────────────────────────
  {
    ...
    copy: {
      ...
      body: {
        ...
        de: 'Tancrède de Hauteville war ein kleiner normannischer Lord in der Nähe von Coutances im Cotentin – der felsigen, windigen Halbinsel im Westen der Normandie, weit entfernt vom herzoglichen Hof von Rouen. Er besaß bescheidenes Land, hatte aber zwölf Söhne und kein Erbe, das er unter sich aufteilen konnte. Der Cotentin brachte harte Männer mit begrenzten Aussichten hervor, und für die ältesten Söhne der unteren Aristokratie führte der einzige Weg zu Land und Status woanders hin. Ab den 1030er Jahren verließen die Hauteville-Brüder einer nach dem anderen die Normandie und zogen nach Süden in die fragmentierten und vom Krieg zerrütteten Gebiete des italienischen Mezzogiorno.',
      },
    },
    anchorYear: 1010,
  },
  {
    ...
    copy: {
      ...
      body: {
        ...
        de: 'Im frühen 11. Jahrhundert erreichten normannische Abenteurer Süditalien – Pilger und Söldner, die von der chronischen Instabilität der Region angezogen wurden. Langobardenfürsten, byzantinische Gouverneure und arabische Emire verwendeten alle normannische Schwerter. Der erste wirkliche Halt erfolgte im Jahr 1030, als Rainulf Drengot die Grafschaft Aversa vom Herzog von Neapel im Austausch für Militärdienste erhielt. Die Nachricht reichte bis in die Normandie: Im Süden galt es Ländereien und Ruhm zu erobern. Für die Gebrüder Hauteville bewies Aversa, dass ein Normanne ohne Abstammung ein Schwert mit dem Schwert schmieden konnte.',
      },
    },
    anchorYear: 1030,
  },
  {
    ...
    copy: {
      ...
      body: {
        ...
        de: 'William, der älteste von Tancreds Söhnen, der Italien erreichte, kam Ende der 1030er Jahre an. Süditalien war ein Kriegsgebiet mit drei Seiten: langobardische Fürsten kämpften ums Überleben, byzantinische Gouverneure versuchten, die kaiserliche Autorität wiederherzustellen, und normannische Söldnerbanden verkauften ihre Dienste an den Meistbietenden. Wilhelm schloss sich 1038 der byzantinischen Expedition gegen das arabische Sizilien an – ein Unternehmen, das ihm die militärische Dynamik der Region offenbarte und ihn davon überzeugte, dass normannische Waffen mehr leisten konnten, als nur anderen zu dienen. Als die Expedition in byzantinischem Verrat und gegenseitigem Misstrauen scheiterte, kehrten die Normannen mit einem klareren Bewusstsein ihrer eigenen Macht auf den Kontinent zurück.',
      },
    },
    anchorYear: 1038,
  },
  {
    ...
    copy: {
      ...
      body: {
        ...
        de: 'Im Jahr 1041 wandten sich normannische Söldner gegen ihre byzantinischen Auftraggeber. In der Schlacht von Olivento führte Wilhelm die normannische Kavallerie in einem verheerenden Angriff an, der die byzantinische Linie durchbrach. Chronisten zufolge erhielt er dort den Spitznamen „Bras-de-Fer“ – entweder weil er den Schild eines Feindes mit einem einzigen Schwerthieb gebrochen hatte, oder weil er den ganzen Tag über unermüdlich kämpfte. Dieser Sieg war der erste von drei Siegen, die die byzantinische Militärmacht in Apulien zerstörten und die Normannen als eigenständige politische Kraft etablierten.',
      },
    },
    anchorYear: 1041,
  },
  {
    ...
    copy: {
      ...
      body: {
        ...
        de: 'Nach den Siegen von 1041 brauchten die Normannen einen Anführer. Sie entschieden sich für Wilhelm – nicht aufgrund einer feudalen Verleihung oder eines Geburtsrechts, sondern aufgrund der Anerkennung von Kriegern, die den Ruf im Kampf über alles andere respektierten. Als Graf von Apulien verteilte Wilhelm die eroberten Gebiete unter loyalen Normannen und etablierte so die feudale Struktur, die seine Brüder später zu einem Königreich ausbauen würden. Melfi wurde zum Verwaltungszentrum dieser neuen normannischen Macht – eine Festung auf einem Hügel, in der eine Generation später die päpstliche Investitur von Robert Guiscard stattfinden sollte.',
      },
    },
    anchorYear: 1042,
  },
  {
    ...
    copy: {
      ...
      body: {
        ...
        de: 'William Bras-de-Fer starb um 1046, wahrscheinlich in seinen Vierzigern, nachdem er kaum vier Jahre lang die Grafschaft Apulien innehatte. Seine Regierungszeit war kurz, aber der Präzedenzfall war unumkehrbar: Die Normannen hielten nun Gebiete in Süditalien nicht als Söldner, sondern als Herren. Seine Brüder Drogon und dann Onfroy folgten ihm nach, und nach Onfroy kam der sechste Sohn – Robert, bekannt als Guiscard – der die Familiengrafschaft Apulien in ein Mittelmeerreich verwandeln sollte. Alle folgenden Heldentaten der Hautevilles – das Königreich Sizilien, das Fürstentum Antiochia, der multikulturelle Hof von Roger II. – gingen von dem Stützpunkt aus, den William Bras-de-Fer mit dem Schwert erobert hatte.',
      },
    },
    anchorYear: 1046,
  },
  ...
  // ── Sichelgaita lifetime guided arc ──────────────────────────────
  {
    ...
    copy: {
      ...
      body: {
        ...
        de: 'Sichelgaita wurde um 1040 als Tochter von Guaimar IV., dem lombardischen Fürsten von Salerno, einem der letzten unabhängigen lombardischen Staaten in Süditalien, geboren. Sie wuchs in einer Stadt auf, die für ihre medizinische Fakultät, ihre Handelsbeziehungen und ihre prekäre Unabhängigkeit zwischen byzantinischen, arabischen und normannischen Ambitionen berühmt war. Im Gegensatz zu den meisten Adligen ihrer Zeit wurde sie in Waffen ausgebildet – eine lombardische Tradition des Fürstenhauses von Salerno, die ihr außergewöhnliches Leben prägen sollte.',
      },
    },
    anchorYear: 1040,
  },
  {
    ...
    copy: {
      ...
      body: {
        ...
        de: 'Um 1058 heiratete Sichelgaita Robert Guiscard, der sich von seiner ersten Frau Alberada scheiden ließ, um das Bündnis zu besiegeln. Die Heirat war von strategischer Bedeutung: Sie verschaffte Robert Legitimität unter der lombardischen Bevölkerung, die er eroberte, und bot Salerno einen mächtigen Beschützer. Doch die Partnerschaft ging über die Politik hinaus. Sichelgaita begleitete Robert im Feldzug, kommandierte selbst Truppen und wurde sein vertrauenswürdigster Berater. Die Ehe hatte auch ein politisches Opfer: Roberts ältester Sohn Bohemond wurde nun zugunsten von Sichelgaitas Sohn Roger Borsa aus der Thronfolge ausgeschlossen.',
      },
    },
    anchorYear: 1058,
  },
  {
    ...
    copy: {
      ...
      body: {
        ...
        de: 'Zeitgenössische Chronisten beschreiben Sichelgaita mit Begriffen, die normalerweise Kriegern vorbehalten sind. Sie trug volle Rüstung, ritt an der Spitze der Truppen und war bei mehreren Belagerungen während der normannischen Eroberung Süditaliens anwesend. Anna Komnena, die byzantinische Prinzessin-Historikerin, verglich sie mit Athene – ein Vergleich, der Bewunderung und Entsetzen vereint. Zu einer Zeit, als von Adligen erwartet wurde, dass sie Haushalte regieren und für die Seelen ihrer Ehemänner beten, herrschte Sichelgaita über Provinzen und kämpfte für das Reich ihres Mannes.',
      },
    },
    anchorYear: 1071,
  },
  {
    ...
    copy: {
      ...
      body: {
        ...
        de: 'In der Schlacht von Durazzo im Jahr 1081 ging Sichelgaitas Rolle mit ungewöhnlicher Klarheit in die historischen Aufzeichnungen ein. Als die normannischen Truppen unter einem byzantinischen Gegenangriff unter der Führung der Warägergarde zu schwächeln begannen, soll Sichelgaita die flüchtenden Soldaten versammelt haben, indem er einen Speer schwang und sie zur Ordnung rief. Der Bericht über Anne Comnena – eine Feindin gegenüber den Normannen, aber Respekt vor dem Mut von Sichelgaita – beschreibt sie als „eine zweite Pallas“, die an der Spitze ihrer Truppen reitet. Die Normannen formierten sich neu und gewannen die Schlacht. Dies ist einer der detailliertesten Berichte über eine mittelalterliche Frau im Kampf.',
      },
    },
    anchorYear: 1081,
  },
  {
    ...
    copy: {
      ...
      body: {
        ...
        de: 'Als Robert Guiscard 1085 in Kefalonia starb, hielt die Nachfolge, die er mit Sichelgaita vereinbart hatte, knapp an. Ihr Sohn Roger Borsa erbte das Herzogtum auf Kosten von Bohemond, Roberts Erstgeborener von Alberada. Sichelgaita hatte Jahre damit verbracht, die Allianzen und die päpstliche Unterstützung aufzubauen, die dies ermöglichten. Sie war es, die von Papst Gregor VII. die Anerkennung der Rechte von Roger Borsa erlangte. Bohemond, der größte Krieger, fand sich mit Tarentum und einem brennenden Groll wieder, der ihn zum Ersten Kreuzzug treiben würde – und dazu, sein eigenes Fürstentum am Rande der bekannten Welt zu errichten.',
      },
    },
    anchorYear: 1085,
  },
  {
    ...
    copy: {
      ...
      body: {
        ...
        de: 'Sichelgaita starb um 1090, wahrscheinlich in Salerno. Sie war Prinzessin, Ehefrau, Kriegerin, Diplomatin und De-facto-Regentin gewesen. Dennoch erscheint sie in den meisten Geschichten nur als Fußnote in Robert Guiscards Karriere – wenn sie überhaupt auftaucht. Die Quellen, in denen sie erwähnt wird, sind fast ausschließlich feindselig: Anne Comnena schrieb als byzantinische Feindin, und lateinische Chronisten behandelten Frauen selten ausführlich. Was erhalten bleibt, reicht aus, um sie als eine der ganz wenigen dokumentierten weiblichen Kriegsherrinnen des Mittelalters zu kennzeichnen – und eine Erinnerung daran, dass die normannische Welt komplexer war, als ihre von Männern dominierten Chroniken vermuten lassen.',
      },
    },
    anchorYear: 1090,
  },
  ...
  // ── Odo of Bayeux lifetime guided arc ────────────────────────────
  {
    ...
    copy: {
      ...
      body: {
        ...
        de: 'Odon war der Halbbruder von Wilhelm, Herzog der Normandie – Sohn von Herleva und Herluin de Conteville. Um 1049, als er kaum zwanzig war, ernannte ihn Wilhelm zum Bischof von Bayeux. Die Ernennung erfolgte unter politischer Schirmherrschaft: Odon war zu jung, zu schlecht ausgebildet und zu offensichtlich dazu bestimmt, den Interessen der Familie zu dienen. Aber die normannische Kirche stand unter herzoglicher Autorität, und Wilhelm brauchte in jedem Machtzentrum loyale Männer. Bayeux war mit seiner Kathedrale und seiner strategischen Lage im Bessin einer der wichtigsten Sitze des Herzogtums.',
      },
    },
    anchorYear: 1049,
  },
  {
    ...
    copy: {
      ...
      body: {
        ...
        de: 'Als Wilhelm im September 1066 den Ärmelkanal überquerte, überquerte Odo ihn mit. In der Schlacht von Hastings am 14. Oktober kämpfte er – oder befehligte zumindest – trotz seines bischöflichen Status. Das kanonische Recht verbot Geistlichen, Blut zu vergießen, daher soll Odo der Überlieferung zufolge eher einen Streitkolben als ein Schwert geführt haben: stumpf statt schneidend, eine Unterscheidung, die dem Buchstaben des Gesetzes entsprach, seinen Geist jedoch außer Acht ließ. Ob dieses Detail nun wahr ist oder nicht, Odon war auf dem Schlachtfeld anwesend, sammelte die Truppen und koordinierte die Reserve. Der Teppich von Bayeux zeigt ihn in Rüstung, mit einem Knüppel in der Hand, mitten im Geschehen.',
      },
    },
    anchorYear: 1066,
  },
  {
    ...
    copy: {
      ...
      body: {
        ...
        de: 'William belohnte Odon großzügig. Er wurde Earl of Kent – ​​die Grafschaft, die Dover kontrollierte, den kürzesten Übergang zur Normandie und das Tor nach London. Zur Zeit des Domesday Book im Jahr 1086 besaß Odo mehr Land in England als jeder andere außer dem König selbst. Während Wilhelms Abwesenheit in der Normandie regierte er England als Regent und übte sowohl weltliche als auch kirchliche Autorität aus – eine Kombination, die nirgendwo sonst in der Christenheit undenkbar wäre. Halb Priester, halb Kriegsherr – die Verkörperung normannischer Energie.',
      },
    },
    anchorYear: 1067,
  },
  {
    ...
    copy: {
      ...
      body: {
        ...
        de: 'Während William zwischen der Normandie und England hin- und herpendelte, regierte Odo in seiner Abwesenheit – er schlug Aufstände nieder, sprach Recht und erhob Steuern mit einer Effizienz, die ihm sowohl Respekt als auch Hass einbrachte. Er war kein sanfter Herrscher. Als der Norden Englands rebellierte, gehörte Odo zu denen, die 1069–70 Wilhelms verheerende „Verwüstung des Nordens“ durchführten, die große Gebiete Yorkshires entvölkerte. Er vereinte die moralische Autorität eines Bischofs und die Zwangsgewalt eines Grafen und nutzte beides ohne zu zögern.',
      },
    },
    anchorYear: 1070,
  },
  {
    ...
    copy: {
      ...
      body: {
        ...
        de: 'Der Teppich von Bayeux – ein 70 Meter langer gestickter Bericht über die normannische Eroberung – wird traditionell dem Patronat von Odo zugeschrieben und wahrscheinlich für die Weihe der Kathedrale von Bayeux im Jahr 1077 in Auftrag gegeben. Odo erscheint auf seinen Tafeln mehrmals, immer in einem günstigen Licht: Er segnet das Mahl vor Hastings, versammelt die Truppen und ist in jedem entscheidenden Moment anwesend. Ob er es tatsächlich in Auftrag gegeben hat, bleibt umstritten, aber die Betonung seiner Rolle im Wandteppich ist unbestreitbar. Es ist eines der wichtigsten historischen Dokumente des Mittelalters – und obwohl Odon es in Auftrag gegeben hat, ist es auch eines der raffiniertesten politischen Propagandastücke, die jemals gewebt wurden.',
      },
    },
    anchorYear: 1077,
  },
  {
    ...
    copy: {
      ...
      body: {
        ...
        de: 'Im Jahr 1082 ließ Wilhelm Odo – seinen eigenen Halbbruder – unter dem Vorwurf verhaften, er habe eine unerlaubte Militärexpedition nach Italien geplant, möglicherweise um selbst das Papsttum zu erwirken. Die Verhaftung war dramatisch: William bestand darauf, dass er nicht den Bischof von Bayeux (was eine päpstliche Autorität erfordert hätte), sondern den Earl of Kent (was eine Angelegenheit königlicher Vorrechte war) einsperrte. Odon verbrachte fünf Jahre im Gefängnis. Nach Williams Tod im Jahr 1087 freigelassen, rebellierte er zugunsten von Robert Courteheuse gegen William Red, wurde besiegt und endgültig aus England vertrieben. Er starb während des Ersten Kreuzzugs in Palermo im Februar 1097 – ein würdiges Ende für einen Mann, der sein Leben an der Schnittstelle von Krieg, Religion und Macht verbracht hatte.',
      },
    },
    anchorYear: 1082,
  },
  ...
  // ── Hereward the Wake lifetime guided arc ────────────────────────
  {
    ...
    copy: {
      ...
      body: {
        ...
        de: 'Vor 1066 war England ein wohlhabendes angelsächsisches Königreich – sein Reichtum zeigte sich in seinen Kirchen, seinen Steuerunterlagen und seinem ausgeklügelten System der lokalen Verwaltung. Das Danelaw war längst absorbiert, aber das skandinavische Erbe blieb tief in den östlichen Grafschaften verankert. Männer wie Hereward – wahrscheinlich ein kleiner Thegn aus Lincolnshire – lebten in einer Welt, in der sich englische, dänische und norwegische Einflüsse frei vermischten. Das Land war reich, das Gesetz wurde eingeführt und der Frieden des Königs gewahrt. Es war eine Welt am Rande der Zerstörung.',
      },
    },
    anchorYear: 1060,
  },
  {
    ...
    copy: {
      ...
      body: {
        ...
        de: 'Als Wilhelm in Hastings siegte und am Weihnachtstag 1066 gekrönt wurde, brach die politische Ordnung Englands zusammen. In den nächsten fünf Jahren wurde die gesamte angelsächsische Aristokratie systematisch durch normannische Herren ersetzt. Die Ländereien wurden beschlagnahmt, die englischen Thegns auf den Rang von Pächtern auf ihrem eigenen Land reduziert und eine neue französischsprachige herrschende Klasse setzte ihren Willen durch den Bau von Burgen, Forstgesetzen und die Neuverteilung aller großen Ländereien im Königreich durch. Für Männer wie Hereward war die Eroberung kein fernes politisches Ereignis – sie bedeutete den persönlichen Ruin.',
      },
    },
    anchorYear: 1066,
  },
  {
    ...
    copy: {
      ...
      body: {
        ...
        de: 'Herewards frühes Leben ist von Legenden umhüllt und es ist schwierig, Fakten von Fiktionen zu trennen. Er wurde möglicherweise vor der Eroberung verbannt und kehrte um 1069 zurück, um festzustellen, dass die Ländereien seiner Familie von den Normannen beschlagnahmt worden waren. Dokumentiert ist, dass er im Jahr 1070 zum Anführer des englischen Widerstands in den Sümpfen Ostenglands wurde – einer Landschaft aus Sümpfen, Inseln und Wasserstraßen, die einen konventionellen normannischen Kavalleriekrieg nahezu unmöglich machte. Die Chronik der Peterborough Abbey berichtet über seinen Überfall auf die Abtei im Jahr 1070, um zu verhindern, dass ihre Reichtümer in normannische Hände fallen.',
      },
    },
    anchorYear: 1069,
  },
  {
    ...
    copy: {
      ...
      body: {
        ...
        de: 'Die Sümpfe um Ely bildeten eine natürliche Festung. Kilometerlanges überschwemmtes Land, das nur von denen befahrbar war, die die verborgenen Dammwege kannten, umgab die Isle of Ely – eine Insel aus trockenem Land, die von der großen Abtei verankert wurde. Hereward und seine Anhänger ließen sich dort nieder, zusammen mit enteigneten englischen Thegns, dänischen Plünderern und Mönchen, die sich der normannischen Autorität widersetzten. Über ein Jahr lang hielten die Sümpfe stand. Normannische Kavallerie war in den Sümpfen nutzlos, und die Garnison der Insel konnte nicht ausgehungert werden, solange sie die Wasserstraßen kontrollierte.',
      },
    },
    anchorYear: 1070,
  },
  {
    ...
    copy: {
      ...
      body: {
        ...
        de: 'Im Jahr 1071 marschierte Wilhelm mit der ganzen Kraft des normannischen Militärgenies gegen Ely. Er ordnete den Bau eines Damms über die Sümpfe an – eine gewaltige Bauleistung in lebensfeindlichem Gelände. Der erste Versuch scheiterte: Die Fahrbahn stürzte unter der Last der gepanzerten Männer und Pferde ein. William versuchte es erneut, indem er Belagerungstürme vorrückte und einen Frontalangriff versuchte. Der englische Widerstand hielt monatelang durch. Schließlich handelten die Mönche von Ely – angesichts der Zerstörung ihrer Abtei – eine Kapitulation aus und offenbarten den Normannen offenbar einen sicheren Weg durch die Sümpfe. Hereward selbst entkam. Was als nächstes mit ihm geschah, ist unbekannt.',
      },
    },
    anchorYear: 1071,
  },
  {
    ...
    copy: {
      ...
      body: {
        ...
        de: 'Nach Ely verschwand Hereward aus den historischen Aufzeichnungen. Spätere mittelalterliche Quellen – die Gesta Herewardi, zusammengestellt im 12. Jahrhundert – verwandelten ihn in eine romantische Outlaw-Figur: einen Guerillaführer, der die Normannen aus den Sümpfen schikanierte, einen Proto-Robin Hood, der für die Enteigneten kämpfte. Wie viel Wahrheit in dieser Legende steckt, lässt sich nicht sagen. Was zählt, ist, dass die Legende fortbesteht – ein Beweis dafür, dass das Trauma der normannischen Eroberung von den Engländern nie ganz vergessen wurde und dass der Widerstand, selbst wenn er besiegt wurde, zu einem Prüfstein der englischen Identität wurde.',
      },
    },
    anchorYear: 1075,
  },
  {
    ...
    copy: {
      ...
      body: {
        ...
        de: 'Die normannische Eroberung war die erfolgreichste militärische Machtübernahme in der mittelalterlichen europäischen Geschichte. Innerhalb von zwanzig Jahren wurde eine ganze Aristokratie ersetzt, der herrschenden Klasse eine neue Sprache aufgezwungen und die Landschaft durch Burgen, Kathedralen und Waldreservate umgestaltet. Das Domesday Book von 1086 dokumentiert die Übertragung bis ins kleinste Detail. Aber jede Eroberung hat zwei Geschichten. Herewards Widerstand, so kurz und letztendlich vergeblich er auch war, stellt die englische Erfahrung der Eroberung dar: Enteignung, Widerstand, Niederlage und die langsame, langwierige Anpassung an eine neue Ordnung, deren vollständige Absorption Jahrhunderte dauern würde.',
      },
    },
    anchorYear: 1086,
  },
  ...
  // ── Henry I — the lion of justice ────────────────────────────────
  {
    ...
    copy: {
      ...
      body: {
        ...
        de: 'Am 2. August 1100 wurde William Redhead bei der Jagd im New Forest durch einen Pfeil getötet. Mord oder Unfall, die Debatte bleibt offen. Sein jüngerer Bruder Henry galoppierte sofort nach Winchester, beschlagnahmte den königlichen Schatz und ließ sich innerhalb von drei Tagen in Westminster krönen. Geschwindigkeit war entscheidend: Sein älterer Bruder Robert Courteheuse kehrte mit einem soliden Anspruch vom Ersten Kreuzzug zurück. Heinrichs Putsch sicherte die englische Krone einem Herrscher, der die königliche Verwaltung umgestalten würde.',
      },
    },
    anchorYear: 1100,
  },
  {
    ...
    copy: {
      ...
      body: {
        ...
        de: 'Bei seiner Krönung gab Heinrich eine Charta heraus, in der er versprach, den Missbräuchen von William Red ein Ende zu setzen – willkürliche Besteuerung, Ausbeutung kirchlicher Ländereien und repressive Forstgesetze. Es war das erste Mal, dass ein englischer König eine schriftliche Verpflichtung gegenüber seinen Untertanen einging. Die Charta war eine Frage des politischen Kalküls, nicht des Idealismus: Heinrich brauchte die Unterstützung der Barone gegen seinen Bruder. Aber der Präzedenzfall war wichtig. Ein Jahrhundert später zitierten die Barone, die die Magna Carta verfassten, die Charta Heinrichs I. als Vorbild.',
      },
    },
    anchorYear: 1100,
  },
  {
    ...
    copy: {
      ...
      body: {
        ...
        de: 'Im Jahr 1106 fiel Heinrich in die Normandie ein und besiegte Robert Courteheuse in der Schlacht von Tinchebray. Robert wurde gefangen genommen und für die restlichen 28 Jahre seines Lebens eingesperrt. Zum ersten Mal seit dem Tod des Eroberers waren England und die Normandie unter einem einzigen Herrscher vereint. Heinrich regierte beide mit eiserner Faust, überquerte unermüdlich den Ärmelkanal und verbrachte mehr Zeit in der Normandie als jeder seiner Vorgänger. Der von Wilhelm I. erbaute Ärmelkanalstaat wurde wiederhergestellt – und dieses Mal würde er von dem effektivsten Verwalter geführt, den das mittelalterliche Europa gekannt hatte.',
      },
    },
    anchorYear: 1106,
  },
  {
    ...
    copy: {
      ...
      body: {
        ...
        de: 'Heinrich I. baute die fortschrittlichste königliche Verwaltung in Westeuropa auf. Die Staatskasse – benannt nach dem karierten Tuch, auf dem die Konten abgerechnet wurden – wurde zu einer ständigen Institution in Winchester und prüfte jeden Penny, der der Krone geschuldet wurde. Königliche Richter reisten durch England und setzten das Gesetz des Königs an herrschaftlichen Gerichten durch. Roger von Salisbury, Heinrichs oberster Minister, schuf eine Bürokratie, die in der Lage war, auch in der Abwesenheit des Königs in der Normandie zu regieren. Es handelte sich um eine Regierung nach System und nicht nach Persönlichkeit – und sie würde die Dynastie, die sie aufgebaut hatte, überdauern.',
      },
    },
    anchorYear: 1110,
  },
  {
    ...
    copy: {
      ...
      body: {
        ...
        de: 'In der Nacht des 25. November 1120 prallte die Blanche-Nef beim Verlassen des Hafens von Barfleur gegen einen Felsen und sank im Ärmelkanal. Unter den Toten war Guillaume Adelin, Heinrichs einziger legitimer Sohn und Erbe. Der Chronist Orderic Vital schrieb, dass Henry nie wieder lächelte. Die Katastrophe zerstörte den Nachfolgeplan, an dem Henri zwanzig Jahre lang gearbeitet hatte. Er zwang seine Barone, seiner Tochter Mathilde die Treue zu schwören – ein beispielloser Schritt, der den Grundstein für einen Bürgerkrieg legen würde. Ein einziger Schiffbruch veränderte den Lauf der englischen Geschichte.',
      },
    },
    anchorYear: 1120,
  },
  {
    ...
    copy: {
      ...
      body: {
        ...
        de: 'Heinrich I. starb am 1. Dezember 1135 in Lyons-la-Forêt in der Normandie, weil er angeblich zu viele Neunaugen gegessen hatte. Er hatte 35 Jahre lang regiert – die längste Regierungszeit aller normannischen Könige. Ihr Tod löste genau die Krise aus, die er befürchtet hatte. Trotz der Mathilde geschworenen Eide überquerte Stephan von Blois den Kanal und eroberte innerhalb weniger Wochen die Krone. Der von Heinrich aufgebaute Verwaltungsapparat würde überleben, aber die politische Ordnung, die er durch sein Testament aufrechterhalten hatte, brach zusammen. England würde in einen fast zwei Jahrzehnte währenden Bürgerkrieg stürzen.',
      },
    },
    anchorYear: 1135,
  },
  ...
  // ── The Anarchy — when the crown broke ──────────────────────────
  {
    ...
    copy: {
      ...
      body: {
        ...
        de: 'Als Heinrich I. im Dezember 1135 starb, handelte sein Neffe Stephan von Blois außerordentlich schnell. Er überquerte den Kanal, gewann die Unterstützung der Londoner und des Bischofs von Winchester und wurde am 22. Dezember in Westminster gekrönt – bevor Matilda reagieren konnte. Stephen war mutig, großzügig und persönlich freundlich, aber er besaß weder den eisernen Willen Heinrichs I. noch seinen Verwaltungsinstinkt. Seine Herrschaft sollte auf die Probe stellen, ob der anglonormannische Staat einen schwachen König überleben könnte.',
      },
    },
    anchorYear: 1135,
  },
  {
    ...
    copy: {
      ...
      body: {
        ...
        de: 'Im September 1139 landete Kaiserin Matilda mit einer kleinen Truppe, unterstützt von ihrem Halbbruder Robert von Gloucester, in England. England war geteilt. Der Westen und ein Großteil der Midlands erklärten sich für Matilda; der Südosten und London standen für Stephen. Ein Jahrzehnt lang gelang es keiner Seite, den entscheidenden Schlag zu versetzen. Burgen wechselten den Besitzer, Barone erwiderten ihre Treue und das Land litt darunter. Im Angelsaxon Chronicle heißt es: „Christus und seine Heiligen schliefen“ – die berühmteste Beschreibung der mittelalterlichen Anarchie in englischer Sprache.',
      },
    },
    anchorYear: 1139,
  },
  {
    ...
    copy: {
      ...
      body: {
        ...
        de: 'Am 2. Februar 1141 besiegten die Streitkräfte von Robert von Gloucester Stephens Armee in der Schlacht von Lincoln. Stephanus selbst wurde gefangen genommen – er wurde aus den Kämpfen gerissen, nachdem sein Schwert zerbrach und er von einem Stein getroffen wurde. Es ist das einzige Mal in der Geschichte des englischen Mittelalters, dass ein regierender König auf einem englischen Schlachtfeld gefangen genommen wurde. Mathilde schien kurz vor dem Sieg zu stehen. Sie marschierte nach London, um die Krone zu erringen.',
      },
    },
    anchorYear: 1141,
  },
  {
    ...
    copy: {
      ...
      body: {
        ...
        de: 'Die Londoner verjagten Mathilde, bevor sie gekrönt wurde. Der Krieg stellte sich erneut auf den Kopf. Im Dezember 1142 belagerte Stephen Matilda im Oxford Castle. Sie entkam in einer der berühmtesten Episoden des Krieges: Sie überquerte nachts die zugefrorene Themse, in Weiß gehüllt auf dem Schnee, mit nur drei oder vier Begleitern. Sie erreichte Wallingford und setzte den Kampf fort. Die Flucht wurde zum Symbol des gesamten Konflikts – dramatisch, unentschlossen und mit Gewalt allein nicht zu lösen.',
      },
    },
    anchorYear: 1142,
  },
  {
    ...
    copy: {
      ...
      body: {
        ...
        de: 'Nach dem plötzlichen Tod von Eustace, Stephans ältestem Sohn, im Jahr 1153 fanden die erschöpften Parteien schließlich einen Kompromiss. Der Vertrag von Winchester (auch Vertrag von Wallingford genannt) erkannte Stephen als König auf Lebenszeit an, ernannte jedoch Mathildes Sohn Henry Plantagenet zum Erben. Stephan starb am 25. Oktober 1154 und Heinrich II. folgte ihm ohne Widerstand nach. Die Anarchie war vorbei. Heinrich erbte ein angeschlagenes Königreich, aber auch den von Heinrich I. aufgebauten Verwaltungsapparat – eine Basis, auf der das Anjou-Reich aufgebaut werden sollte.',
      },
    },
    anchorYear: 1153,
  },
  ...
  // ── The March of Wales — castles on the frontier ────────────────
  {
    ...
    copy: {
      ...
      body: {
        ...
        de: 'William FitzOsbern, einer der engsten Gefährten Wilhelms des Eroberers, wurde zum Earl of Hereford ernannt und mit der Sicherung der walisischen Grenze beauftragt. Um 1067 begann er mit dem Bau von Chepstow Castle – einem großen steinernen Bergfried, der auf Kalksteinfelsen über dem Fluss Wye thront. Es war die älteste datierbare Steinburg Großbritanniens und trug eine Botschaft: Die Normannen waren hier, um zu bleiben. Von Chepstow aus drang FitzOsbern in Gwent ein und erzwang die normannische Herrschaft über eine Landschaft, die die Angelsachsen nie kontrolliert hatten.',
      },
    },
    anchorYear: 1067,
  },
  {
    ...
    copy: {
      ...
      body: {
        ...
        de: 'Robert FitzHamon eroberte Glamorgan um 1091 und baute in Cardiff eine Burgruine, die zum Anker der normannischen Macht in Südwales wurde. Der Marsch nach Süden ging schnell voran: Normannische Herren errichteten Burgen in Neath, Swansea und Kidwelly und errichteten Herrschaften in den fruchtbaren Küstenebenen, während walisische Fürsten das bergige Landesinnere behielten. Dieses Muster – normannische Ebenen, walisische Höhen – sollte die Mark von Wales zwei Jahrhunderte lang prägen.',
      },
    },
    anchorYear: 1091,
  },
  {
    ...
    copy: {
      ...
      body: {
        ...
        de: 'Im Norden drangen Hugh von Avranches (Hugh der Dicke), Earl of Chester, und sein Cousin Robert de Rhuddlan in den 1070er und 1080er Jahren tief nach Gwynedd vor. Robert baute eine Burg in Rhuddlan am Fluss Clwyd und stürmte bis nach Snowdonia. Aber der Vorstoß nach Norden war prekär. Im Jahr 1093 wurde Robert de Rhuddlan von einer Gruppe walisischer Räuber getötet, und die walisischen Prinzen von Gwynedd – insbesondere Gruffudd ap Cynan – führten einen generationenlangen Widerstandskrieg, der schließlich die normannische Grenze zurückdrängen sollte.',
      },
    },
    anchorYear: 1073,
  },
  {
    ...
    copy: {
      ...
      body: {
        ...
        de: 'Arnulf de Montgomery gründete Pembroke Castle im Jahr 1093 und verlagerte damit die normannische Grenze bis an die Südwestspitze von Wales. Pembroke wurde mehr als nur eine Grenzfestung: Es war der natürliche Einschiffungspunkt für Irland, und seine Herren – die Familie von Clare, die später den Titel Earl of Pembroke annahm – spielten eine zentrale Rolle bei der anglonormannischen Invasion in Irland. Die Burg, die Arnulf auf einem Kalksteinvorsprung mit Blick auf den Haven errichtete, blieb jahrhundertelang der strategische Schlüssel zur Irischen See.',
      },
    },
    anchorYear: 1093,
  },
  {
    ...
    copy: {
      ...
      body: {
        ...
        de: 'Mitte des 12. Jahrhunderts hatten die Waliser von ihren normannischen Gegnern gelernt. Owain Gwynedd, Prinz von Gwynedd von 1137 bis 1170, vereinte Nordwales und wehrte die normannischen Herren aus ihren tiefsten Tiefen ab. Im Jahr 1157 wehrte er die Invasion Heinrichs II. in den Wäldern von Gwynedd ab. Owain übernahm normannische Militärtechniken – Burgbau, schwere Kavallerie – und behielt dabei das walisische Recht und die walisische Sprache bei. Der Marsch wurde zu einer echten Grenze: keine Vorstoßlinie, sondern eine umkämpfte Zone, in der normannische und walisische Machtstrukturen nebeneinander existierten.',
      },
    },
    anchorYear: 1157,
  },
  {
    ...
    copy: {
      ...
      body: {
        ...
        de: 'Der Marsch von Wales war nie ein einzelner Feldzug, sondern ein zwei Jahrhunderte dauernder Prozess, der den Bau von Burgen, Mischehen, Aufstände und Unterbringung umfasste. Die normannischen Herren übernahmen walisische Bräuche; Die walisischen Fürsten übernahmen normannische Institutionen. Die Markherrschaften – halbunabhängige Gebiete, die weder vollständig unter die englische Krone noch unter walisisches Recht fielen – schufen einen politischen Flickenteppich, der im mittelalterlichen Europa einzigartig war. Die Grenze wurde erst mit der Eroberung durch Eduard I. in den 1280er Jahren geschlossen, aber die anglonormannische Prägung – in Burgen, Ortsnamen und Rechtstraditionen – ist bis heute in ganz Wales sichtbar.',
      },
    },
    anchorYear: 1170,
  },
  ...
  // ── Anglo-Norman Ireland — Strongbow and the crown ──────────────
  {
    ...
    copy: {
      ...
      body: {
        ...
        de: 'Bevor Normannen Irland betraten, war Dublin bereits eine der großen Handelsstädte der Welt an der Irischen See. Im 9. Jahrhundert als Wikinger-Longphort gegründet, entwickelte sich die Stadt zu einer hiberno-nordischen Stadt der Kaufleute, Handwerker und Kriegerkönige. Sein Hafen verband Irland mit den skandinavischen Netzen von York, Chester und der Isle of Man. Als anglonormannische Abenteurer in den 1160er Jahren begannen, über die Irische See nach Westen zu blicken, war Dublin der begehrte Preis für sie alle.',
      },
    },
    anchorYear: 1160,
  },
  {
    ...
    copy: {
      ...
      body: {
        ...
        de: 'Im Jahr 1166 wurde Diarmait Mac Murchada, König von Leinster, von einer Koalition rivalisierender irischer Könige unter der Führung von Ruaidrí Ua Conchobair von Connacht aus Irland vertrieben. Diarmait ging nach England und suchte Hilfe bei Heinrich II., der ihn ermächtigte, unter den anglonormannischen Herren der walisischen Mark zu rekrutieren. Diarmait fand eifrige Verbündete – ehrgeizige Marschbarone mit militärischem Fachwissen und Appetit auf Land. Der von ihm abgeschlossene Deal würde Irland jahrhundertelang für anglonormannische Interventionen öffnen.',
      },
    },
    anchorYear: 1166,
  },
  {
    ...
    copy: {
      ...
      body: {
        ...
        de: 'Im Mai 1169 landete die erste anglonormannische Streitmacht in der Nähe von Wexford – ein kleines Kontingent von Bogenschützen und Soldaten aus Pembroke. Sie nahmen Wexford schnell ein. Im folgenden Jahr traf Richard de Clare, Earl of Pembroke – mit dem Spitznamen Strongbow – mit einer viel größeren Armee ein. Er nahm Waterford ein, heiratete Aoife, die Tochter von Diarmait, und ihm wurde die Thronfolge von Leinster versprochen. Anglonormannische Kavallerie, Armbrustschützen und Burgenbautechniken überwältigten die irischen Streitkräfte, die an andere Formen der Kriegsführung gewöhnt waren.',
      },
    },
    anchorYear: 1170,
  },
  {
    ...
    copy: {
      ...
      body: {
        ...
        de: 'Im September 1170 stürmten Strongbows Streitkräfte Dublin und vertrieben die hiberno-nordische Garnison. Dies war der Wendepunkt. Dublin bot den Anglonormannen einen befestigten Hafen, ein Handelszentrum und das strategische Herz Ostirlands. Diarmait starb 1171 und Strongbow beanspruchte Leinster. Die Geschwindigkeit und das Ausmaß der anglonormannischen Machtübernahme beunruhigten Heinrich II., der sah, wie sein eigener Vasall eine unabhängige Macht wurde. Der König beschloss, persönlich einzugreifen.',
      },
    },
    anchorYear: 1170,
  },
  {
    ...
    copy: {
      ...
      body: {
        ...
        de: 'Im Oktober 1171 landete Heinrich II. mit einer riesigen Armee in Waterford – der erste englische König, der irischen Boden betrat. Sein Ziel war nicht Eroberung, sondern Kontrolle: Er kam, um die königliche Autorität über Strongbow und die anderen anglonormannischen Herren zu behaupten und die Unterwerfung der irischen Könige zu erhalten. Die meisten unterwarfen sich kampflos und akzeptierten Heinrich als Oberherrn. Dublin wurde der Krone zugesprochen. Heinrich gründete die Lordship of Ireland – eine Verfassungsvereinbarung, die Irland acht Jahrhunderte lang an die englische Krone binden sollte.',
      },
    },
    anchorYear: 1171,
  },
  {
    ...
    copy: {
      ...
      body: {
        ...
        de: 'Im Jahr 1175 schlossen Heinrich II. und Ruaidrí Ua Conchobair, der letzte anerkannte Hochkönig Irlands, den Vertrag von Windsor. Ruaidrí erkannte Heinrich als Oberherrn an und behielt die Autorität über den gälischen Westen, während die anglonormannischen Herren Leinster, Meath und die skandinavischen Hafenstädte behielten. Auf dem Papier zog der Vertrag eine Grenze zwischen zwei Irland – einem anglonormannischen und einem gälischen. In der Praxis respektierte keine Seite die Grenze lange, aber der Vertrag brachte eine Teilung zum Ausdruck, die die irische Politik jahrhundertelang verfolgen sollte.',
      },
    },
    anchorYear: 1175,
  },
  {
    ...
    copy: {
      ...
      body: {
        ...
        de: 'Im Jahr 1177 startete der anglonormannische Ritter John de Courcy mit einer kleinen Streitmacht eine unerlaubte Invasion in Ulster. Er besiegte den örtlichen König Ruaidrí Mac Duinn Sléibe, eroberte Downpatrick und baute dann eine große Burg in Carrickfergus am Belfast Lough – die mächtigste anglonormannische Festung in Irland. De Courcy baute im Nordosten eine quasi unabhängige Herrschaft auf, importierte Siedler, gründete Klöster und prägte seine eigene Währung. Sein Abenteuer zeigte, dass die anglonormannische Expansion in Irland sowohl von individuellen Ambitionen als auch von der königlichen Politik vorangetrieben wurde.',
      },
    },
    anchorYear: 1177,
  },
  {
    ...
    copy: {
      ...
      body: {
        ...
        de: 'Im Jahr 1185 schickte Heinrich II. seinen jüngsten Sohn John als Lord of Ireland nach Irland – das erste Mitglied der englischen Königsfamilie, das diesen Titel trug. John war neunzehn Jahre alt und der Besuch war eine Katastrophe: Er entfremdete sowohl die irischen Könige als auch die anglonormannischen Kolonisten. Doch die institutionelle Maschinerie, die er mitbrachte – königliche Richter, eine Kanzlei, die Anfänge der Kreisverwaltung – pflanzte Samen, die seine Demütigung überdauern würden. Als John 1210 als König zurückkehrte, sollte der von ihm auferlegte Verwaltungsrahmen die englische Regierungsführung in Irland für Generationen prägen.',
      },
    },
    anchorYear: 1185,
  },
  {
    ...
    copy: {
      ...
      body: {
        ...
        de: 'Im Jahr 1210 marschierte König John mit der größten königlichen Armee, die jemals auf der Insel gesehen wurde, nach Irland ein. Seine Ziele waren nicht die gälischen Iren, sondern seine eigenen Barone: Hugh de Lacy, der die Grafschaft Ulster an sich gerissen hatte, und William de Braose, ein Flüchtling vor der englischen Justiz. John marschierte nach Norden, vertrieb de Lacy und zwang jeden anglonormannischen Lord zur Unterwerfung. Er erließ das englische Recht neu, baute königliche Schlösser in Dublin und anderswo und straffte die Zügel der königlichen Regierung. Die Expedition stellte fest, dass die Herrschaft Irlands eine Abhängigkeit der englischen Krone war und kein Spielplatz für freiherrliche Abenteurer.',
      },
    },
    anchorYear: 1210,
  },
  {
    ...
    copy: {
      ...
      body: {
        ...
        de: 'Im Jahr 1315 landete Edward Bruce – der Bruder von Robert Bruce von Schottland – mit einer schottischen Armee in Carrickfergus und erklärte sich selbst zum König von Irland. Drei Jahre lang verwüstete er die anglonormannische Kolonie, besiegte die englischen Streitkräfte mehrmals und marschierte bis nach Limerick. Die Invasion fiel mit der Großen Hungersnot von 1315–17 zusammen, und die kombinierte Verwüstung erschütterte die anglonormannische Macht außerhalb der Ostküste. Edward Bruce wurde 1318 in der Schlacht von Faughart in der Nähe von Dundalk getötet, aber die Kolonie erholte sich nie vollständig. Die Invasion markierte den Beginn des gälischen Wiederauflebens, das nach und nach die englische Kontrolle untergraben sollte.',
      },
    },
    anchorYear: 1316,
  },
  {
    ...
    copy: {
      ...
      body: {
        ...
        de: 'Im Jahr 1366 traf sich das irische Parlament in Kilkenny und verabschiedete das berühmteste Gesetz des mittelalterlichen Irlands. Die Kilkenny-Statuten untersagten englischen Siedlern, Irisch zu sprechen, irische Kleidung anzunehmen, mit Iren zu heiraten oder das Brehon-Gesetz anzuwenden. Die Statuten waren eine panische Reaktion auf die Gälisierung der anglonormannischen Siedler – ein Beweis dafür, dass die Kolonie ihre eindeutige Identität verlor. In der Praxis waren die Statuten außerhalb des Pale nicht anwendbar, aber sie formalisierten die kulturelle Grenze zwischen dem „englischen Irland“ und dem „gälischen Irland“, die die Politik der Insel bis weit in die Neuzeit hinein bestimmen sollte.',
      },
    },
    anchorYear: 1366,
  },
  {
    ...
    copy: {
      ...
      body: {
        ...
        de: 'Zwei Jahrhunderte nach Strongbows Landung war die anglonormannische Kolonie auf einen Streifen der Ostküste – den Pale um Dublin – und eine Handvoll befestigter Städte geschrumpft. Der Westen und der Norden waren fest gälisch; zwischen den beiden sprachen Familien, die als Eroberer kamen, nun Irisch, folgten dem Brehon-Gesetz und verbündeten sich mit gälischen Dynastien. Sie wurden, wie der berühmte Ausdruck sagt, „irischer als die Iren selbst“. Der normannische Einfluss blieb in Burgen, Stadtrechten, Gewohnheitsrecht und der Idee, dass Irland eine Herrschaft der englischen Krone sei – ein Erbe, das die problematischen Beziehungen der Insel zu England über Jahrhunderte hinweg prägen sollte.',
      },
    },
    anchorYear: 1400,
  },
  ...
  // ── David I — the Norman king of Scots ──────────────────────────
  {
    ...
    copy: {
      ...
      body: {
        ...
        de: 'David, jüngster Sohn von Malcolm III. und der englischen Prinzessin Margaret, verbrachte seine prägenden Jahre am Hofe Heinrichs I. von England. Er nahm die anglonormannische Kultur auf – Feudalherrschaft, Klosterreform, Burgbau, Ritterrituale. Als er nach Schottland zurückkehrte, zunächst als Earl of Huntingdon und dann als König im Jahr 1124, brachte er eine Vision mit, wie ein Königreich regiert werden sollte. Er brachte auch anglonormannische Anhänger mit, die zu einigen der mächtigsten Familien Schottlands werden sollten: Bruce, Stewart, Comyn, Balliol.',
      },
    },
    anchorYear: 1100,
  },
  {
    ...
    copy: {
      ...
      body: {
        ...
        de: 'David I. veränderte Schottland durch anglonormannische Institutionen. Er gründete oder förderte mindestens fünfzehn große Klöster – Jedburgh, Kelso, Melrose, Holyrood, Dunfermline – und importierte Mönche aus England und Frankreich. Er schuf königliche Städte mit Handelsprivilegien, führte ein feudales Landsystem mit Ritterlehen und Baronien ein und etablierte ein System von Sheriffs und königlichen Richtern nach dem Vorbild der englischen Staatskasse. Schottlands bestehende gälische und skandinavische Institutionen wurden nicht zerstört, sondern durch einen Verwaltungsrahmen im normannischen Stil überlagert.',
      },
    },
    anchorYear: 1128,
  },
  {
    ...
    copy: {
      ...
      body: {
        ...
        de: 'Im Jahr 1138, während der Anarchie, fiel David in Nordengland ein, um seine Nichte Matilda zu unterstützen. Am 22. August wurde seine Armee in Northallerton von einer englischen Streitmacht besiegt, die sich um einen Fahnenmast versammelte, der die Banner der Heiligen des Nordens – die „Standarte“ – trug. Die Ironie war offensichtlich: Anglonormannische Ritter kämpften auf beiden Seiten. Zu Davids Armee gehörten normannische Herren seines eigenen Hofes sowie gälische Heere aus den Highlands. Die Schlacht zeigte, wie weit die anglonormannische Militärkultur in Schottland eingedrungen war – und wie die Anarchie die Grenze zwischen englischer und schottischer Politik verwischt hatte.',
      },
    },
    anchorYear: 1138,
  },
  {
    ...
    copy: {
      ...
      body: {
        ...
        de: 'David I. starb 1153 in Carlisle. Historiker nennen seine Herrschaft die „Davidianische Revolution“ – die konzentrierteste Periode institutioneller Veränderungen in der schottischen Geschichte. Die anglonormannischen Familien, die er in Schottland niederließ – Bruce in Annandale, Stewart in Renfrewshire, Balliol in Galloway – kämpften jahrhundertelang um die schottische Krone. Die von ihm geschaffenen Klöster, Marktstädte und Verwaltungsstrukturen bildeten das Rückgrat des mittelalterlichen schottischen Staates. Schottland wurde nicht von den Normannen erobert; Es wurde von einem schottischen König umgestaltet, der ihre Methoden gelernt hatte.',
      },
    },
    anchorYear: 1153,
  },
  ...
  // ── William the Lion — Scotland and the Angevins ────────────────
  {
    ...
    copy: {
      ...
      body: {
        ...
        de: 'William wurde 1165 im Alter von 22 Jahren König von Schottland und trat die Nachfolge seines Bruders Malcolm IV. an. Er erbte die anglonormannischen Institutionen von David I. und den Anspruch seines Großvaters auf die Grafschaft Northumbria – ein Anspruch, der die schottische Außenpolitik während seiner gesamten Regierungszeit leiten sollte. Wilhelm war energisch, hartnäckig und entschlossen, die nördlichen Grafschaften Englands zurückzugewinnen, die David I. während der Anarchie gehalten hatte, die Heinrich II. Malcolm IV. aber aufgeben musste. Schottland war unter Wilhelm ein feudales Königreich mit Blick nach Süden.',
      },
    },
    anchorYear: 1165,
  },
  {
    ...
    copy: {
      ...
      body: {
        ...
        de: 'Im Jahr 1174 fiel Wilhelm während des Großen Aufstands gegen Heinrich II. in Nordengland ein. Als er am 13. Juli Alnwick Castle im Nebel belagerte, wurde er von einer englischen Streitmacht überrascht und gefangen genommen. Ein schottischer König wird von den Engländern in Ketten gelegt – eine beispiellose Demütigung. Wilhelm wurde in die Normandie gebracht, wo Heinrich ihn zwang, den Vertrag von Falaise zu unterzeichnen. Schottland wurde ein feudaler Vasall Englands, seine Burgen wurden mit englischen Truppen besetzt, seine Kirche wurde Canterbury unterstellt. Der Vertrag legte die härtesten Bedingungen fest, die jemals ein schottischer König akzeptiert hatte.',
      },
    },
    anchorYear: 1174,
  },
  {
    ...
    copy: {
      ...
      body: {
        ...
        de: 'Im Jahr 1189 brauchte der neue englische König Richard I. Geld für den Dritten Kreuzzug. Wilhelm nutzte die Gelegenheit: Er zahlte Richard 10.000 Mark Silber – eine enorme Summe –, um den Vertrag von Falaise aufzukündigen. Der Canterbury Quitclaim stellte die Unabhängigkeit Schottlands wieder her und befreite die Church of Scotland von der englischen Kontrolle. Es war ein meisterhafter diplomatischer Coup, der zu einem Preis erkauft wurde, den sich William kaum leisten konnte. Schottland war wieder frei, aber die zugrunde liegende Spannung zwischen den beiden Königreichen – englische Ansprüche auf Oberherrschaft, schottisches Beharren auf Souveränität – sollte die anglo-schottischen Beziehungen jahrhundertelang bestimmen.',
      },
    },
    anchorYear: 1189,
  },
  {
    ...
    copy: {
      ...
      body: {
        ...
        de: 'Wilhelm der Löwe regierte 49 Jahre lang – die längste Regierungszeit aller mittelalterlichen schottischen Könige – und starb im Jahr 1214. Sein Schottland war in seinen Institutionen zutiefst anglonormannisch: feudale Herrschaft, Township-Urkunden, Augustiner- und Zisterzienserabteien, königliche Justiz, die von Sheriffs verwaltet wurde. Dennoch blieb es ein eigenständiges Königreich mit eigenen Gesetzen, eigener Kirche und eigener Identität. Die anglonormannische Transformation Schottlands war keine Kolonisierung, sondern eine Adoption – eine herrschende Klasse wählte normannische Methoden, um einen stärkeren Staat aufzubauen. Die Familien, die William niederließ, und die Institutionen, die er stärkte, sollten Schottland durch die Unabhängigkeitskriege und darüber hinaus tragen.',
      },
    },
    anchorYear: 1214,
  },
  ...
  // ── Thomas Becket — murder in the cathedral ─────────────────────
  {
    ...
    copy: {
      ...
      body: {
        ...
        de: 'Thomas Becket stieg aus dem Londoner Handelsbürgertum auf und wurde 1155 Kanzler Heinrichs II. – der mächtigste Minister Englands. Er war alles, was der junge König brauchte: brillant, unermüdlich und absolut loyal. Er lebte in prächtiger Pracht, führte Feldzüge in Frankreich und verwaltete die Maschinerie der Anjou-Regierung. Henri vertraute ihm vollkommen. Als das Erzbistum Canterbury im Jahr 1162 vakant wurde, hatte Heinrich eine scheinbar naheliegende Lösung: Er ernannte Becket zum Erzbischof und kontrollierte Kirche und Staat durch einen Mann.',
      },
    },
    anchorYear: 1155,
  },
  {
    ...
    copy: {
      ...
      body: {
        ...
        de: 'Der Plan ging spektakulär nach hinten los. Nach seiner Erzbischofsweihe wandelte sich Becket vom königlichen Diener zum Verfechter der Unabhängigkeit der Kirche. Er verzichtete auf das Kanzleramt, führte einen strengen Lebensstil und widersetzte sich Heinrich an allen Fronten – kirchliche Gerichte, Ernennungen von Geistlichen, königliche Besteuerung des Klerus. Henri war fassungslos und wütend. Ihre Freundschaft entwickelte sich zur erbittertsten politischen Fehde in der mittelalterlichen englischen Geschichte. Die Clarendon-Verfassungen (1164), Heinrichs Versuch, kirchliche Privilegien zu definieren und einzuschränken, wurden zum Brennpunkt.',
      },
    },
    anchorYear: 1164,
  },
  {
    ...
    copy: {
      ...
      body: {
        ...
        de: 'Nach dem Rat von Northampton im Oktober 1164, bei dem Henry versuchte, Becket wegen Missachtung und finanzieller Unterschlagung vor Gericht zu stellen, floh Becket aus England. Er verbrachte sechs Jahre im französischen Exil, appellierte an Papst Alexander III., exkommunizierte Heinrichs Anhänger und lehnte einen Kompromiss ab. Henry und Becket waren in einen Kampf verwickelt, den keiner gewinnen konnte und keiner aufgeben wollte. Das Exil vergiftete die anglonormannische Politik: Bischöfe waren zwischen König und Papst hin- und hergerissen, Barone zwischen feudaler Loyalität und religiösem Gewissen.',
      },
    },
    anchorYear: 1164,
  },
  {
    ...
    copy: {
      ...
      body: {
        ...
        de: 'Becket kehrte im Dezember 1170 nach einer fragilen Versöhnung nach Canterbury zurück. Innerhalb weniger Wochen exkommunizierte er drei Bischöfe, die Heinrich unterstützt hatten. Der König in der Normandie brach vor Wut aus – und vier Ritter nahmen seine Worte als Befehl. Am 29. Dezember betraten Reginald FitzUrse, Hugh de Morville, William de Tracy und Richard le Breton die Kathedrale von Canterbury und töteten Becket am Altar. Der Mord schockierte die Christenheit. Innerhalb von drei Jahren wurde Becket heiliggesprochen, Canterbury wurde zum größten Wallfahrtsort Englands und Heinrich wurde gezwungen, an Beckets Grab öffentliche Buße zu tun.',
      },
    },
    anchorYear: 1170,
  },
  {
    ...
    copy: {
      ...
      body: {
        ...
        de: 'Die Becket-Affäre definiert die Grenzen des anglonormannischen Königshauses. Heinrich II. war der mächtigste Monarch Westeuropas, konnte die Kirche jedoch nicht seinem Willen unterwerfen. Der Thomaskult wurde zu einem internationalen Phänomen – jahrhundertelang strömten Pilger aus ganz Europa nach Canterbury. Noch wichtiger ist, dass Beckets Widerstand einen Grundsatz etablierte, der in der gesamten englischen Verfassungsgeschichte nachhallen sollte: dass es Grenzen gab, die ein König nicht überschreiten konnte, und dass das Gewissen der Macht widerstehen konnte. Die Rechtsreformen der Anjou blieben bestehen; auch die Unabhängigkeit der Kirche.',
      },
    },
    anchorYear: 1173,
  },
  ...
  // ── Samuel de Champlain guided arc ──────────────────────────────────
  {
    ...
    copy: {
      ...
      body: {
        ...
        de: 'Samuel de Champlain wurde um 1574 in Brouage, einem befestigten Salzhafen an der Küste von Saintonge, geboren. Der Atlantikhandel der Stadt und ihre Nähe zu La Rochelle prägten einen jungen Mann, der sein Leben damit verbringen würde, zwischen Frankreich und der Neuen Welt zu segeln.',
      },
    },
    anchorYear: 1574,
  },
  {
    ...
    copy: {
      ...
      body: {
        ...
        de: 'Vor Kanada segelte Champlain nach Spanisch-Westindien und Mittelamerika (1599–1601) und verfeinerte dabei die Navigations- und Beobachtungsfähigkeiten, die seine Karriere bestimmen sollten. Er kehrte mit Karten, Zeichnungen und der Überzeugung zurück, dass Frankreich Kolonien in der Neuen Welt gründen sollte.',
      },
    },
    anchorYear: 1601,
  },
  {
    ...
    copy: {
      ...
      body: {
        ...
        de: 'Im Jahr 1604 beteiligte sich Champlain unter dem königlichen Monopol von Pierre Dugua de Mons an der Gründung einer Kolonie auf der Insel Sainte-Croix, dann in Port-Royal. Strenge Winter töteten viele, aber Champlain kartografierte die Küste von Cape Cod bis zur Bay of Fundy – Erkenntnisse, die sein nächstes, entscheidendes Projekt leiten sollten.',
      },
    },
    anchorYear: 1604,
  },
  {
    ...
    copy: {
      ...
      body: {
        ...
        de: 'Champlain wählte die Engstelle des St. Lawrence – Kebec in Algonquin – als dauerhaften Wohnsitz. Der befestigte Posten stand am Fuße der Klippe und überblickte den Fluss, wo er sich in Musketenreichweite verengt. Es war eine kommerzielle Sperre und der Traum eines jeden Strategen. Neufrankreich hatte seine Hauptstadt.',
      },
    },
    anchorYear: 1608,
  },
  {
    ...
    copy: {
      ...
      body: {
        ...
        de: 'Champlain schmiedete Bündnisse mit den Wendat (Huron), Algonquin und Montagnais – Verpflichtungen, die durch den Krieg gegen die Haudenosaunee im Jahr 1609 besiegelt wurden. Diese Partnerschaften bestimmten ein Jahrhundert lang die Diplomatie Neu-Frankreichs: Die Kolonie überlebte, weil indigene Nationen sich entschieden, an der Seite der Franzosen Handel zu treiben und zu kämpfen.',
      },
    },
    anchorYear: 1609,
  },
  {
    ...
    copy: {
      ...
      body: {
        ...
        de: 'Im Jahr 1615 reiste Champlain den Ottawa River hinauf zum Huronsee und überwinterte bei den Wendat – das bis dahin tiefste Eindringen eines französischen Herrschers in den Kontinent. Seine Reise enthüllte die immensen Ausmaße des Landes, das Frankreich beansprucht hatte: ein Binnenland aus Seen, Flüssen und Nationen, das sich über jede europäische Karte hinaus erstreckte.',
      },
    },
    anchorYear: 1615,
  },
  {
    ...
    copy: {
      ...
      body: {
        ...
        de: 'Champlains Karte von Neu-Frankreich aus dem Jahr 1632 war die genaueste Darstellung des Nordostens Nordamerikas. Es wurde auf der Grundlage jahrzehntelanger persönlicher Beobachtungen, indigener Aussagen und sorgfältiger Zeichnungen zusammengestellt und diente den Seefahrern und Administratoren über Generationen hinweg als Leitfaden. Er war ebenso ein Kartograph wie ein Gouverneur – und seine Karten überdauerten jedes Gebäude, das er errichtete.',
      },
    },
    anchorYear: 1632,
  },
  {
    ...
    copy: {
      ...
      body: {
        ...
        de: 'Champlain starb am 25. Dezember 1635 in der Einrichtung, die er 27 Jahre zuvor gegründet hatte. Er hinterließ eine Kolonie von kaum dreihundert Seelen, ein Netzwerk indigener Allianzen und die detailliertesten Karten aller französischen Überseegebiete. Die Geschichte würde ihm den Spitznamen „Vater von Neu-Frankreich“ geben.',
      },
    },
    anchorYear: 1635,
  },
  ...
  // ── Jacques Cartier guided arc ──────────────────────────────────────
  {
    ...
    copy: {
      ...
      body: {
        ...
        de: 'Jacques Cartier wurde 1491 in Saint-Malo geboren, dem befestigten bretonischen Hafen, dessen Seeleute bereits auf den Großen Ufern von Neufundland fischten. Die Stadt lag an der Schnittstelle der bretonischen und normannischen Seewelt – ein natürliches Sprungbrett für die Erkundung des Atlantiks.',
      },
    },
    anchorYear: 1491,
  },
  {
    ...
    copy: {
      ...
      body: {
        ...
        de: 'Im Auftrag von Franz I. verließ Cartier Saint-Malo am 20. April 1534 mit zwei Schiffen. Er überquerte den Atlantik in zwanzig Tagen, drang in den Sankt-Lorenz-Golf ein und kartierte die Küsten von Neufundland, Prince Edward Island und Gaspésie – die erste systematische französische Aufklärung der Region.',
      },
    },
    anchorYear: 1534,
  },
  {
    ...
    copy: {
      ...
      body: {
        ...
        de: 'In Gaspé Bay platzierte Cartier eine Zehn-Meter-Flanke mit dem Wappen Frankreichs – ein Akt der Ballbesitznahme, den der örtliche Chef Donnacona nicht begrüßte. Cartier brachte Donnaconas zwei Söhne nach Frankreich und begründete damit ein spannungsgeladenes Verhältnis zwischen europäischen Ansprüchen und indigener Souveränität, das die nächsten zwei Jahrhunderte bestimmen sollte.',
      },
    },
    anchorYear: 1534,
  },
  {
    ...
    copy: {
      ...
      body: {
        ...
        de: 'Im Jahr 1535 segelte Cartier unter der Führung von Donnaconas Söhnen den Sankt-Lorenz-Strom hinauf nach Stadaconé – einem blühenden Dorf an der Stelle des heutigen Quebec. Er verbrachte den Winter dort und verlor 25 Männer durch Skorbut, bevor ein von den Einheimischen weitergegebener Annedda-Tee (weißer Zedernholztee) den Rest rettete. Der Fluss war offen und seine Nationen waren mächtig.',
      },
    },
    anchorYear: 1535,
  },
  {
    ...
    copy: {
      ...
      body: {
        ...
        de: 'Trotz Donnaconas Warnungen ging Cartier flussaufwärts nach Hochelaga, einer großen Palisadenstadt am Fuße des Mount Royal. Vom Gipfel aus sah er die Stromschnellen des Sankt-Lorenz-Stroms, die jeden Vormarsch blockierten, und das riesige Waldinnere dahinter. Er gab dem Berg einen Namen – und gab Montreal seinen Namen.',
      },
    },
    anchorYear: 1535,
  },
  {
    ...
    copy: {
      ...
      body: {
        ...
        de: 'Die Expedition von 1541 bis 1542 hatte zum Ziel, eine dauerhafte Kolonie zu gründen und das legendäre Königreich Saguenay zu finden. Er baute eine Festung oberhalb von Stadacone und sammelte, was er für Diamanten und Gold hielt – Quarz und Pyrit. Roberval kam mit Siedlern an, aber das Unternehmen scheiterte. Erst sechzig Jahre später kehrte Frankreich mit voller Kraft zurück.',
      },
    },
    anchorYear: 1541,
  },
  {
    ...
    copy: {
      ...
      body: {
        ...
        de: 'Cartier starb 1557 in Saint-Malo, sein Versuch, eine Kolonie zu gründen, scheiterte. Doch seine drei Reisen hatten den Sankt-Lorenz-Strom vom Golf bis zu den Stromschnellen namens Mount Royal kartiert und bewiesen, dass der Fluss eine Autobahn zum Kontinent war. Als Champlain siebzig Jahre später segelte, folgte er den Karten von Cartier.',
      },
    },
    anchorYear: 1557,
  },
  ...
  // ── Pierre Dugua de Mons guided arc ─────────────────────────────────
  {
    ...
    copy: {
      ...
      body: {
        ...
        de: 'Pierre Dugua, Sieur de Mons, wurde um 1558 in Royan in Saintonge geboren – ein Protestant in einer Region, deren Kaufleute seit langem entlang der Atlantikküste Handel trieben. Sein Militärdienst während der Religionskriege brachte ihm das Vertrauen Heinrichs IV. ein, der ihm das Instrument gewährte, das eine dauerhafte Kolonisierung ermöglichte: ein königliches Monopol auf den Pelzhandel.',
      },
    },
    anchorYear: 1558,
  },
  {
    ...
    copy: {
      ...
      body: {
        ...
        de: 'Im Jahr 1603 gewährte Heinrich IV. Dugua ein Monopol auf den Pelzhandel zwischen dem 40. und 46. Breitengrad. Es war der Finanzmotor der Kolonisierung: Privates Kapital finanzierte Schiffe, Proviant und Siedler im Austausch für die exklusiven Gewinne des Bibers. Dugua rekrutierte Champlain als Kartographen und Navigator – die Partnerschaft, die Neu-Frankreich gründen sollte.',
      },
    },
    anchorYear: 1603,
  },
  {
    ...
    copy: {
      ...
      body: {
        ...
        de: 'Im Jahr 1604 landete Duguas Expedition auf St. Croix Island in der Bay of Fundy. Die Insel schien zu verteidigen, doch der Winter war verheerend: 35 der 79 Männer starben an Skorbut und Kälte. Die Überlebenden zogen nach Port-Royal auf der anderen Seite der Bucht. Dugua hatte zu einem schrecklichen Preis gelernt, dass die Kolonisierung mehr als nur Kapital erforderte – sie erforderte Kenntnisse über das Land.',
      },
    },
    anchorYear: 1604,
  },
  {
    ...
    copy: {
      ...
      body: {
        ...
        de: 'Port-Royal wurde die erste dauerhafte französische Siedlung in Nordamerika. Unter Poutrincourts örtlichem Kommando und Champlains Kartographie beherbergte die Siedlung Siedler, knüpfte Verbindungen zu den Mi\'kmaq und beherbergte den Orden der Bon Temps – den ersten Gesellschaftsclub in der Neuen Welt. Dugua finanzierte es von Frankreich aus, ohne jemals wieder den Ozean zu überqueren.',
      },
    },
    anchorYear: 1605,
  },
  {
    ...
    copy: {
      ...
      body: {
        ...
        de: 'Als Duguas akadisches Monopol widerrufen wurde, wandte er sich an den St. Lawrence. 1608 sandte er Champlain mit einem neuen Auftrag, einen Handelsposten in Quebec zu gründen. Dugua ist nie dorthin gesegelt, aber ohne sein Kapital, seine politischen Verbindungen und seine Bereitschaft, Verluste aufzufangen, hätte Champlains Siedlung nie das Licht der Welt erblickt.',
      },
    },
    anchorYear: 1608,
  },
  {
    ...
    copy: {
      ...
      body: {
        ...
        de: 'Dugua starb 1628, weitgehend vergessen. Die Geschichte bewahrte Champlain, nicht den Kaufmann, der die Verträge unterzeichnete. Doch Duguas Modell – ein privates Monopol, das die öffentliche Kolonisierung finanzierte – diente als Vorbild für jedes nachfolgende Unternehmen in Neu-Frankreich. Er bewies, dass eine dauerhafte Ansiedlung nachhaltiges Kapital und nicht nur königlichen Ehrgeiz erforderte.',
      },
    },
    anchorYear: 1628,
  },
  ...
  // ── Louis Hébert guided arc ─────────────────────────────────────────
  {
    ...
    copy: {
      ...
      body: {
        ...
        de: 'Louis Hébert wurde um 1575 in Paris geboren, wo er als Apotheker arbeitete. Er wurde über die Handelsnetzwerke von Rouen rekrutiert und war der erste Europäer, der kanadischen Boden kultivierte – und Stößel und Mörser gegen Pflug und Hacke eintauschte.',
      },
    },
    anchorYear: 1575,
  },
  {
    ...
    copy: {
      ...
      body: {
        ...
        de: 'Hébert begleitete Poutrincourt 1606 nach Port-Royal, wo er Kranke behandelte und mit einheimischen Pflanzen experimentierte. Er kehrte nach Paris zurück, aber die Erfahrung hatte einen Samen gesät: Das Land könnte das europäische Leben nähren, wenn jemand es bewirtschaften wollte.',
      },
    },
    anchorYear: 1606,
  },
  {
    ...
    copy: {
      ...
      body: {
        ...
        de: '1617 verkaufte Hébert seinen Pariser Laden, nahm seine Familie – seine Frau Marie Rollet und drei Kinder – mit und segelte von Honfleur nach Quebec. Die Handelsgesellschaft versuchte, ihn in das Lager einzusperren, aber er bestand darauf, Landwirtschaft zu betreiben. Er war mit dem Handel fertig; er wollte das Land.',
      },
    },
    anchorYear: 1617,
  },
  {
    ...
    copy: {
      ...
      body: {
        ...
        de: 'Auf dem Plateau über dem Haus rodete Hébert das Land und baute Weizen, Roggen und Gartengemüse an. Er war der erste Europäer in Kanada, der hauptsächlich von seiner eigenen Ernte und nicht von den Geschäften des Unternehmens lebte. Die Farm erwies sich als entscheidender Punkt: Die Kolonie war nicht ausschließlich auf Versorgungsschiffe aus Frankreich angewiesen.',
      },
    },
    anchorYear: 1618,
  },
  {
    ...
    copy: {
      ...
      body: {
        ...
        de: 'Hébert starb im Januar 1627 nach einem Sturz auf dem Eis – der erste europäische Bauer, der auf kanadischem Boden begraben wurde. Seine Frau Marie Rollet blieb, heiratete erneut und verankerte weiterhin die fragile Gemeinschaft. Ihre Nachkommen zählen heute Millionen. Der Apotheker, der sich für den Anbau entschied, hatte etwas Tieferes als nur Weizen gesät.',
      },
    },
    anchorYear: 1627,
  },
  ...
  // ── Robert Giffard guided arc ───────────────────────────────────────
  {
    ...
    copy: {
      ...
      body: {
        ...
        de: 'Robert Giffard wurde um 1587 in Perche, einer friedlichen Region im Landesinneren südlich der Normandie, geboren. Als Chirurg besuchte er in den 1620er Jahren Neu-Frankreich und sah, was der Kolonie fehlte: Familien, die bereit waren, Landwirtschaft zu betreiben. Er kehrte nach Mortagne zurück, entschlossen, diese Lücke zu füllen – in seinen eigenen Pfarreien.',
      },
    },
    anchorYear: 1587,
  },
  {
    ...
    copy: {
      ...
      body: {
        ...
        de: 'Giffards Route führte über Land von Mortagne nach Rouen, die Seine hinunter nach Dieppe und dann über den Atlantik. Im Jahr 1634 leitete er die größte Rekrutierungswelle in den frühen Tagen Neu-Frankreichs: Dutzende Familien aus Perche schifften sich gemeinsam ein und ließen sich gemeinsam nieder. Es war eine organisierte Kettenmigration.',
      },
    },
    anchorYear: 1634,
  },
  {
    ...
    copy: {
      ...
      body: {
        ...
        de: 'Giffard erhielt die Herrschaft über Beauport nördlich von Quebec und siedelte seine Percheron-Familien auf langen Flusskonzessionen entlang des Sankt-Lorenz-Stroms an. Das Vorbild – Herr als Anwerber, Organisator und Eigentümer – wurde zur Vorlage für die Bevölkerung der Kolonie. Beauport war das erste und erfolgreichste Beispiel.',
      },
    },
    anchorYear: 1634,
  },
  {
    ...
    copy: {
      ...
      body: {
        ...
        de: 'Die Namen, die Giffard aus Perche mitbrachte – Cloutier, Juchereau, Tremblay, Boucher, Côté – wurden zu den Gründungsnamen des französischen Kanadas. Sie waren weder Abenteurer noch Soldaten, sondern Bauern, Handwerker und ihre Frauen, angezogen von einem Rekrutierer, den sie persönlich kannten. Der Gründungseffekt von Percheron ist in der Genealogie Quebecs bis heute sichtbar.',
      },
    },
    anchorYear: 1640,
  },
  {
    ...
    copy: {
      ...
      body: {
        ...
        de: 'Giffard starb 1668 in Beauport, nachdem er mehrmals den Atlantik überquert hatte, um Siedler herzubringen. Sein Modell der Rekrutierung von Herrschaften – persönliche Netzwerke, Bindungen zur Gemeinde, Familienmigration – prägte die demografische Basis Neu-Frankreichs mehr als jeder königliche Erlass. Ein bescheidener Chirurg aus einem friedlichen Landesinneren hatte einen Kontinent bevölkert.',
      },
    },
    anchorYear: 1668,
  },
  ...
  // ── Pierre Boucher guided arc ───────────────────────────────────────
  {
    ...
    copy: {
      ...
      body: {
        ...
        de: 'Pierre Boucher wurde 1622 in Mortagne-au-Perche geboren. Im Jahr 1635, im Alter von dreizehn Jahren, überquerte er mit der Welle der von Giffard rekrutierten Percheron-Familien den Atlantik. Den Rest seiner 95 Jahre verbrachte er in Neu-Frankreich – länger als fast jeder andere aus der Gründergeneration.',
      },
    },
    anchorYear: 1635,
  },
  {
    ...
    copy: {
      ...
      body: {
        ...
        de: 'Boucher wurde als Teenager zu den Wendat geschickt und beherrschte fließend die indigenen Sprachen. Dieses Eintauchen verschaffte ihm das interkulturelle Verständnis, das ihn zu einem der effektivsten Anführer der Kolonie machen würde – einem Gouverneur, der in der Lage war, sowohl mit Paris als auch mit den First Nations zu verhandeln.',
      },
    },
    anchorYear: 1640,
  },
  {
    ...
    copy: {
      ...
      body: {
        ...
        de: 'Als Gouverneur von Trois-Rivières ab 1654 verteidigte Boucher das Establishment in den gefährlichsten Jahren der Irokesenkriege. Mit kaum einer Handvoll Milizsoldaten bekleidete er einen Posten direkt an der Frontlinie zwischen den französischen und den Haudenosaunee-Territorien.',
      },
    },
    anchorYear: 1654,
  },
  {
    ...
    copy: {
      ...
      body: {
        ...
        de: 'Im Jahr 1661 segelte Boucher nach Frankreich, um Ludwig XIV. persönlich zu bitten. Sein Argument war direkt: Neu-Frankreich würde ohne Soldaten sterben. Der König hörte zu. Das Ergebnis war das Regiment Carignan-Salières – zwölfhundert Soldaten, die 1665 entsandt wurden, die größte militärische Verstärkung, die die Kolonie je gesehen hatte.',
      },
    },
    anchorYear: 1661,
  },
  {
    ...
    copy: {
      ...
      body: {
        ...
        de: 'Im Jahr 1664 veröffentlichte Boucher die erste Beschreibung von Neu-Frankreich in Buchform: Geographie, Menschen, Tiere und Potenzial. Die wahre Geschichte wurde für ein französisches Publikum geschrieben, das fast nichts über Kanada wusste, und war sowohl ein Werbetrakt als auch ein ethnografisches Dokument.',
      },
    },
    anchorYear: 1664,
  },
  {
    ...
    copy: {
      ...
      body: {
        ...
        de: 'Boucher gründete die Herrschaft Boucherville in der Nähe von Montreal und starb 1717 im Alter von 95 Jahren. Er war als Kind in eine Kolonie mit ein paar hundert Seelen gekommen; er starb in einer Gesellschaft von achtzehntausend Menschen. Seine Schriften, seine Diplomatie und seine Petition an Ludwig XIV. hatten den Wandel unmittelbar geprägt.',
      },
    },
    anchorYear: 1717,
  },
  ...
  // ── Jean Talon guided arc ───────────────────────────────────────────
  {
    ...
    copy: {
      ...
      body: {
        ...
        de: 'Jean Talon wurde um 1626 in Châlons-en-Champagne geboren und stieg als Schützling von Colbert – dem Finanzminister Ludwigs XIV. – in der königlichen Bürokratie auf. Als Colbert einen Mann brauchte, der Neu-Frankreich von einem Handelsposten in eine produktive Kolonie der Krone verwandeln konnte, entschied er sich für Talon.',
      },
    },
    anchorYear: 1626,
  },
  {
    ...
    copy: {
      ...
      body: {
        ...
        de: 'Talon kam 1665 als erster Intendant der Kolonie nach Quebec – Hauptverwalter der Krone für Justiz, Finanzen und Zivilordnung. Er fand eine Kolonie von knapp dreitausend Seelen vor, die vom Pelzhandel abhängig und anfällig für Überfälle der Irokesen war. Er machte sich daran, alles zu ändern.',
      },
    },
    anchorYear: 1665,
  },
  {
    ...
    copy: {
      ...
      body: {
        ...
        de: 'Talon ordnete die erste systematische Volkszählung Kanadas an: von Tür zu Tür, wobei Name, Alter, Beruf und Familienstand jedes Siedlers entlang des Sankt-Lorenz-Stroms erfasst wurden. Die Zählung ergab 3.215 Seelen – und Talon war entschlossen, die demografische Realität zu ändern.',
      },
    },
    anchorYear: 1666,
  },
  {
    ...
    copy: {
      ...
      body: {
        ...
        de: 'Zwischen 1663 und 1673 organisierte Talon die Migration von etwa achthundert Filles du Roi – junge Frauen, die geschickt wurden, um Kolonisten zu heiraten und Kinder zu bekommen. Innerhalb eines Jahrzehnts verdreifachte sich die Bevölkerung der Kolonie. Talon bot Prämien für kinderreiche Familien und Geldstrafen für Alleinstehende.',
      },
    },
    anchorYear: 1668,
  },
  {
    ...
    copy: {
      ...
      body: {
        ...
        de: 'Talon verdrängte Neu-Frankreich über die Biberfelle hinaus. Er gründete eine Brauerei in Quebec, förderte den Anbau von Hanf und Flachs, baute eine Gerberei und erkundete Eisenvorkommen. Ihr Ziel war die Selbstversorgung der Colbertisten: eine Kolonie, die produzierte, was sie verbrauchte, und den Überschuss nach Frankreich exportierte.',
      },
    },
    anchorYear: 1670,
  },
  {
    ...
    copy: {
      ...
      body: {
        ...
        de: 'Talon schickte Gesandte nach Westen, um im Namen Frankreichs das Landesinnere zu beanspruchen. 1671 proklamierte sein Gesandter in Sault Sainte-Marie offiziell die französische Souveränität über das Becken der Großen Seen. Die von ihm ins Leben gerufenen geografischen Ambitionen führten innerhalb eines Jahrzehnts zu La Salles Expedition zum Mississippi.',
      },
    },
    anchorYear: 1671,
  },
  {
    ...
    copy: {
      ...
      body: {
        ...
        de: 'Talon kehrte 1672 nach Frankreich zurück und kehrte nie zurück. In sieben Jahren hatte er die Bevölkerung verdreifacht, die Wirtschaft diversifiziert, die französischen Ansprüche auf die Großen Seen ausgeweitet und den Verwaltungsrahmen festgelegt, der Neu-Frankreich bis 1760 regieren sollte. Er starb 1694 in Paris – ein Bürokrat, dessen Aufzeichnungen einen Kontinent veränderten.',
      },
    },
    anchorYear: 1672,
  },
  ...
  // ── Marguerite Bourgeoys guided arc ─────────────────────────────────
  {
    ...
    copy: {
      ...
      body: {
        ...
        de: 'Marguerite Bourgeoys wurde 1620 in Troyes in der Champagne geboren. Im Alter von zwanzig Jahren erlebte sie eine religiöse Bekehrung und schloss sich einer externen Kongregation von Frauen an, die die Armen unterrichteten. Als Maisonneuve einen Lehrer für seine junge Einrichtung in Montreal suchte, folgte Bourgeoys dem Anruf.',
      },
    },
    anchorYear: 1620,
  },
  {
    ...
    copy: {
      ...
      body: {
        ...
        de: 'Im Jahr 1653 segelte Bourgeoys von Frankreich nach Montreal – damals Ville-Marie genannt, einer befestigten Missionssiedlung mit knapp fünfzig Siedlern. Sie kam, um zu unterrichten, fand aber eine Gemeinschaft vor, die alles brauchte: Bildung, Fürsorge, moralische Orientierung und den einfachen Willen zum Überleben.',
      },
    },
    anchorYear: 1653,
  },
  {
    ...
    copy: {
      ...
      body: {
        ...
        de: 'Im Jahr 1658 eröffnete Bourgeoys seine erste Schule in einem umgebauten Steinstall. Sie unterrichtete gemeinsam französische und einheimische Kinder – Lesen, Schreiben, Rechnen und Lebenskompetenzen. Es war die erste Schule ohne Kloster in Neu-Frankreich.',
      },
    },
    anchorYear: 1658,
  },
  {
    ...
    copy: {
      ...
      body: {
        ...
        de: 'Bourgeoys gründete die Congrégation de Notre-Dame – die erste nicht klösterliche weibliche Religionsgemeinschaft in Neu-Frankreich. Seine Mitglieder lebten unter den Menschen, nicht hinter Klostermauern. Sie unterrichteten in Pfarrschulen, bereiteten die Töchter des Königs auf die Ehe vor und brachten Bildung in entfernte Einrichtungen.',
      },
    },
    anchorYear: 1659,
  },
  {
    ...
    copy: {
      ...
      body: {
        ...
        de: 'In den 1680er Jahren betrieb die Kongregation Schulen in Quebec, Trois-Rivières und entlang der Côte-de-Beaupré. Bourgeoys rekrutierte Lehrer in Frankreich und bildete einheimische Frauen aus. Sein Netz von Pfarrschulen verschaffte Neu-Frankreich eine Bildungsinfrastruktur, mit der die englischen Kolonien jahrzehntelang nicht Schritt halten konnten.',
      },
    },
    anchorYear: 1680,
  },
  {
    ...
    copy: {
      ...
      body: {
        ...
        de: 'Bourgeoys starb am 12. Januar 1700 in Montreal. Sie wurde 1982 heiliggesprochen – die erste in Frankreich geborene Frau, die für ihre Arbeit in Amerika so geehrt wurde. Ihre Kongregation existiert noch heute, und das von ihr aufgebaute Bildungsmodell prägte die Kolonialgesellschaft mehr als ein Jahrhundert lang.',
      },
    },
    anchorYear: 1700,
  },
  ...
  // ── Jeanne Mance guided arc ─────────────────────────────────────────
  {
    ...
    copy: {
      ...
      body: {
        ...
        de: 'Jeanne Mance wurde 1606 in Langres in der Champagne geboren. Sie behandelte die Verwundeten während des Dreißigjährigen Krieges und erfuhr über Pariser fromme Netzwerke von einem Missionsprojekt auf der Insel Montreal. Sie engagierte sich ehrenamtlich als Krankenschwester und Spendensammlerin.',
      },
    },
    anchorYear: 1606,
  },
  {
    ...
    copy: {
      ...
      body: {
        ...
        de: 'Mance segelte 1641 mit Maisonneuves Gruppe von La Rochelle aus. Sie nahm die von Angélique de Bullion gespendeten Gelder entgegen, die für ein Krankenhaus auf dem Land bestimmt waren. Die Überfahrt war der Dreh- und Angelpunkt ihres Lebens: Sie verließ Frankreich als einfache provinzielle Säkularistin und kam als Mitarchitektin einer Stadt an.',
      },
    },
    anchorYear: 1641,
  },
  {
    ...
    copy: {
      ...
      body: {
        ...
        de: 'Maisonneuves Gruppe gründete Ville-Marie im Mai 1642 auf der Insel Montreal. Mance war vom ersten Tag an dabei – die einzige Frau unter den Gründern. Die Gründung war ein ernsthaftes Projekt, und Mance war sein praktisches Gewissen.',
      },
    },
    anchorYear: 1642,
  },
  {
    ...
    copy: {
      ...
      body: {
        ...
        de: 'Im Jahr 1645 eröffnete Mance das Hôtel-Dieu de Montréal – das erste Krankenhaus der Einrichtung und eines der ältesten in Nordamerika. Sie kümmerte sich gleichermaßen um Siedler und Eingeborene, kümmerte sich um die Vorräte, versorgte die Verwundeten bei Irokesenüberfällen und sorgte dafür, dass die Institution über Jahrzehnte des Krieges hinweg zahlungsfähig blieb.',
      },
    },
    anchorYear: 1645,
  },
  {
    ...
    copy: {
      ...
      body: {
        ...
        de: 'Während der gefährlichsten Jahre der Irokesenkriege hielt Mance Montreal zusammen, während Maisonneuve nach Frankreich segelte, um Verstärkung zu holen. Sie nutzte Krankenhausgelder, um Soldaten zu rekrutieren – eine umstrittene Entscheidung, die die Einrichtung rettete.',
      },
    },
    anchorYear: 1651,
  },
  {
    ...
    copy: {
      ...
      body: {
        ...
        de: 'Jeanne Mance starb am 18. Juni 1673 in Montreal. Sie hatte zweiunddreißig Jahre damit verbracht, ein Krankenhaus aufzubauen und trotz Krieg, Krankheit und Finanzkrisen eine Grenzsiedlung aufrechtzuerhalten. Ihr Hôtel-Dieu gilt heute als Mitbegründerin von Montreal und hat bis heute Bestand.',
      },
    },
    anchorYear: 1673,
  },
  ...
  // ── René-Robert Cavelier de La Salle guided arc ─────────────────────
  {
    ...
    copy: {
      ...
      body: {
        ...
        de: 'René-Robert Cavelier wurde 1643 in Rouen in eine Familie wohlhabender Kaufleute geboren. Nachdem er von den Jesuiten erzogen worden war, verließ er den Orden und segelte 1667 nach Neu-Frankreich – wo er sein komfortables normannisches Leben gegen die obsessive Suche nach einer Durchfahrt in den Westen eintauschte. Er würde etwas Größeres finden.',
      },
    },
    anchorYear: 1643,
  },
  {
    ...
    copy: {
      ...
      body: {
        ...
        de: 'La Salle ließ sich auf der Insel Montreal nieder, wo er indigene Sprachen lernte und hartnäckige Geschichten über einen großen Fluss hörte, der nach Süden floss. Er verkaufte seine Herrschaft, um Expeditionen zu finanzieren, und wurde zum aggressivsten westlichen Entdecker der Kolonie.',
      },
    },
    anchorYear: 1669,
  },
  {
    ...
    copy: {
      ...
      body: {
        ...
        de: 'Im Jahr 1673 baute La Salle Fort Frontenac am Auslass des Ontariosees wieder auf – dem strategischen Dreh- und Angelpunkt zwischen dem St.-Lorenz-Korridor und den Großen Seen. Von Frontenac aus kontrollierte er den westlichen Pelzhandel und organisierte die Expeditionen, die ihn nach Mississippi führen sollten.',
      },
    },
    anchorYear: 1673,
  },
  {
    ...
    copy: {
      ...
      body: {
        ...
        de: 'Im Jahr 1680 baute La Salle das Fort Crèvecœur am Illinois River – den tiefsten französischen Stützpunkt im Landesinneren. Desertion und Meuterei verwüsteten das Unternehmen, aber die Rückschläge verstärkten nur seine Entschlossenheit, den Mississippi zu erreichen.',
      },
    },
    anchorYear: 1680,
  },
  {
    ...
    copy: {
      ...
      body: {
        ...
        de: 'Am 9. April 1682 erreichte La Salle die Mündung des Mississippi und beanspruchte das gesamte Flussbecken für Frankreich und nannte es „Louisiana“. In einer einzigen Expedition hatte ein Normanne aus Rouen das französische Territorium von den Großen Seen bis zum Golf von Mexiko ausgedehnt – der spektakulärste geografische Anspruch in der Geschichte Neufrankreichs.',
      },
    },
    anchorYear: 1682,
  },
  {
    ...
    copy: {
      ...
      body: {
        ...
        de: 'Die Rückexpedition von La Salle zur Kolonisierung der Golfküste endete in einer Katastrophe. Er verpasste das Mississippi-Delta, landete in Texas und verbrachte zwei Jahre verloren. Seine hungrigen und verzweifelten Männer meuterten und töteten ihn am 19. März 1687. Der größte Entdecker Neufrankreichs starb durch die Hand seiner eigenen Gefährten.',
      },
    },
    anchorYear: 1687,
  },
  {
    ...
    copy: {
      ...
      body: {
        ...
        de: 'La Salles Anspruch auf Louisiana erstreckte das französische Territorium vom Sankt-Lorenz-Golf bis zum Golf von Mexiko. Der Sohn eines Kaufmanns aus Rouen hatte den größten geografischen Bogen in der Kolonialgeschichte zurückgelegt. Louisiana würde bevölkert, umkämpft und verkauft werden – aber der Anspruch, der es hervorbrachte, lag bei ihm.',
      },
    },
    anchorYear: 1682,
  },
  // ── Templar origins guided arc ────────────────────────────────────
  {
    id: 'to-crusader-jerusalem',
    eraId: 'norman-expansion',
    ...
    focus: {
      placeIds: ['jerusalem', 'tiberias', 'acre'],
      regionIds: [],
      routeSegmentIds: [],
    },
    presentation: {
    ...
    copy: {
      title: 'Crusader Jerusalem',
      body: {
        en: 'After the First Crusade captured Jerusalem in July 1099, the new Kingdom of Jerusalem controlled a thin coastal strip and a handful of inland strongholds. Pilgrims began arriving from across Latin Christendom — but the roads between the port of Jaffa and the Holy City were lawless. Bandits, displaced populations, and remnants of defeated armies preyed on unarmed travellers. The kingdom\'s small feudal army could garrison castles but not patrol every road. The pilgrim traffic that justified the kingdom\'s existence was its most vulnerable point.',
        fr: 'Après la prise de Jérusalem par la Première Croisade en juillet 1099, le nouveau Royaume de Jérusalem contrôlait une mince bande côtière et une poignée de places fortes intérieures. Des pèlerins commencèrent à affluer de toute la chrétienté latine — mais les routes entre le port de Jaffa et la Ville sainte étaient sans loi. Bandits, populations déplacées et restes d\'armées vaincues s\'en prenaient aux voyageurs désarmés. La petite armée féodale du royaume pouvait garnir les châteaux mais non patrouiller chaque route. Le flux de pèlerins qui justifiait l\'existence du royaume en était le point le plus vulnérable.',
        de: 'Nach der Eroberung Jerusalems durch den Ersten Kreuzzug im Juli 1099 kontrollierte das neue Königreich Jerusalem einen schmalen Küstenstreifen und eine Handvoll Festungen im Landesinneren. Pilger strömten aus der gesamten lateinischen Christenheit herbei – doch die Straßen zwischen dem Hafen von Jaffa und der Heiligen Stadt waren gesetzeswidrig. Banditen, Vertriebene und Überreste besiegter Armeen griffen unbewaffnete Reisende an. Die kleine Feudalarmee des Königreichs konnte zwar die Burgen besetzen, aber nicht jede Straße patrouillieren. Der Pilgerstrom, der die Existenz des Königreichs rechtfertigte, war sein verwundbarster Punkt.',
      },
    },
    anchorYear: 1099,
  },
  {
    id: 'to-brotherhood-formed',
    eraId: 'norman-expansion',
    arcId: 'templar-origins',
    camera: {
      target: 'places',
    ...
    copy: {
      title: 'The small brotherhood',
      body: {
        en: 'Around 1119 or 1120 — the traditional date is debated — a small group of knights led by Hugues de Payens, a minor lord from Champagne, and Godefroy de Saint-Omer, a Flemish knight, approached King Baldwin II of Jerusalem with a proposal: they would take religious vows and devote themselves to protecting pilgrims on the roads. Baldwin granted them quarters in the al-Aqsa Mosque on the Temple Mount, believed by Crusaders to stand on the site of Solomon\'s Temple. From this location the group took its eventual name: the Poor Fellow-Soldiers of Christ and of the Temple of Solomon.',
        fr: 'Vers 1119 ou 1120 — la date traditionnelle est débattue — un petit groupe de chevaliers mené par Hugues de Payens, petit seigneur de Champagne, et Godefroy de Saint-Omer, chevalier flamand, s\'adressa au roi Baudouin II de Jérusalem avec une proposition : ils prononceraient des vœux religieux et se consacreraient à la protection des pèlerins sur les routes. Baudouin leur accorda des quartiers dans la mosquée al-Aqsa sur le Mont du Temple, que les Croisés croyaient érigée sur l\'emplacement du Temple de Salomon. C\'est de ce lieu que le groupe tira son nom futur : les Pauvres Chevaliers du Christ et du Temple de Salomon.',
        de: 'Um 1119 oder 1120 – das traditionelle Datum ist umstritten – wandte sich eine kleine Gruppe von Rittern unter der Führung von Hugues de Payens, dem kleinen Herrscher der Champagne, und Godfrey de Saint-Omer, dem flämischen Ritter, an König Balduin II. von Jerusalem mit einem Vorschlag: Sie würden religiöse Gelübde ablegen und sich dem Schutz der Pilger auf den Straßen widmen. Baldwin gewährte ihnen Quartier in der Al-Aqsa-Moschee auf dem Tempelberg, die nach Ansicht der Kreuzfahrer an der Stelle des Salomo-Tempels stand. Von diesem Ort erhielt die Gruppe ihren zukünftigen Namen: „Arme Ritter Christi und Tempel Salomos“.',
      },
    },
    anchorYear: 1119,
  },
  {
    id: 'to-champagne-patronage',
    eraId: 'norman-expansion',
    arcId: 'templar-origins',
    camera: {
      target: 'bbox',
    ...
    focus: {
      placeIds: ['troyes', 'payns', 'saint-omer'],
      regionIds: [],
      routeSegmentIds: [],
    },
    presentation: {
    ...
    copy: {
      title: 'Patronage in Francia',
      body: {
        en: 'Hugues de Payens came from Payns, a village near Troyes in the County of Champagne. His co-founder Godefroy hailed from Saint-Omer in Flanders. Neither man was Norman. Hugues travelled to Europe around 1127 to seek formal recognition and recruits. He found a powerful ally in Bernard of Clairvaux, the Cistercian abbot whose influence pervaded the French church. Bernard wrote "In Praise of the New Knighthood," a treatise that recast holy war as monastic discipline and gave the fledgling order theological legitimacy. The Count of Champagne himself had earlier donated land to Hugues — the Templar network was rooted in Champagne and Picardy long before it became international.',
        fr: 'Hugues de Payens venait de Payns, un village près de Troyes dans le Comté de Champagne. Son cofondateur Godefroy était originaire de Saint-Omer en Flandre. Aucun des deux n\'était normand. Hugues voyagea en Europe vers 1127 pour obtenir une reconnaissance formelle et des recrues. Il trouva un allié puissant en Bernard de Clairvaux, l\'abbé cistercien dont l\'influence imprégnait l\'Église française. Bernard écrivit « Éloge de la nouvelle chevalerie », un traité qui refondit la guerre sainte en discipline monastique et donna à l\'ordre naissant une légitimité théologique. Le Comte de Champagne lui-même avait auparavant fait don de terres à Hugues — le réseau templier était enraciné en Champagne et en Picardie bien avant de devenir international.',
        de: 'Hugues de Payens stammte aus Payns, einem Dorf in der Nähe von Troyes in der Grafschaft Champagne. Ihr Mitbegründer Godefroy stammte aus Saint-Omer in Flandern. Norman war es auch nicht. Hugh reiste um 1127 nach Europa, um formelle Anerkennung zu erlangen und Rekruten zu gewinnen. Er fand einen mächtigen Verbündeten in Bernhard von Clairvaux, dem Zisterzienserabt, dessen Einfluss die französische Kirche durchdrang. Bernard schrieb „In Praise of the New Chivalry“, eine Abhandlung, die den Heiligen Krieg als klösterliche Disziplin umformte und dem entstehenden Orden theologische Legitimität verlieh. Der Graf von Champagne selbst hatte Hugo zuvor Land gespendet – das Templernetzwerk war in der Champagne und der Picardie verwurzelt, lange bevor es international wurde.',
      },
    },
    anchorYear: 1127,
  },
  {
    id: 'to-council-troyes',
    eraId: 'norman-expansion',
    arcId: 'templar-origins',
    camera: {
      target: 'places',
    ...
    copy: {
      title: 'The Council of Troyes',
      body: {
        en: 'On 13 January 1129, a church council convened at Troyes — seat of the Champagne court — to examine the Templar proposal. Presided over by the papal legate Cardinal Matthew of Albano, with Bernard of Clairvaux as its dominant voice, the council granted the Templars a formal Rule based on the Cistercian model: communal property, fixed hours of prayer, strict obedience, and — uniquely — license to bear arms in defence of pilgrims and the Holy Land. The order received papal privileges that allowed it to collect tithes and build its own churches. In a single session, a band of perhaps nine knights became an institution with the backing of Rome.',
        fr: 'Le 13 janvier 1129, un concile ecclésiastique se réunit à Troyes — siège de la cour de Champagne — pour examiner la proposition templière. Présidé par le légat pontifical, le cardinal Matthieu d\'Albano, avec Bernard de Clairvaux comme voix dominante, le concile accorda aux Templiers une Règle formelle inspirée du modèle cistercien : propriété communale, heures de prière fixes, obéissance stricte et — fait unique — licence de porter les armes pour défendre les pèlerins et la Terre sainte. L\'ordre reçut des privilèges pontificaux lui permettant de percevoir des dîmes et de construire ses propres églises. En une seule session, une poignée d\'environ neuf chevaliers devint une institution soutenue par Rome.',
        de: 'Am 13. Januar 1129 traf sich in Troyes – Sitz des Hofes der Champagne – ein Kirchenrat, um den Vorschlag der Templer zu prüfen. Unter dem Vorsitz des päpstlichen Legaten, Kardinal Matthäus von Albano, mit Bernhard von Clairvaux als dominanter Stimme, erteilte der Rat den Templern eine formelle Regel nach dem Vorbild der Zisterzienser: Gemeinschaftseigentum, feste Gebetszeiten, strikter Gehorsam und – als einziger – die Erlaubnis, Waffen zu tragen, um Pilger und das Heilige Land zu verteidigen. Der Orden erhielt päpstliche Privilegien, die es ihm ermöglichten, den Zehnten einzutreiben und eigene Kirchen zu bauen. In einer einzigen Sitzung wurde aus einer Handvoll von etwa neun Rittern eine von den Römern unterstützte Institution.',
      },
    },
    anchorYear: 1129,
  },
  {
    id: 'to-growth-template',
    eraId: 'norman-expansion',
    arcId: 'templar-origins',
    camera: {
      target: 'bbox',
    ...
    focus: {
      placeIds: ['jerusalem', 'troyes', 'acre', 'paris'],
      regionIds: [],
      routeSegmentIds: [],
    },
    presentation: {
    ...
    copy: {
      title: 'A pan-European order',
      body: {
        en: 'Within two decades of Troyes, the Templars operated across the Latin West: commanderies in France, England, Iberia, Italy, and the Holy Roman Empire funnelled recruits, horses, and silver to the Levant. Their membership was drawn from every corner of Catholic Europe. No medieval census recorded Templars by birthplace, and no modern historian can credibly say what share were Norman, Champenois, Flemish, or Iberian. What can be said is that the order grew inside a crusader world that Norman princes — Bohemond at Antioch, the Hautevilles in Sicily, Richard the Lionheart a century later — had done much to build. The military-religious template the Templars institutionalised owed its context to that Norman-led first generation of crusader states, even though the order\'s own founders came from Champagne and Flanders.',
        fr: 'Moins de vingt ans après Troyes, les Templiers opéraient dans tout l\'Occident latin : des commanderies en France, en Angleterre, en Ibérie, en Italie et dans le Saint-Empire acheminaient recrues, chevaux et argent vers le Levant. Leurs membres venaient de chaque recoin de l\'Europe catholique. Aucun recensement médiéval n\'enregistra les Templiers par lieu de naissance, et aucun historien moderne ne peut affirmer de manière crédible quelle part était normande, champenoise, flamande ou ibérique. Ce que l\'on peut dire, c\'est que l\'ordre grandit dans un monde croisé que des princes normands — Bohémond à Antioche, les Hauteville en Sicile, Richard Cœur de Lion un siècle plus tard — avaient largement contribué à bâtir. Le modèle militaro-religieux que les Templiers institutionnalisèrent devait son contexte à cette première génération normande d\'États croisés, même si les propres fondateurs de l\'ordre venaient de Champagne et de Flandre.',
        de: 'Weniger als zwanzig Jahre nach Troyes waren die Templer im gesamten lateinischen Westen im Einsatz: Kommandos in Frankreich, England, Iberien, Italien und dem Heiligen Römischen Reich transportierten Rekruten, Pferde und Geld in die Levante. Ihre Mitglieder kamen aus allen Teilen des katholischen Europas. In keiner mittelalterlichen Volkszählung wurden die Templer nach Geburtsort erfasst, und kein moderner Historiker kann glaubhaft sagen, wie viele davon Normannen, Champagner, Flamen oder Iberer waren. Was wir sagen können ist, dass der Orden in einer Kreuzzugswelt wuchs, zu deren Aufbau normannische Fürsten – Bohemond in Antiochia, die Hautevilles in Sizilien und Richard Löwenherz ein Jahrhundert später – maßgeblich beigetragen hatten. Das militärisch-religiöse Modell, das die Templer institutionalisierten, verdankte seinen Kontext dieser ersten normannischen Generation von Kreuzfahrerstaaten, auch wenn die eigenen Gründer des Ordens aus der Champagne und Flandern stammten.',
      },
    },
    anchorYear: 1139,
  },
  {
    ...
    copy: {
      title: 'Cyprus and the order',
      body: {
        en: 'When Richard the Lionheart — great-great-grandson of William the Conqueror — seized Cyprus in 1191 on his way to the Third Crusade, he sold the island to the Templars for 100,000 bezants. The order tried to govern it but faced a local revolt within months and returned it. Richard then sold Cyprus to Guy de Lusignan, establishing a Crusader kingdom that would outlast every Frankish foothold on the mainland. The episode captures the Templar position perfectly: they were wealthy enough to buy an island, militarily capable enough to hold castles from Acre to Tortosa, yet ultimately dependent on the same feudal-crusader architecture that Norman warlords had built a century before them. The order\'s later fall — suppressed by Philip IV of France in 1307 — belongs to a different story; its origins belong here, in the world the First Crusade made.',
        fr: 'Lorsque Richard Cœur de Lion — arrière-arrière-petit-fils de Guillaume le Conquérant — s\'empara de Chypre en 1191 en route vers la Troisième Croisade, il vendit l\'île aux Templiers pour 100 000 besants. L\'ordre tenta de la gouverner mais fit face à une révolte locale en quelques mois et la restitua. Richard vendit alors Chypre à Guy de Lusignan, fondant un royaume croisé qui survivrait à chaque point d\'appui franc sur le continent. L\'épisode illustre parfaitement la position templière : assez riches pour acheter une île, assez compétents militairement pour tenir des châteaux d\'Acre à Tortose, mais en fin de compte dépendants de la même architecture féodale-croisée que les seigneurs de guerre normands avaient bâtie un siècle avant eux. La chute ultérieure de l\'ordre — supprimé par Philippe IV de France en 1307 — appartient à une autre histoire ; ses origines appartiennent ici, dans le monde que la Première Croisade avait façonné.',
        de: 'Als Richard Löwenherz – Ururenkel von Wilhelm dem Eroberer – 1191 auf dem Weg zum Dritten Kreuzzug Zypern eroberte, verkaufte er die Insel für 100.000 Bezants an die Templer. Der Orden versuchte, es zu regieren, sah sich jedoch innerhalb weniger Monate einer lokalen Revolte gegenüber und stellte es wieder her. Anschließend verkaufte Richard Zypern an Guy de Lusignan und gründete damit ein Kreuzfahrerkönigreich, das jede fränkische Festung auf dem Kontinent überleben sollte. Die Episode veranschaulicht perfekt die Position der Templer: reich genug, um eine Insel zu kaufen, militärisch kompetent genug, um Burgen von Acre bis Tortosa zu halten, aber letztendlich abhängig von derselben feudalen Kreuzfahrerarchitektur, die normannische Kriegsherren ein Jahrhundert vor ihnen errichtet hatten. Der spätere Untergang des Ordens – der 1307 von Philipp IV. von Frankreich aufgelöst wurde – gehört zu einer anderen Geschichte; Seine Ursprünge liegen hier, in der Welt, die der Erste Kreuzzug geprägt hatte.',
      },
    },
    anchorYear: 1191,
  },
